    ...
    app.post('/api/v2/marketplace-metrics', async (request, reply) => {
        try {
            ...
            if (
                ...
                typeof body.active_companies === 'undefined' ||
                ...
                return reply.code(400).send({
                    error: {
                        message: 'metric_date, active_recruiters, active_companies, active_jobs, total_applications, and total_placements are required',
                    },
                });
            }
