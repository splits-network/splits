        ...
        try {
            ...
            return reply
                ...
                .send({
                    error: {
                        message:
                            error.message || "Failed to fetch automation rules",
                    },
                });
        }
    });
    ...
    app.get("/api/v2/automation-rules/:id", async (request, reply) => {
        try {
            ...
            return reply
                ...
                .send({
                    error: {
                        message: error.message || "Automation rule not found",
                    },
                });
        }
    });
        ...
        try {
            ...
            if (
                ...
                return reply.code(400).send({
                    error: {
                        message:
                            "name, trigger_type, condition, and action are required",
                    },
                });
            }
        ...
        try {
            ...
            return reply
                ...
                .send({
                    error: {
                        message:
                            error.message || "Failed to update automation rule",
                    },
                });
        }
    });
        ...
        try {
            ...
            return reply
                ...
                .send({
                    error: {
                        message:
                            error.message || "Failed to delete automation rule",
                    },
                });
        }
    });
