...
CREATE INDEX idx_invitations_clerk_id ON invitations(clerk_invitation_id);
...
COMMENT ON COLUMN invitations.clerk_invitation_id IS 'Reference to Clerk organization invitation';
