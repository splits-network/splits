 ...
 * V3 Badge Evaluator
 *
 * Evaluates badge criteria against entity data.
 * Supports all operators: equals, not_equals, contains, gt, gte, lt, lte, in, exists.
 */
 ...
 * Requires all `all` clauses to pass AND at least one `any` clause (if present).
 */
