...
export const updateSchema = {
  ...
  properties: {
    ...
    slug: { type: ['string', 'null'] }, tagline: { type: ['string', 'null'], maxLength: 160 },
    description: { type: ['string', 'null'] }, logo_url: { type: ['string', 'null'] },
    logo_path: { type: ['string', 'null'] }, banner_url: { type: ['string', 'null'] },
    banner_path: { type: ['string', 'null'] },
    industries: { type: 'array', items: { type: 'string' } },
    specialties: { type: 'array', items: { type: 'string' } },
    placement_types: { type: 'array', items: { type: 'string' } },
    geo_focus: { type: 'array', items: { type: 'string' } },
    headquarters_city: { type: ['string', 'null'] }, headquarters_state: { type: ['string', 'null'] },
    headquarters_country: { type: ['string', 'null'], maxLength: 2 },
    founded_year: { type: ['integer', 'null'] }, team_size_range: { type: ['string', 'null'] },
    website_url: { type: ['string', 'null'] }, linkedin_url: { type: ['string', 'null'] },
    contact_email: { type: ['string', 'null'] }, contact_phone: { type: ['string', 'null'] },
