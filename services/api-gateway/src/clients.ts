...
export class ServiceClient {
    ...
    async put<T>(path: string, data?: any, correlationId?: string, customHeaders?: Record<string, string>): Promise<T> {
        return this.request<T>('PUT', path, data, undefined, correlationId, customHeaders);
    }
