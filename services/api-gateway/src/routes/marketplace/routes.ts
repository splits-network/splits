        ...
        schema: {
            ...
            body: {
                ...
                properties: {
                    ...
                    marketplace_industries: { type: 'array', items: { type: 'string' } },
                    marketplace_specialties: { type: 'array', items: { type: 'string' } },
                    marketplace_location: { type: 'string' },
                    marketplace_tagline: { type: 'string', maxLength: 255 },
                    marketplace_years_experience: { type: 'number', minimum: 0 },
