  ...
  app.get(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        app.log.error(error, 'Failed to list integrations');
  ...
  app.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        app.log.error(error, 'Failed to create integration');
  ...
  app.get(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        app.log.error(error, 'Failed to get integration');
        return reply.code(500).send({ error: error.message });
      }
    }
  );
  ...
  app.patch(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        app.log.error(error, 'Failed to update integration');
        return reply.code(400).send({ error: error.message });
      }
    }
  );
  ...
  app.delete(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        app.log.error(error, 'Failed to delete integration');
        return reply.code(500).send({ error: error.message });
      }
    }
  );
  ...
  app.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        app.log.error(error, 'Failed to trigger sync');
        return reply.code(400).send({ error: error.message });
      }
    }
  );
  ...
  app.get(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        app.log.error(error, 'Failed to get sync logs');
        return reply.code(500).send({ error: error.message });
      }
    }
  );
  ...
  app.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        app.log.error(error, 'Connection test failed');
  ...
  app.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        app.log.info({ integrationId, payload }, 'Received ATS webhook');
