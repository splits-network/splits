...
export async function registerChatRoutes(
    ...
    // V3 conversation aliases removed — now handled by src/v3/conversations/routes.ts
    ...
    // V3 aliases removed — now handled by:
    // - src/v3/conversations/routes.ts (conversations, actions)
    // - src/v3/blocks/routes.ts (blocks)
    // - src/v3/reports/routes.ts (reports)
    // - src/v3/attachments/routes.ts (attachments)
    // - src/v3/messages/routes.ts (messages)
