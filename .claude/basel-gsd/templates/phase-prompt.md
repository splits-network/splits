...
<!-- For checkpoint task examples and patterns, see @./.claude/basel-gsd/references/checkpoints.md -->
...
See `./.claude/basel-gsd/templates/user-setup.md` for full schema and examples
...
See `./.claude/basel-gsd/workflows/verify-phase.md` for verification logic.
