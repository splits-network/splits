...
**New Template:**
- Implementation: `basel-gsd/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `basel-gsd/workflows/{name}.md`
- Usage: Reference from command with `@./.claude/basel-gsd/workflows/{name}.md`

**New Reference Document:**
- Implementation: `basel-gsd/references/{name}.md`
