...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /basel:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ./.claude/basel-gsd/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ./.claude/basel-gsd/templates/discovery.md structure:
...
1. **Scope the discovery** using ./.claude/basel-gsd/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ./.claude/basel-gsd/templates/discovery.md
...
Use ./.claude/basel-gsd/templates/discovery.md.
...
1. Discuss phase context (/basel:discuss-phase [current-phase])
2. Create phase plan (/basel:plan-phase [current-phase])
