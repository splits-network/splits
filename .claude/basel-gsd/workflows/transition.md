...
Exit skill and invoke SlashCommand("/basel:plan-phase [X+1]")
...
**Also available:**
- `/basel:discuss-phase [X+1]` — gather context first
- `/basel:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/basel:complete-milestone {version}")
...
`/basel:complete-milestone {version}`
