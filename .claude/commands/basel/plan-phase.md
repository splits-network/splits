...
**If not found:** Error - user should run `/basel:new-project` first.
...
<phase_context>
**IMPORTANT:** If CONTEXT.md exists below, it contains user decisions from /basel:discuss-phase.
...
IMPORTANT: If phase context exists below, it contains USER DECISIONS from /basel:discuss-phase.
...
- /basel:plan-phase {X} --research — re-research first
