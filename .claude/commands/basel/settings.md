...
**If not found:** Error - run `/basel:new-project` first.
...
These settings apply to future /basel:plan-phase and /basel:execute-phase runs.

Quick commands:
- /basel:set-profile <profile> — switch model profile
- /basel:plan-phase --research — force research
- /basel:plan-phase --skip-research — skip research
- /basel:plan-phase --skip-verify — skip plan check
```
