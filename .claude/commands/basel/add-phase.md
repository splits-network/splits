...
- Example: `/basel:add-phase Add authentication` → description = "Add authentication"
- Example: `/basel:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /basel:add-phase <description>
Example: /basel:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /basel:plan-phase {N} to break down)
...
**Also available:**
- `/basel:add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /basel:insert-phase)
- Don't create plans yet (that's /basel:plan-phase)
