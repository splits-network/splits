...
- Example: `/basel:remove-phase 17` → phase = 17
- Example: `/basel:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /basel:remove-phase <phase-number>
Example: /basel:remove-phase 17
```
...
To abandon current work, use /basel:pause-work instead.
```
...
Would you like to:
- `/basel:progress` — see updated roadmap status
