...
Output: {phase}-UAT.md tracking all test results. If issues found: diagnosed gaps, verified fix plans ready for /basel:execute-phase
</objective>

<execution_context>
@./.claude/basel-gsd/workflows/verify-work.md
@./.claude/basel-gsd/templates/UAT.md
</execution_context>
...
8. If issues found:
   ...
   - Present ready status with `/clear` then `/basel:execute-phase`
</process>
...
- /basel:execute-phase {Z+1} — skip to execution (if already planned)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 BASEL GSD ► PHASE {Z} ISSUES FOUND ⚠
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
/basel:execute-phase {Z} --gaps-only
...
- /basel:plan-phase {Z} --gaps — regenerate fix plans
...
**Options:**
- /basel:plan-phase {Z} --gaps — retry fix planning with guidance
- /basel:discuss-phase {Z} — gather more context before replanning
...
- [ ] Ready for `/basel:execute-phase` when complete
</success_criteria>
