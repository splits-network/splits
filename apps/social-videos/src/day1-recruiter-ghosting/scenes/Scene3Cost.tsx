...
const costs = [
  { label: "Damaged reputation", color: colors.accent },
  { label: "Lost referrals", color: colors.accent },
  { label: "Candidates choose competitors", color: colors.accent },
  { label: "Negative Glassdoor reviews", color: colors.accent },
];
