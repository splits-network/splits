/**
 * Search Types for Candidate App
 * Scoped to entity types relevant to candidates: jobs, companies, recruiters
 */

export type SearchableEntityType = 'job' | 'company' | 'recruiter';
