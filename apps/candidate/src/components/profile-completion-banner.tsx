...
export function ProfileCompletionBanner({ className = '' }: ProfileCompletionBannerProps) {
    ...
    const calculateCompletion = () => {
        const fields = [
            ...
            state.profileData.desired_salary_min !== undefined || state.profileData.desired_salary_max !== undefined,
        ];
    ...
    return (
        <div className={`alert alert-info shadow-sm ${className}`}>
            <div className="flex items-center gap-3 flex-1">
                <i className="fa-duotone fa-regular fa-user-pen text-2xl"></i>
                <div className="flex-1">
                    <h3 className="font-semibold">Complete Your Profile</h3>
                    <p className="text-sm opacity-90">
                        Your profile is {completionPercentage}% complete. A complete profile helps recruiters find and match you with better opportunities.
                    </p>
                </div>
            </div>
