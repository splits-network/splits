    ...
    return (
        <div ref={containerRef} className="space-y-2">
            ...
            <div className="flex gap-0.5 w-full">
                ...
                <div className="flex gap-0.5 flex-1">
                    {monthLabels.map((label, index) => (
                        <div
                            key={index}
                            className="flex-1 text-[8px] text-base-content/50 text-center"
                        >
                            {label}
                        </div>
                    ))}
            ...
            <div className="flex gap-2 w-full">
                {/* Day labels */}
                <div className="flex flex-col gap-0.5 text-sm text-base-content/50 justify-between pt-0.5 flex-shrink-0">
                    <span>S</span>
                    <span>M</span>
                    <span>T</span>
                    <span>W</span>
            ...
            {/* Legend */}
            <div className="flex items-center justify-center gap-1.5 text-sm text-base-content/50 mt-2">
                <span>Less</span>
            ...
            {activityData.maxInDay > 0 && (
                <div className="text-sm text-base-content/60 mt-1.5">
                    Most active:{" "}
