        ...
        <header className="navbar bg-base-100 shadow sticky top-0 z-50">
            ...
            <div className="navbar-start ps-4">
                <div className="dropdown lg:hidden">
                    ...
                    >
                        <li>
                            <Link href="/public/jobs">Find Jobs</Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link href="/public/resources">Resources</Link>
                        </li>
                        <li>
                            <Link href="/public/companies">Companies</Link>
                        </li>
                        {isSignedIn && (
                            <>
                    ...
                    >
                        ...
                        <li>
                            <details>
                                ...
                                <ul className="menu xl:menu-horizontal bg-base-100 rounded-box lg:min-w-max shadow p-6">
                                    <div className="space-y-1">
                                        <h3 className="font-bold text-sm mb-3 text-base-content/60">
                                            EXPLORE COMPANIES
                                        </h3>
                                        <li>
                                            <Link
                ...
                {isSignedIn ? (
                    <>
                        <Link
                            ...
                            className="btn btn-ghost xs:btn-circle"
                            title="Dashboard"
                        >
