...
export function PreferencesStep() {
    ...
    const handleJobTypeChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        updateProfileData({ desired_job_type: value || undefined });
    };
    ...
    const handleSalaryMaxChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        if (value === "") {
            ...
            const maxValue =
                value === "unlimited" ? 999999999 : parseInt(value, 10);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="text-center">
                ...
                <h2 className="text-xl font-bold mb-2">Job Preferences</h2>
                <p className="text-base-content/70 text-sm">
                    Help us match you with the right opportunities. All fields
                    are optional.
                </p>
            </div>
            ...
            <div className="mx-auto space-y-6">
                ...
                <fieldset className="fieldset">
                    ...
                    <select
                        ...
                        value={state.profileData.desired_job_type || ""}
                    ...
                    <div className="space-y-2 mt-2">
                        <label className="flex items-center gap-3 p-3 rounded-lg border border-base-300 cursor-pointer hover:border-coral/50 transition-all">
                            <input
                                ...
                                checked={
                                    state.profileData.open_to_remote || false
                                }
                                onChange={() =>
                                    updateProfileData({
                                        open_to_remote:
                                            !state.profileData.open_to_remote,
                                    })
                                }
                            />
                            <div>
                        ...
                        <label className="flex items-center gap-3 p-3 rounded-lg border border-base-300 cursor-pointer hover:border-coral/50 transition-all">
                            <input
                                ...
                                className="toggle toggle-primary"
                                checked={
                                    state.profileData.open_to_relocation ||
                                    false
                                }
                                onChange={() =>
                                    updateProfileData({
                    ...
                    <div className="grid grid-cols-2 gap-3 mt-2">
                        <div>
                            ...
                            <select
                                className="select w-full"
                                value={
                                    state.profileData.desired_salary_min ?? ""
                                }
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-base-content/70 mt-1">
                            Click "Complete Setup" to finish your profile and
