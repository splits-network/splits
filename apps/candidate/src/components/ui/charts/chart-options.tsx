...
export const dataset = (() => {
    ...
    return {
        primaryBorderColor: colors.primaryHex,
        primaryBackgroundColor: hexToRgba(colors.primaryHex, 0.2),
...
export function applyThemeToChart(chart: any) {
    ...
    // Update options that don't live on datasets
...
export function registerChart(chart: any) {
    ...
    return () => { chartRegistry.delete(chart); };
}
