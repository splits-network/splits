...
export function VerticalDataRow({ label, value, icon, children }: VerticalDataRowProps) {
    const isPlaceholder = value === 'Not provided';
    const valueClass = isPlaceholder ? 'text-sm text-base-content/40 italic' : 'text-sm text-base-content/80';
