...
/**
 * Basel Auth Shell — split-panel wrapper for all candidate auth pages.
 *
 ...
 * - CSS scroll-reveal entrance animations for logo + form content
 */
