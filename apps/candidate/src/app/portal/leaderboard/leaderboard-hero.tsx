            ...
            <div className="container mx-auto px-6 lg:px-12">
                <div className="max-w-4xl">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black leading-[0.92] tracking-tight mb-6">
                        <span className="lb-title-word inline-block scroll-reveal fade-up">
                            {title}
                        </span>{" "}
                    ...
                    <p className="lb-subtitle text-lg text-base-content/60 leading-relaxed max-w-xl mb-10 scroll-reveal fade-up">
                        {subtitle}
                    </p>
