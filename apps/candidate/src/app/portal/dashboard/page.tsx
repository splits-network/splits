        ...
        async function loadDashboardData() {
            try {
                ...
                try {
                    ...
                    console.error(
                        "Failed to load recruiter relationships:",
                        err,
                    );
                }
                ...
                try {
                    const conversationsResponse = await client.get(
                        "/chat/conversations",
                    );
                                        ...
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            >
                                                {profileCompletion.tier
                                                    .charAt(0)
                                                    .toUpperCase() +
                                                    profileCompletion.tier.slice(
                                                        1,
                                                    )}
                                            </span>
                                        </div>
                                        <p className="text-sm text-base-content/70">
                                            A complete profile helps you stand
                                            out to recruiters
                                        </p>
                                    </div>
                                </div>
                        ...
                        <AtAGlance
                            ...
                            pendingApplications={
                                allApplications.filter((app) =>
                                    ["ai_review", "recruiter_request"].includes(
                                        app.stage,
                                    ),
                                ).length
                            }
