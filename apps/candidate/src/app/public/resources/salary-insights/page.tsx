        ...
        <>
            ...
            <ScrollAnimator>
                <div className="min-h-screen bg-base-200">
                    {/* Header */}
                    <section className="bg-gradient-to-br from-success to-accent text-white py-16 overflow-hidden">
                            ...
                            <div className="card bg-gradient-to-br from-primary to-secondary text-primary-content max-w-2xl mx-auto">
                                <div className="card-body">
                                    ...
                                    <div className="flex gap-2 justify-center">
                                        ...
                                        <Link href="/resources/career-guides" className="btn btn-outline btn-neutral">
                                            Career Guides
                                        </Link>
                                    </div>
                                </div>
