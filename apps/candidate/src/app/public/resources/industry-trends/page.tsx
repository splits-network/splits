        ...
        <>
            ...
            <ScrollAnimator>
                <div className="min-h-screen bg-base-200">
                    {/* Header */}
                    <section className="bg-gradient-to-br from-accent to-secondary text-white py-16">
                                        ...
                                        {skills.map((skill, index) => (
                                            <div key={index}>
                                                ...
                                                <div className="w-full bg-base-300 rounded-full h-3 overflow-hidden">
                                                    <div
                                                        className="bg-gradient-to-r from-primary to-secondary h-3 rounded-full origin-left"
