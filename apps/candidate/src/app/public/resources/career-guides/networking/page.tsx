    ...
    const tips = [
        {
            ...
            description:
                "Focus on building genuine relationships with people you connect with, rather than collecting hundreds of superficial contacts.",
            icon: "star",
        },
        {
            title: "Be Authentic",
            description:
                "People can sense when you're being genuine. Share your real interests, challenges, and goals.",
            icon: "heart",
        },
        {
            title: "Follow Up Consistently",
            description:
                "The fortune is in the follow-up. Maintain relationships by checking in regularly, even when you don't need anything.",
            icon: "calendar-check",
        },
        {
            title: "Give Before You Ask",
            description:
                "Look for ways to help others before requesting favors. Building goodwill creates lasting relationships.",
            icon: "gift",
        },
    ];
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="card bg-base-100 shadow mb-12">
                            <div className="card-body prose max-w-none">
                                <p className="text-lg">
                                    Your professional network is one of your
                                    most valuable career assets. Studies show
                                    that up to 85% of jobs are filled through
                                    networking, and strong professional
                                    connections can open doors to opportunities,
                                    mentorship, and career growth.
                                </p>
                                <p>
                                    Building a meaningful network isn't about
                                    collecting business cards—it's about
                                    cultivating genuine relationships with
                                    people who can support your career journey,
                                    and whom you can support in return.
                                </p>
                            </div>
                        </div>
                                ...
                                {strategies.map((strategy, index) => (
                                    ...
                                    >
                                        <div className="card-body">
                                            <div
                                                className={`w-14 h-14 rounded-full bg-${strategy.color}/20 flex items-center justify-center mb-4`}
                                            >
                                                <i
                                                    className={`fa-duotone fa-regular fa-${strategy.icon} text-${strategy.color} text-2xl`}
                                                ></i>
                                            </div>
                        ...
                        <div className="card bg-base-100 shadow mb-12">
                            <div className="card-body">
                                ...
                                <p className="mb-4 text-base-content/70">
                                    Have a clear, concise answer to "What do you
                                    do?" that sparks interest and conversation:
                                </p>
                                ...
                                <div className="bg-base-200 p-6 rounded-lg">
                                    ...
                                    <div className="bg-primary/10 p-4 rounded-lg border-l-4 border-coral">
                                        <p className="italic">
                                            ...
                                            healthcare tech startup. I lead the
                                            team building tools that help
                                            doctors spend less time on paperwork
                                            and more time with patients. We've
                                            helped reduce administrative work by
                                            40% at over 200 clinics."
                                        </p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    >
                                        <div className="card-body">
                                            <div className="flex items-start gap-4">
                                                <i
                                                    className={`fa-duotone fa-regular fa-${tip.icon} text-3xl text-primary`}
                                                ></i>
                                                <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <ul className="space-y-2 text-sm">
                                            ...
                                            <li>
                                                ✓ List 20 people you'd like to
                                                connect with
                                            </li>
                                            <li>
                                                ✓ Join 3 relevant industry
                                                groups
                                            </li>
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-2 text-sm">
                                            <li>
                                                ✓ Request 3 informational
                                                interviews
                                            </li>
                                            <li>✓ Attend 1 industry event</li>
                                            <li>
                                                ✓ Comment on 10 posts from
                                                connections
                                            </li>
                                            <li>
                                                ✓ Share 2 pieces of valuable
                                                content
                                            </li>
                                        </ul>
                                    </div>
