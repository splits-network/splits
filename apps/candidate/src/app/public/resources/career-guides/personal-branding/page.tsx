    ...
    const contentIdeas = [
        {
            ...
            icon: "lightbulb",
            example: "Share a mistake you made and what you learned",
        },
        {
            type: "How-To Guides",
            icon: "list-ol",
            example: "Step-by-step process for solving a common problem",
        },
        {
            type: "Industry Commentary",
            icon: "newspaper",
            example: "Your take on recent news or trends",
        },
        {
            type: "Behind the Scenes",
            icon: "camera",
            example: "Day in the life or how you approach your work",
        },
        {
            type: "Tool Reviews",
            icon: "wrench",
            example: "Tools and resources you find valuable",
        },
        {
            type: "Career Advice",
            icon: "graduation-cap",
            example: "Tips for others in your field",
        },
        {
            type: "Project Showcases",
            icon: "folder-open",
            example: "Deep dive into a project you're proud of",
        },
        {
            type: "Personal Stories",
            icon: "book",
            example: "Your career journey and pivotal moments",
        },
    ];
        ...
        <>
            ...
            <div className="min-h-screen bg-base-200">
                <AnimatedGuideHero
                    ...
                    title="Personal Branding Essentials"
                    description="Build and promote your professional brand to stand out and advance your career."
                    readTime="8 min read"
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="card bg-base-100 shadow mb-12">
                            <div className="card-body prose max-w-none">
                                <p className="text-lg">
                                    In today's digital age, your personal brand
                                    is your reputation—it's what people say
                                    about you when you're not in the room. A
                                    strong personal brand can open doors to new
                                    opportunities, help you stand out in a
                                    crowded market, and accelerate your career
                                    growth.
                                </p>
                                <p>
                                    Building a personal brand isn't about
                                    self-promotion—it's about clearly
                                    communicating your unique value, sharing
                                    your expertise generously, and building
                                    ...
                                    >
                                        <div className="card-body">
                                            <div className="flex items-start gap-4 mb-6">
                                                <div
                                                    className={`w-16 h-16 rounded-full bg-${pillar.color}/20 flex items-center justify-center flex-shrink-0`}
                                                >
                                                    <i
                                                        className={`fa-duotone fa-regular fa-${pillar.icon} text-${pillar.color} text-2xl`}
                                                    ></i>
                                                </div>
                                                <div>
                                    ...
                                    >
                                        <div className="card-body">
                                            <div className="flex items-center gap-3 mb-3">
                                                <i
                                                    className={`fa-duotone fa-regular fa-${idea.icon} text-2xl text-primary`}
                                                ></i>
                        ...
                        <div className="card bg-base-100 shadow mb-12">
                            <div className="card-body">
                                ...
                                <div className="bg-primary/10 p-6 rounded-lg border-l-4 border-coral mb-6">
                                    ...
                                    <p className="font-bold mb-2 text-success">
                                        After (Branded):
                                    </p>
                                    <p className="italic">
                                        "I help B2B SaaS companies turn complex
                                        technical features into compelling
                                        stories that drive pipeline. As a
                                        product marketing leader, I've launched
                                        15+ products and generated over $50M in
                                        new revenue."
                                    </p>
                                </div>
                                ...
                                <div className="alert alert-info">
                                    ...
                                    <span>
                                        Notice how the "After" version is
                                        specific, value-focused, and memorable
                                    </span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <ul className="space-y-2 text-sm">
                                            <li>
                                                ✓ Define your unique value and
                                                positioning
                                            </li>
                                            <li>
                                                ✓ Write your brand statement and
                                                elevator pitch
                                            </li>
                                            <li>
                                                ✓ Audit your current online
                                                presence
                                            </li>
                                            <li>
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-2 text-sm">
                                            ...
                                            <li>
                                                ✓ Join 3-5 relevant online
                                                communities
                                            </li>
                                            <li>
                                                ✓ Start following industry
                                                leaders
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                        ...
                                        <ul className="space-y-2 text-sm">
                                            <li>
                                                ✓ Publish first piece of
                                                original content
                                            </li>
                                            <li>
                                                ✓ Engage with 10 posts from your
                                                network
                                            </li>
                                            <li>
                                                ✓ Share 3 pieces of curated
                                                content
                                            </li>
                                            <li>
                                                ✓ Request recommendations on
                                                LinkedIn
                                            </li>
                                        </ul>
                                    </div>
                                    <div>
                                        ...
                                        <ul className="space-y-2 text-sm">
                                            <li>
                                                ✓ Publish second piece of
                                                content
                                            </li>
                                            <li>
                                                ✓ Connect with 15 new people
                                            </li>
                                            <li>
                                                ✓ Comment on industry
                                                discussions
