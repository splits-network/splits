        ...
        <>
            ...
            <ScrollAnimator>
                <div className="min-h-screen bg-base-200">
                    {/* Header */}
                    <section className="bg-gradient-to-br from-info to-primary text-white py-16 overflow-hidden">
                        ...
                        <section className="mb-16 overflow-hidden">
                            ...
                            <div className="card bg-gradient-to-br from-primary to-secondary text-primary-content shadow">
                                <div className="card-body">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4" data-animate-stagger>
                            ...
                            <div className="card bg-base-100 shadow max-w-2xl mx-auto">
                                <div className="card-body">
                                    ...
                                    <div className="flex gap-2 justify-center">
                                        ...
                                        <Link href="/resources/interview-prep" className="btn btn-outline">
                                            Interview Prep
                                        </Link>
                                    </div>
                                </div>
