...
import { HelpSearchFilter } from "./help-search";

export const metadata: Metadata = {
    title: "Help Center - Applicant Network",
    description:
        "Find answers to common questions about using Applicant Network. Browse FAQs on accounts, applications, recruiters, interviews, privacy, and more.",
    keywords:
        "help center, FAQ, frequently asked questions, applicant network support, job search help",
    openGraph: {
        title: "Help Center - Applicant Network",
        description:
            "Find answers to common questions about using Applicant Network. Browse FAQs on accounts, applications, recruiters, interviews, privacy, and more.",
        url: "https://applicant.network/public/help",
        type: "website",
    },
...
const faqCategories = [
    ...
    },
    {
        ...
        faqs: [
            ...
            {
                question:
                    "Will my recruiter help me prepare for interviews?",
    ...
    },
    {
        ...
        faqs: [
            ...
            {
                question:
                    "Can my current employer see that I'm job searching?",
                                ...
                                {faqCategories.map((category) => (
                                    ...
                                    >
                                        <div className="card-body items-center text-center p-6">
                                            <i
                                                className={`fa-duotone fa-regular ${category.icon} text-4xl text-primary mb-2`}
                                            ></i>
                                ...
                                >
                                    <div className="flex items-center gap-3 mb-6">
                                        <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                                            <i
                                                className={`fa-duotone fa-regular ${category.icon} text-2xl text-primary`}
                                            ></i>
                                        </div>
