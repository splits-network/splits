...
const TOC_SECTIONS = [
    ...
    { id: "service-description", label: "Service Description", icon: "fa-layer-group" },
    ...
    { id: "intellectual-property", label: "Intellectual Property", icon: "fa-copyright" },
    ...
    { id: "dispute-resolution", label: "Dispute Resolution", icon: "fa-handshake" },
            ...
            <div className="bg-dark text-white">
                ...
                <section className="py-20 bg-cream text-dark">
                    <div className="container mx-auto px-4 max-w-5xl">
                        ...
                        <div className="toc-card bg-white border-4 border-dark p-8 mb-16 opacity-0">
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
                                {TOC_SECTIONS.map((section, idx) => (
                                    ...
                                    >
                                        <i className={`fa-duotone fa-regular fa-${section.icon} text-coral text-sm group-hover:scale-110 transition-transform`}></i>
                        ...
                        <section id="acceptance" className="content-section mb-16 opacity-0">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight">
                                    <span className="text-coral">1.</span> Acceptance of Terms
                                </h2>
                            </div>
                            ...
                            <div className="section-card bg-white border-4 border-dark/30 p-6 mb-4 opacity-0">
                                <p className="text-sm font-bold leading-relaxed text-dark/80">
                                    By accessing and using Applicant Network, you accept and agree to be bound by the terms and conditions described in this agreement. If you do not agree to these terms, you should not use the service.
                                </p>
                            </div>
                            ...
                            <div className="section-card bg-teal/10 border-4 border-teal p-6 opacity-0">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="font-black text-sm uppercase tracking-[0.12em] mb-2 text-dark">Legal Agreement</h3>
                                        <p className="text-sm font-bold text-dark/70">These Terms of Service constitute a binding legal agreement between you and Applicant Network.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="service-description" className="content-section mb-16 opacity-0">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight">
                                    <span className="text-teal">2.</span> Service Description
                                </h2>
                            </div>
                            ...
                            <p className="section-card bg-white border-4 border-dark/30 p-6 text-sm font-bold leading-relaxed text-dark/80 mb-6 opacity-0">
                                Applicant Network is a split-fee recruiting marketplace that connects job seekers with recruiters and companies. The platform enables streamlined hiring processes and transparent collaboration.
                            </p>

                            <div className="grid md:grid-cols-3 gap-6">
                                {[
                                    { icon: "fa-briefcase", title: "Candidates", items: ["Job search & discovery", "Application management", "Recruiter communication", "Placement tracking"], color: "coral" },
                                    { icon: "fa-people-group", title: "Recruiters", items: ["Job listing & management", "Candidate search", "Application review", "Interview coordination"], color: "teal" },
                                    { icon: "fa-building", title: "Companies", items: ["Job posting", "Applicant tracking", "Team collaboration", "Hiring workflows"], color: "yellow" },
                                ].map((role, idx) => (
                                    <div key={idx} className={`section-card bg-white border-4 border-${role.color} p-6 opacity-0`}>
                                        <div className="flex items-center gap-3 mb-4">
                                            <i className={`fa-duotone fa-regular fa-${role.icon} text-${role.color} text-xl`}></i>
                                            <h3 className={`font-black text-lg uppercase tracking-[0.12em] text-${role.color}`}>{role.title}</h3>
                                        </div>
                                        <ul className="space-y-2">
                                            {role.items.map((item, i) => (
                                                <li key={i} className="flex items-start gap-2">
                                                    <i className={`fa-duotone fa-regular fa-check text-${role.color} text-[10px] mt-1 flex-shrink-0`}></i>
                                                    <span className="text-xs font-bold text-dark/70">{item}</span>
                                                </li>
                                            ))}
                                        </ul>
                                    </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="section-card bg-white border-4 border-coral p-6 opacity-0">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <h3 className="font-black text-lg uppercase tracking-[0.12em]">Legal Team</h3>
                                    </div>
                                    <a href="mailto:legal@applicant.network" className="text-coral font-black text-lg hover:underline block mb-2">
                                        legal@applicant.network
                                    </a>
                                    <p className="text-xs font-bold text-dark/50">Response within 5 business days</p>
                                </div>
                                ...
                                <div className="section-card bg-white border-4 border-teal p-6 opacity-0">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <h3 className="font-black text-lg uppercase tracking-[0.12em]">Support</h3>
                                    </div>
                                    <a href="mailto:support@applicant.network" className="text-teal font-black text-lg hover:underline block mb-2">
                                        support@applicant.network
                                    </a>
                                    <p className="text-xs font-bold text-dark/50">Response within 2 business days</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <div className="text-center mt-16 pt-12 border-t-4 border-dark/20">
                            ...
                            <div className="flex flex-wrap gap-4 justify-center">
                                <Link href="/public/privacy-policy" className="text-sm font-black uppercase tracking-wider text-coral hover:underline">
                                    Privacy Policy
                                </Link>
                                <Link href="/public/cookie-policy" className="text-sm font-black uppercase tracking-wider text-teal hover:underline">
                                    Cookie Policy
                                </Link>
