...
export function StatusAnimator({ children }: StatusAnimatorProps) {
    ...
    useGSAP(
        () => {
            ...
            // ════════════════════════════════════════
            // PAST INCIDENTS (handled via CSS - loads async)
            // ════════════════════════════════════════
            // Past incidents load asynchronously so we don't animate with GSAP
            // to avoid timing issues. They appear naturally when data loads.
