    ...
    const heroState = useMemo(() => {
        if (isLoading) {
            return {
                ...
                subtext: "We noticed something unusual and we're investigating. Your account is fine. Services are operational. We're just making sure everything stays that way.",
                bgColor: "bg-dark",
        ...
        if (allHealthy) {
            return {
                ...
                subtext: "Your profile, applications, and recruiter connections are all green. Browse roles, track your pipeline, message recruiters — all systems operational.",
                bgColor: "bg-teal",
                textColor: "text-dark",
                badgeColor: "bg-teal",
                badgeText: "text-dark",
        ...
        if (someUnhealthy) {
            return {
                ...
                subtext: "We spotted an issue. Your profile and applications are safe. Some features might load slower than usual. We're fixing it now.",
                bgColor: "bg-coral",
        ...
        return {
            ...
            subtext: "We're checking everything. Your data is safe. Services remain operational. Updates coming shortly.",
            bgColor: "bg-yellow",
            textColor: "text-dark",
            ...
            <section className="status-hero relative min-h-[50vh] overflow-hidden flex items-center bg-dark">
                <div className="memphis-shapes absolute inset-0 pointer-events-none overflow-hidden">
                    ...
                    <svg className="memphis-shape absolute bottom-[10%] right-[40%] opacity-0 stroke-purple" width="80" height="25" viewBox="0 0 80 25">
                        <polyline points="0,20 10,5 20,20 30,5 40,20 50,5 60,20 70,5 80,20" fill="none" strokeWidth="3" strokeLinecap="round" />
                    </svg>
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-base mt-1 text-dark/70">
                                                    {service.error || "We're on it. This won't take long."}
                                                </p>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center max-w-3xl mx-auto opacity-0">
                        <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight mb-6 text-white">
                            Need{" "}
                            <span className="text-teal">Help?</span>
                        </h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <a href="mailto:help@applicant.network"
