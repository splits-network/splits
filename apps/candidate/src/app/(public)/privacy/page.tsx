...
export const metadata: Metadata = {
    ...
    description:
        "Read Applicant Network's Privacy Policy to understand how we collect, use, protect, and manage your personal information and data.",
    openGraph: {
        title: "Privacy Policy - Applicant Network | Your Data Privacy & Security",
        description:
            "Read Applicant Network's Privacy Policy to understand how we collect, use, protect, and manage your personal information and data.",
            ...
            <div className="prose prose-lg max-w-none">
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80 mb-4">
                        When you create an account or use our services, you may
                        provide us with:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 text-base-content/80">
                        <li>
                            <strong>Profile Information:</strong> Name, email
                            address, phone number, location, resume, work
                            experience, education, skills, and career
                            preferences
                        </li>
                        <li>
                            <strong>Application Information:</strong> Job
                            applications, cover letters, and related documents
                        </li>
                        <li>
                            <strong>Communication Data:</strong> Messages sent
                            through our platform, feedback, and support
                            inquiries
                        </li>
                        <li>
                            <strong>Payment Information:</strong> For recruiters
                            only—billing address and payment details (processed
                    ...
                    <p className="text-base-content/80">
                        We may receive information from authentication providers
                        (like Clerk), analytics services, and other business
                ...
                <section className="mb-8">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-base-content/80">
                        <li>
                            <strong>Provide Services:</strong> Enable job
                            search, applications, recruiter matching, and
                            communication
                        </li>
                        <li>
                            <strong>Improve Platform:</strong> Analyze usage
                            patterns, fix bugs, and develop new features
                        </li>
                        <li>
                            <strong>Personalization:</strong> Recommend relevant
                            jobs and customize your experience
                        </li>
                        <li>
                            <strong>Communication:</strong> Send important
                            updates, notifications, and marketing (with your
                            consent)
                        </li>
                        <li>
                            <strong>Safety & Security:</strong> Prevent fraud,
                            protect accounts, and enforce our terms
                        </li>
                        <li>
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80 mb-4">
                        When you apply to a job, we share your profile and
                        application materials with the recruiter managing that
                        position. Your information remains private until you
                        choose to apply.
                    </p>
                    ...
                    <p className="text-base-content/80">
                        ...
                        as in response to court orders, subpoenas, or other
                        legal processes.
                    </p>
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80 mt-4">
                        ...
                        of transmission over the internet is 100% secure. You
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        ...
                        anonymize your personal data within 30 days, except
                        where we must retain information for legal or business
                        purposes.
                    </p>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-base-content/80">
                        ...
                        <li>
                            Right to know if personal information is sold or
                            shared
                        </li>
                        <li>
                        ...
                        <li>
                            Right to non-discrimination for exercising CCPA
                            rights
                        </li>
                    </ul>
                    <p className="text-base-content/80 mt-4">
                        <strong>Note:</strong> We do not sell your personal
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        ...
                        will notify you of material changes by posting the new
