                ...
                <div className="container mx-auto px-4 relative z-10 py-20">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="hero-subtext text-lg md:text-xl leading-relaxed mb-10 opacity-0 text-white/70 max-w-3xl mx-auto">
                            The job search is broken. Recruiters ghost you. Job
                            boards spam you. Companies ignore you. Applicant
                            Network flips the script — you get vetted recruiters
                            working FOR you, complete transparency, and zero
                            cost. This is recruiting done right.
                        </p>
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="mission-section opacity-0">
                            ...
                            <div className="space-y-6 text-lg leading-relaxed text-dark/80">
                                <p>
                                    Job hunting shouldn't feel like shouting
                                    into the void. You shouldn't have to wonder
                                    if your resume made it past the algorithm.
                                    You shouldn't be ghosted after investing
                                    hours in interview prep.
                                </p>

                                <p>
                                    Applicant Network was built to fix this. We
                                    connect talented candidates like you with
                                    vetted recruiters who are invested in your
                                    success. Recruiters on our platform are
                                    rated, accountable, and incentivized to get
                                    you hired — not just to collect resumes.
                                </p>

                                <p>
                                    We believe transparency should be the
                                    default. You deserve to know who's viewing
                                    your profile, which recruiters are working
                                    your applications, and exactly where you
                                    stand in the hiring process. No black boxes.
                                    No mystery. Just clarity.
                                </p>

                                <p className="font-bold text-dark">
                                    And it's completely free for candidates.
                                    Forever.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="pullquote max-w-4xl mx-auto relative p-8 md:p-12 border-4 border-yellow opacity-0">
                        ...
                        <p className="text-2xl md:text-3xl font-black uppercase tracking-tight leading-tight mt-4 text-white">
                            Recruiting should work FOR candidates, not AROUND
                            them. We built a platform where transparency isn't
                            optional — it's the entire point.
                        </p>
                        <div className="mt-6 pt-4 border-t-4 border-yellow">
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        <div className="trust-section opacity-0">
                            ...
                            <p className="text-lg leading-relaxed mb-10 text-white/70">
                                We take your privacy seriously. Your profile is
                                only visible to vetted recruiters you approve.
                                Your data is encrypted and protected. You can
                                pause visibility, export your data, or delete
                                your account at any time — no questions asked.
                            </p>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center max-w-4xl mx-auto mb-10 opacity-0">
                        ...
                        <p className="text-lg mb-8 text-white/70">
                            Create your free profile in under 5 minutes. Get
                            matched with vetted recruiters who actually care
                            about placing you. Track your applications in
                            real-time. Land better opportunities, faster.
                        </p>
                    </div>
