...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description:
            "Discover expert recruiters by industry, specialty, and location.",
        url: "https://applicant.network/marketplace",
    },
    ...buildCanonical("/marketplace"),
};
...
async function buildMarketplaceParams(
    ...
    const sortBy =
        (await getSearchParam(searchParams, "sort_by")) ?? "reputation_score";
    const sortOrder =
...
export default async function MarketplacePage({
    ...
    let initialPagination:
        | StandardListResponse<Recruiter>["pagination"]
        | undefined;
