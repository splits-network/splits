...
export const metadata: Metadata = {
    ...
    description:
        "Learn about how Applicant Network uses cookies and similar technologies to improve your experience and provide our services.",
    openGraph: {
        title: "Cookie Policy - Applicant Network | How We Use Cookies",
        description:
            "Learn about how Applicant Network uses cookies and similar technologies to improve your experience and provide our services.",
        ...
        <div className="container mx-auto px-4 py-12">
            <div className="prose prose-lg max-w-none">
                ...
                <div className="alert alert-info mb-8">
                    <i className="fa-duotone fa-regular fa-cookie-bite"></i>
                    <span>
                        This Cookie Policy explains how Applicant Network uses
                        cookies and similar technologies when you visit our
                        website.
                    </span>
                </div>
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        ...
                        actions and preferences over time, so you don't have to
                ...
                <section className="mb-8">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-base-content/80">
                        <li>
                            <strong>Enable Essential Features:</strong> Allow
                            you to log in, navigate the site, and use core
                            functionality
                        </li>
                        <li>
                            <strong>Remember Your Preferences:</strong> Store
                            settings like language, theme, and display
                            preferences
                        </li>
                        <li>
                            <strong>Improve Performance:</strong> Help us
                            understand how you use the site so we can make it
                            better
                        </li>
                        <li>
                            <strong>Analyze Usage:</strong> Collect data about
                            site traffic and user behavior
                        </li>
                        <li>
                            <strong>Enhance Security:</strong> Detect and
                            prevent fraudulent activity and security threats
                        </li>
                        <li>
                            <strong>Personalize Content:</strong> Show you
                            relevant job recommendations and content
                        </li>
                    </ul>
                </section>
                        ...
                        <div className="card bg-base-200">
                            <div className="card-body">
                                ...
                                <p className="text-base-content/80 mb-3">
                                    ...
                                    to function properly. Without them, you
                                    won't be able to use basic features like
                                    logging in or submitting applications.
                                </p>
                                <p className="text-base-content/80">
                        ...
                        <div className="card bg-base-200">
                            <div className="card-body">
                                ...
                                <p className="text-sm text-base-content/70 mt-2">
                                    <strong>Services we use:</strong> Google
                                    Analytics (anonymized IP)
                                </p>
                                <div className="badge badge-warning mt-3">
                                    Optional
                                </div>
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80 mb-4">
                        We use services from trusted third-party providers that
                        may set their own cookies on your device. These include:
                    </p>
                        ...
                        <table className="table table-zebra">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Payment processing (recruiters only)
                                    </td>
                                    <td>
                                        <a
                    ...
                    <p className="text-base-content/80 mt-4">
                        ...
                        review the privacy policies of these services to learn
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80 mb-4">
                        When you first visit Applicant Network, you'll see a
                        cookie banner where you can choose to accept or decline
                        non-essential cookies. You can change your preferences
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mt-4">
                        <div className="card bg-base-200">
                            <div className="card-body">
                                <h4 className="font-bold mb-2">
                                    <i className="fa-brands fa-chrome text-xl mr-2"></i>
                                    Google Chrome
                                </h4>
                        ...
                        <div className="card bg-base-200">
                            <div className="card-body">
                                <h4 className="font-bold mb-2">
                                    <i className="fa-brands fa-firefox text-xl mr-2"></i>
                                    Mozilla Firefox
                                </h4>
                                <p className="text-sm text-base-content/70">
                        ...
                        <div className="card bg-base-200">
                            <div className="card-body">
                                <h4 className="font-bold mb-2">
                                    <i className="fa-brands fa-safari text-xl mr-2"></i>
                                    Safari
                                </h4>
                                <p className="text-sm text-base-content/70">
                        ...
                        <div className="card bg-base-200">
                            <div className="card-body">
                                <h4 className="font-bold mb-2">
                                    <i className="fa-brands fa-edge text-xl mr-2"></i>
                                    Microsoft Edge
                                </h4>
                                <p className="text-sm text-base-content/70">
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        ...
                        to websites that you don't want your online activity
                        tracked. Currently, there is no universal standard for
                        how websites should respond to Do Not Track signals. We
                        do not currently respond to Do Not Track signals, but
                        you can manage cookies as described above.
                    </p>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80 mb-4">
                        Our website uses cookies on mobile devices just as it
                        does on desktop computers. You can manage cookies on
                        mobile devices through your browser settings, similar to
                        desktop browsers.
                    </p>
                    <p className="text-base-content/80">
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80 mb-4">
                        If you have questions about how we use cookies, please
                        contact us:
                    </p>
                    <div className="card bg-base-200">
                        <div className="card-body">
