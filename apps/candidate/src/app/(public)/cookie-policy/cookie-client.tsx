                    ...
                    <div className="container mx-auto px-4 max-w-5xl">
                        ...
                        <div className="toc-card bg-white border-4 border-dark p-8 mb-16 opacity-0">
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                {TOC_SECTIONS.map((section) => (
                                    ...
                                    >
                                        <i
                                            className={`fa-duotone fa-regular fa-${section.icon} text-yellow text-sm group-hover:scale-110 transition-transform`}
                                        ></i>
                        ...
                        >
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight">
                                    <span className="text-yellow">1.</span> What
                                    Are Cookies?
                                </h2>
                            </div>
                            ...
                            <div className="section-card bg-white border-4 border-dark/30 p-6 mb-6 opacity-0">
                                <p className="text-sm font-bold leading-relaxed text-dark/80">
                                    ...
                                    device when you visit websites. They store
                                    information about your preferences,
                                    settings, and activity to enhance your
                                    experience.
                                </p>
                            </div>
                            ...
                            <div className="section-card bg-white border-4 border-yellow/50 p-6 opacity-0">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    {[
                                        {
                                            name: "Web Beacons",
                                            desc: "Track page visits",
                                        },
                                        {
                                            name: "Local Storage",
                                            desc: "Store data client-side",
                                        },
                                        {
                                        ...
                                        <div
                                            key={i}
                                            className="flex items-start gap-3 p-3 bg-cream"
                                        >
                        ...
                        >
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight">
                                    <span className="text-coral">3.</span> Types
                                    of Cookies
                                </h2>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                {[
                                    ...
                                    {
                                        type: "Analytics",
                                        desc: "Help us improve the service",
                                        color: "teal",
                                        icon: "fa-chart-line",
                                    },
                                    {
                                        type: "Functional",
                                        desc: "Remember your preferences",
                                        color: "purple",
                                        icon: "fa-sliders",
                                    },
                                    {
                                        type: "Marketing",
                                        desc: "Deliver relevant ads",
                                        color: "yellow",
                                        icon: "fa-bullhorn",
                                    },
                                ].map((cookie, idx) => (
                                    <div
                                        key={idx}
                                        className={`section-card bg-white border-4 border-${cookie.color} p-6 opacity-0`}
                                    >
                                        <div className="flex items-center gap-3 mb-4">
                                            <i
                                                className={`fa-duotone fa-regular fa-${cookie.icon} text-${cookie.color} text-xl`}
                                            ></i>
                                            <h3
                                                className={`font-black text-lg uppercase tracking-[0.12em] text-${cookie.color}`}
                                            >
                                                {cookie.type}
                                            </h3>
                                        </div>
                        ...
                        <section className="content-section mt-20 pt-12 border-t-4 border-dark/20 opacity-0">
                            ...
                            <div className="section-card bg-white border-4 border-yellow p-6 opacity-0">
                                ...
                                <a
                                    ...
                                    className="text-yellow font-black text-lg hover:underline block mb-2"
                                >
                                    support@applicant.network
                                </a>
                                <p className="text-xs font-bold text-dark/50">
                                    We're here to help with your cookie
                                    preferences
                                </p>
                            </div>
                        </section>
