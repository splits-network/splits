...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        url: "https://applicant.network/for-recruiters-memphis",
    },
    ...buildCanonical("/for-recruiters-memphis"),
};
                ...
                <div className="container mx-auto px-4 relative z-10 py-20">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="hero-subtext text-lg md:text-xl leading-relaxed mb-10 text-cream/70 opacity-0">
                            Quality candidates. Transparent fees. Fast
                            placements. No gatekeepers between you and the
                            talent you need. Access 12,000+ verified profiles
                            actively seeking opportunities. Know your earnings
                            upfront. Get paid when placements close. This is
                        ...
                        <div className="benefits-grid grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {benefits.map((benefit, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`absolute top-0 right-0 w-10 h-10 ${accentBg[index]}`}
                                        />
                                        <div
                                            className={`w-14 h-14 flex items-center justify-center mb-4 border-4 ${borderColors[index]}`}
                                        >
                                            <i
                                                className={`${benefit.icon} text-2xl ${iconColor[index] === "text-cream" ? borderColors[index].replace("border-", "text-") : "text-dark"}`}
                                            ></i>
                                        </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="pullquote max-w-4xl mx-auto relative p-8 md:p-12 border-4 border-teal opacity-0">
                        ...
                        <p className="text-2xl md:text-3xl font-black uppercase tracking-tight leading-tight mt-4 text-cream">
                            ...
                            They&apos;re here. Verified. Active. Ready to be
                            placed.
                        </p>
                            ...
                            {howSteps.map((step, index) => (
                                ...
                                >
                                    ...
                                    <div className="w-14 h-14 flex items-center justify-center mb-4 bg-yellow">
                                        <i
                                            className={`${step.icon} text-xl text-dark`}
                                        ></i>
                                    </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            {testimonials.map((testimonial, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div
                                            className={`absolute bottom-0 left-0 w-10 h-10 ${accentBg[index]}`}
                                        />
                                        <div className="mb-4">
                                            <i
                                                className={`fa-duotone fa-regular fa-quote-left text-2xl ${borderColors[index].replace("border-", "text-")}`}
                                            ></i>
                                        </div>
                                        ...
                                        <div
                                            className={`pt-4 border-t-[3px] ${borderColors[index]}`}
                                        >
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center mb-12 opacity-0 max-w-4xl mx-auto">
                        ...
                        <p className="text-lg mb-10 text-cream/70">
                            12,000+ verified candidates. Transparent fees. Fast
                            placements. Zero subscription costs. This is how
                            recruiting should work.
                        </p>
