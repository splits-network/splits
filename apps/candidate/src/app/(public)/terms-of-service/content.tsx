                ...
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="scroll-reveal fade-up article-block max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                            <p>
                                By accessing, browsing, or using the Applicant
                                Network platform (the &ldquo;Platform&rdquo;),
                                operated by Employment Networks, Inc.
                                (&ldquo;Applicant Network,&rdquo;
                                &ldquo;we,&rdquo; &ldquo;us,&rdquo; or
                                &ldquo;our&rdquo;), you acknowledge that you
                                have read, understood, and agree to be bound by
                                these Terms of Service (&ldquo;Terms&rdquo;). If
                    ...
                    <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="scroll-reveal slide-from-left split-text-left lg:col-span-3">
                            ...
                            <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                                ...
                                <p>
                                    Applicant Network acts as a marketplace
                    ...
                    <div className="scroll-reveal fade-up article-block max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                            ...
                            <p>
                                ...
                                <a
                                    href="mailto:security@applicant.network"
                                    className="text-secondary underline"
                                >
                                    security@applicant.network
                                </a>{" "}
                    ...
                    <div className="scroll-reveal fade-up article-block max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                            <p>
                                ...
                                Platform. Applicant Network may charge platform
                            ...
                            <p>
                                ...
                                service and privacy policy. You authorize
                                Applicant Network and Stripe to charge your
                                designated payment method for all fees and
                                charges incurred. Payment information is
                                transmitted securely and is never stored on our
                                servers.
                            </p>
                            <p>
                                <strong className="text-base-content font-bold">
                            ...
                            <p>
                                ...
                                Applicant Network does not provide tax advice,
                                and you should consult with a qualified tax
                    ...
                    <div className="scroll-reveal fade-up article-block max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                            <p>
                                ...
                                property comprising the Applicant Network
                                platform are owned by Employment Networks, Inc.
                                or our licensors and are protected by United
                                States and international copyright, trademark,
                            ...
                            <p>
                                ...
                                submitting User Content, you grant Applicant
                    ...
                    <div className="scroll-reveal fade-up article-block max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                            ...
                            <p>
                                ...
                                Applicant Network is a platform provider, not an
                ...
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="scroll-reveal fade-up article-block max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                            ...
                            <p>
                                <strong className="text-base-content font-bold">
                                    Termination by Applicant Network.
                                </strong>{" "}
