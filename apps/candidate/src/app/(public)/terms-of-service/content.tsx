                ...
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="article-block max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                            <p>
                                By accessing, browsing, or using the Applicant Network platform
                                (the &ldquo;Platform&rdquo;), operated by Employment Networks, Inc.
                                (&ldquo;Applicant Network,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo;
                ...
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="split-text-left lg:col-span-3">
                            ...
                            <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                                <p>
                                    Applicant Network is a split-fee recruiting marketplace that
                                ...
                                <p>
                                    Applicant Network acts as a marketplace platform and is not itself a
                    ...
                    <div className="article-block max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                            <p>
                                ...
                                created on the Platform. Applicant Network may charge platform fees,
                            ...
                            <p>
                                ...
                                policy. You authorize Applicant Network and Stripe to charge your
                            ...
                            <p>
                                ...
                                Platform. Applicant Network does not provide tax advice, and you should
                    ...
                    <div className="article-block max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                            <p>
                                ...
                                logos, and other intellectual property comprising the Applicant Network
                            ...
                            <p>
                                ...
                                submitting User Content, you grant Applicant Network a worldwide,
                    ...
                    <div className="article-block max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                            ...
                            <p>
                                ...
                                Applicant Network is a platform provider, not an employer, recruiter,
