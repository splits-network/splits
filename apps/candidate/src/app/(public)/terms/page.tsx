...
export const metadata: Metadata = {
    ...
    description:
        "Read the Terms of Service for Applicant Network. Understand your rights and responsibilities when using our job search and recruiting platform.",
    openGraph: {
        title: "Terms of Service - Applicant Network | User Agreement",
        description:
            "Read the Terms of Service for Applicant Network. Understand your rights and responsibilities when using our job search and recruiting platform.",
            ...
            <div className="prose prose-lg max-w-none">
                ...
                <div className="alert alert-warning mb-8">
                    ...
                    <span>
                        ...
                        using Applicant By accessing or using our services, you
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        ...
                        and use of Applicant Network (the "Platform"), operated
                        by Splits Network, Inc. ("we," "us," or "our"). By
                        creating an account, accessing, or using our Platform,
                ...
                <section className="mb-8">
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-base-content/80">
                        ...
                        <li>
                            Post discriminatory, defamatory, or obscene content
                        </li>
                    </ul>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <h3 className="text-2xl font-semibold mb-3">
                        5.1 Profile and Applications
                    </h3>
                    <p className="text-base-content/80">
                        You grant us permission to share your profile and
                        application materials with recruiters when you apply to
                        jobs. You warrant that all information provided is
                        accurate and that you have the right to share any
                        documents uploaded to the Platform.
                    </p>

                    <h3 className="text-2xl font-semibold mb-3 mt-6">
                        5.2 No Fee for Candidates
                    </h3>
                    <p className="text-base-content/80">
                        Applicant Network is free for candidates. You will never
                        be charged to create a profile, browse jobs, or apply to
                        positions.
                    </p>

                    <h3 className="text-2xl font-semibold mb-3 mt-6">
                        5.3 Direct Hiring Relationships
                    </h3>
                    <p className="text-base-content/80">
                        Recruiters on our Platform facilitate connections
                        between candidates and employers. Any employment
                        relationship is between you and the hiring company, not
                        with Applicant Network or the recruiter.
                    </p>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        Recruiters must maintain an active subscription to
                        access the Platform. You agree to pay all applicable
                        fees as outlined in your subscription plan. Fees are
                    ...
                    <p className="text-base-content/80">
                        When you successfully place a candidate, you agree to
                        our placement fee structure. Fees are earned upon
                        candidate placement and verified employment start date.
                        You must accurately report all placements and related
                        information.
                    </p>
                    ...
                    <ul className="list-disc pl-6 space-y-2 text-base-content/80">
                        ...
                        <li>
                            Provide accurate job descriptions and company
                            information
                        </li>
                        <li>
                            Respond to candidates in a timely and professional
                            manner
                        </li>
                    </ul>
                    ...
                    <p className="text-base-content/80">
                        We reserve the right to verify your identity,
                        credentials, and business information. Failure to
                        provide requested verification may result in account
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        The Platform and its content (text, graphics, logos,
                        features) are owned by Splits Network, Inc. and
                    ...
                    <p className="text-base-content/80">
                        You retain ownership of content you submit (resumes,
                        profiles, job postings). By submitting content, you
                        grant us a worldwide, non-exclusive, royalty-free
                        license to use, reproduce, modify, and display that
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        ...
                        (authentication, payments, analytics). We are not
                        responsible for the content, policies, or practices of
                        these third parties. Your use of third-party services is
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        ...
                        DO NOT WARRANT THAT THE PLATFORM WILL BE UNINTERRUPTED,
                    ...
                    <p className="text-base-content/80">
                        ...
                        or that recruiters will successfully place candidates.
                    ...
                    <p className="text-base-content/80">
                        TO THE MAXIMUM EXTENT PERMITTED BY LAW, SPLITS NETWORK,
                        INC. SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        You agree to indemnify, defend, and hold harmless Splits
                        Network, Inc., its officers, directors, employees, and
                        agents from any claims, liabilities, damages, losses,
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80 mb-4">
                        ...
                        account and access to the Platform at any time, with or
                        without notice, for:
                    </p>
                    <ul className="list-disc pl-6 space-y-2 text-base-content/80">
                    ...
                    <p className="text-base-content/80 mt-4">
                        ...
                        account settings. Upon termination, your right to use
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        ...
                        . We'll work with you to resolve the issue informally.
                    </p>
                    ...
                    <p className="text-base-content/80">
                        ...
                        Association, rather than in court. You waive your right
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        ...
                        material changes, we will notify you by email or through
                ...
                <section className="mb-8">
                    ...
                    <p className="text-base-content/80">
                        ...
                        Splits Network, Inc. regarding your use of the Platform.
                    </p>
                    ...
                    <p className="text-base-content/80">
                        ...
                        Terms will not be deemed a waiver of such right or
                        provision.
                    </p>
                    ...
                    <p className="text-base-content/80">
                        ...
                        account without our prior written consent. We may assign
                ...
                <section className="mb-8">
                    ...
                    <div className="card bg-base-200">
                        <div className="card-body">
                            ...
                            <p>
                                <strong>Address:</strong> Splits Network, Inc.
                                [Full Address]
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex flex-wrap gap-4 justify-center">
                    ...
                    <Link href="/cookie-policy" className="btn btn-outline">
