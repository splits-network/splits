    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                answer: "Check your internet connection. Try a different browser. Clear cache. Check our status page at /status-memphis for known issues.",
            },
            {
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="support-cta-content text-center max-w-3xl mx-auto opacity-0">
                        <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight mb-6 text-white">
                            Still Need <span className="text-coral">Help?</span>
                        </h2>
                        <p className="text-lg mb-8 text-white/60">
                            Our support team is standing by. Real humans. Quick
                            responses. We're here to help you succeed.
                        </p>
