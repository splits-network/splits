...
export const metadata: Metadata = {
    ...
    description:
        "Read real stories from candidates who landed roles through Applicant Network.",
    openGraph: {
        title: "Success Stories",
        description:
            "Read real stories from candidates who landed roles through Applicant Network.",
        url: "https://applicant.network/resources/success-stories",
    },
    ...buildCanonical("/resources/success-stories"),
};
...
const stories = [
    {
        ...
        details:
            "Transitioned from bootcamp graduate to senior engineer at a Fortune 500 company",
        salary: "$145K",
        timeline: "3 weeks",
    },
    {
        ...
        details:
            "Career pivot from sales to product management at a fast-growing startup",
        salary: "$135K + equity",
        timeline: "6 weeks",
    },
    {
        ...
        details:
            "First design role after self-taught journey, now leading design initiatives",
        salary: "$110K",
        timeline: "4 weeks",
    },
    {
        ...
        details:
            "Moved from finance to tech, found remote role with flexible hours",
        salary: "$95K",
        timeline: "5 weeks",
    },
    {
        ...
        details:
            "Negotiated 25% increase over initial offer using platform data",
        salary: "$150K",
        timeline: "8 weeks",
    },
    {
        ...
        details:
            "Career change from retail to B2B SaaS sales, exceeded quota in first quarter",
                        ...
                        <div className="container mx-auto px-4">
                            <div className="max-w-3xl">
                                ...
                                <p className="text-xl opacity-90">
                                    Real stories from candidates who found their
                                        ...
                                        <div className="card-body">
                                            <div className="flex items-start gap-4 mb-4">
                                                <div className="w-16 h-16 rounded-full bg-primary/20 flex items-center justify-center">
                                                    <i
                                                        className={`fa-duotone fa-regular fa-${story.image} text-primary text-2xl`}
                                                    ></i>
                                                </div>
