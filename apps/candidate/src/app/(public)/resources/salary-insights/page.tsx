...
export const metadata: Metadata = {
    ...
    description:
        "Explore salary benchmarks, compensation trends, and market insights.",
    openGraph: {
        title: "Salary Insights",
        description:
            "Explore salary benchmarks, compensation trends, and market insights.",
        url: "https://applicant.network/resources/salary-insights",
    },
    ...buildCanonical("/resources/salary-insights"),
};
...
export default function SalaryInsightsPage() {
    const articleJsonLd = buildArticleJsonLd({
        ...
        description:
            "Explore salary benchmarks, compensation trends, and market insights.",
        path: "/resources/salary-insights",
    });
    return (
        <>
                        ...
                        <div className="container mx-auto px-4">
                            <div className="max-w-3xl">
                                ...
                                <p className="text-xl opacity-90">
                                    Real salary data and compensation trends to
                                    help you know your worth.
                                </p>
                            </div>
                        </div>
                    </section>
                        ...
                        <section className="mb-16 overflow-hidden">
                            ...
                            >
                                {insights.map((insight, index) => (
                                    <div
                                        key={index}
                                        className={`card bg-base-100 shadow border-t-4 border-${insight.color}`}
                                    >
                        ...
                        <section className="text-center overflow-hidden">
                            <div className="card bg-gradient-to-br from-primary to-secondary text-primary-content max-w-2xl mx-auto">
                                <div className="card-body">
                                    ...
                                    <p className="mb-4">
                                        Browse jobs with transparent salary
