...
const guides = [
    {
        ...
        href: "/resources/career-guides/switch-careers-memphis",
    },
    {
        ...
        readTime: "6 min read",
        icon: "fa-users",
        href: "/resources/career-guides/networking-memphis",
    },
    {
        ...
        href: "/resources/career-guides/remote-work-memphis",
    },
    {
        ...
        icon: "fa-handshake",
        href: "/resources/career-guides/negotiating-offers-memphis",
    },
    {
        ...
        readTime: "9 min read",
        icon: "fa-rocket",
        href: "/resources/career-guides/first-90-days-memphis",
    },
    {
        ...
        readTime: "8 min read",
        icon: "fa-badge-check",
        href: "/resources/career-guides/personal-branding-memphis",
    },
];
                ...
                <div className="container mx-auto px-4 relative z-10 py-16">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="hero-headline text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight leading-[0.95] mb-6 opacity-0 text-white">
                            Career <span className="text-teal">Guides</span>
                        </h1>

                        <p className="hero-subtext text-lg md:text-xl leading-relaxed opacity-0 text-white/70">
                            Expert advice and actionable strategies to advance
                            your career at every stage. From switching roles to
                            negotiating offers — we've got you covered.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="cta-card max-w-3xl mx-auto text-center relative p-8 md:p-12 border-4 border-purple bg-white opacity-0">
                        ...
                        <div className="relative">
                            ...
                            <p className="text-base leading-relaxed text-dark/70 mb-6">
                                ...
                                companies and start applying with confidence.
                            </p>
