...
export const metadata: Metadata = {
    ...
    description:
        "Prepare for interviews with expert tips, questions, and strategies.",
    openGraph: {
        title: "Interview Prep",
        description:
            "Prepare for interviews with expert tips, questions, and strategies.",
        url: "https://applicant.network/resources/interview-prep",
    },
    ...buildCanonical("/resources/interview-prep"),
};
                            ...
                            <div className="card bg-base-100 shadow">
                                <div className="card-body">
                                    <p className="mb-4 text-base-content/70">
                                        Practice answering these frequently
                                        asked questions to feel confident and
                                        prepared:
                                    </p>
                                ...
                                <div className="card-body">
                                    ...
                                    >
                                        {starMethod.map((item, index) => (
                                            <div
                                                key={index}
                                                className="bg-base-100/10 p-4 rounded-lg"
                                            >
                        ...
                        <section className="text-center">
                            <div className="card bg-base-100 shadow max-w-2xl mx-auto">
                                <div className="card-body">
                                    ...
                                    <p className="mb-4 text-base-content/70">
                                        Start applying to opportunities that
