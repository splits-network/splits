...
export const metadata: Metadata = {
    ...
    description:
        "Stay ahead with the latest hiring, salary, and market insights.",
    openGraph: {
        title: "Industry Trends",
        description:
            "Stay ahead with the latest hiring, salary, and market insights.",
        url: "https://applicant.network/resources/industry-trends",
    },
    ...buildCanonical("/resources/industry-trends"),
};
...
export default function IndustryTrendsPage() {
    const articleJsonLd = buildArticleJsonLd({
        ...
        description:
            "Stay ahead with the latest hiring, salary, and market insights.",
        path: "/resources/industry-trends",
    });
    return (
        <>
                        ...
                        <div className="container mx-auto px-4">
                            <div className="max-w-3xl">
                                ...
                                <p className="text-xl opacity-90">
                                    ...
                                    the evolving job market and emerging
                                    opportunities.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="card bg-base-100 shadow max-w-2xl mx-auto">
                                <div className="card-body">
                                    ...
                                    <p className="mb-4 text-base-content/70">
                                        Explore jobs in the sectors and roles
