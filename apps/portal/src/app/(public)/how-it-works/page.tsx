...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description:
            "See how Splits Network connects recruiters and companies for split placements, from role setup and submissions through interviews, hires, and payout tracking.",
        url: "https://splits.network/how-it-works",
    },
    ...buildCanonical("/how-it-works"),
};
...
const keyStats = [
    {
        value: "6",
        label: "Simple Steps to Placement",
        accent: "coral" as Accent,
    },
    {
        value: "2.4x",
        label: "Faster Fills via Splits",
        accent: "teal" as Accent,
    },
    {
        value: "75%+",
        label: "Recruiter Share (Pro Tier)",
        accent: "yellow" as Accent,
    },
    {
        value: "$0",
        label: "Upfront Cost for Companies",
        ...
        <HowItWorksAnimator>
            ...
            <section className="hiw-hero relative min-h-[70vh] overflow-hidden flex items-center bg-dark">
                ...
                <div className="memphis-shapes absolute inset-0 pointer-events-none overflow-hidden">
                    ...
                    {/* Plus sign — SVG attrs stay inline */}
                    <svg
                        className="memphis-shape absolute bottom-[8%] right-[15%] opacity-0"
                        width="40"
                        height="40"
                        viewBox="0 0 40 40"
                    >
                ...
                <div className="container mx-auto px-4 relative z-10 py-20">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="hero-subtext text-lg md:text-xl leading-relaxed mb-10 text-cream/70 opacity-0">
                            From posting a role to splitting the placement fee
                            -- here is the complete process, step by step. No
                            mystery. No fine print. Just a transparent path from
                            open role to successful hire.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="intro-content opacity-0">
                            ...
                            <p className="text-lg leading-relaxed mb-6 text-dark/80">
                                Splits Network connects companies who need
                                talent with specialized recruiters who know
                                where to find it. Instead of one agency trying
                                to be everything, multiple recruiters
                                collaborate on a single role -- each bringing
                                their unique network and expertise to the table.
                            </p>

                            <p className="text-lg leading-relaxed mb-6 text-dark/80">
                                One side posts the role with clear terms. The
                                other side brings the candidate. When a hire is
                                made, the placement fee is split according to
                                pre-agreed percentages. Everyone sees the
                                numbers. Everyone gets paid. No backroom deals.
                            </p>

                            <p className="text-lg leading-relaxed text-dark/80">
                                Here is exactly how every step works, from the
                                moment a role goes live to the moment the
                ...
                <div className="container mx-auto px-4">
                    <div className="pullquote max-w-4xl mx-auto relative p-8 md:p-12 border-4 border-teal opacity-0">
                        ...
                        <p className="text-2xl md:text-3xl font-black uppercase tracking-tight leading-tight mt-4 text-white">
                            The best recruiter for a role is the one who knows
                            the right candidate. Split-fee models let that
                            recruiter find that role -- every time.
                        </p>
                            ...
                            {processSteps.map((event, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-center flex-shrink-0">
                                        <div
                                            className={`step-number w-20 md:w-24 h-20 md:h-24 flex flex-col items-center justify-center relative z-10 opacity-0 ${ACCENT[event.accent].bg}`}
                                        >
                                            <div
                                                className={`text-2xl md:text-3xl font-black leading-none ${event.accent === "yellow" || event.accent === "teal" ? "text-dark" : "text-white"}`}
                                            >
                                                {event.step}
                                            </div>
                                            <i
                                                className={`${event.icon} text-xs md:text-sm mt-1 ${event.accent === "yellow" || event.accent === "teal" ? "text-dark" : "text-cream/70"}`}
                                            ></i>
                                        </div>
                                        {index < processSteps.length - 1 && (
                                            <div
                                                className={`w-1 flex-grow ${ACCENT[event.accent].bg} opacity-30`}
                                    ...
                                    <div className="pb-10 md:pb-12 pt-2">
                                        <h3
                                            className={`font-black text-xl md:text-2xl uppercase tracking-wide mb-3 ${ACCENT[event.accent].text}`}
                                        >
                                            {event.title}
                                        </h3>
                                        ...
                                        {/* Detail callout */}
                                        <div
                                            className={`inline-flex items-start gap-3 px-4 py-3 border-l-4 ${ACCENT[event.accent].border} bg-white/[0.03]`}
                                        >
                                            <i
                                                className={`fa-duotone fa-regular fa-arrow-right mt-0.5 flex-shrink-0 ${ACCENT[event.accent].text}`}
                                            ></i>
                                            <span
                                                className={`text-xs md:text-sm font-bold uppercase tracking-wide ${ACCENT[event.accent].text}`}
                                            >
                                                {event.detail}
                                            </span>
                                        </div>
                            ...
                            {Object.values(audienceCards).map((card, idx) => (
                                ...
                                >
                                    <div className="flex items-center gap-3 mb-6">
                                        <div
                                            className={`w-12 h-12 flex items-center justify-center ${ACCENT[card.accent].bg}`}
                                        >
                                            <i
                                                className={`${card.icon} text-xl ${card.accent === "yellow" || card.accent === "teal" ? "text-dark" : "text-white"}`}
                                            ></i>
                                        </div>
                                    ...
                                    <ul className="space-y-4">
                                        {card.items.map((item, i) => (
                                            ...
                                            >
                                                <i
                                                    className={`fa-duotone fa-regular fa-check mt-0.5 flex-shrink-0 ${ACCENT[card.accent].text}`}
                                                ></i>
                                                {item}
                                            </li>
                                        ))}
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="benefits-grid grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {benefits.map((benefit, index) => (
                                ...
                                >
                                    <div
                                        className={`absolute top-0 right-0 w-10 h-10 ${ACCENT[benefit.accent].bg}`}
                                    />
                                    <div
                                        className={`w-14 h-14 flex items-center justify-center mb-4 border-4 ${ACCENT[benefit.accent].border}`}
                                    >
                                        <i
                                            className={`${benefit.icon} text-2xl ${ACCENT[benefit.accent].text}`}
                                        ></i>
                                    </div>
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="money-grid grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                            <div className="money-block p-5 text-center border-4 border-coral opacity-0">
                                <div className="text-2xl md:text-3xl font-black mb-1 text-coral">
                                    $120k
                                </div>
                            ...
                            <div className="money-block p-5 text-center border-4 border-teal opacity-0">
                                <div className="text-2xl md:text-3xl font-black mb-1 text-teal">
                                    20%
                                </div>
                                <div className="text-xs font-bold uppercase tracking-[0.1em] text-dark/70">
                                    Placement Fee
                            ...
                            <div className="money-block p-5 text-center border-4 border-purple opacity-0">
                                <div className="text-2xl md:text-3xl font-black mb-1 text-purple">
                                    $24k
                                </div>
                                <div className="text-xs font-bold uppercase tracking-[0.1em] text-dark/70">
                                    Total Fee
                            ...
                            <div className="money-block p-5 text-center border-4 border-yellow opacity-0">
                                <div className="text-2xl md:text-3xl font-black mb-1 text-yellow">
                                    75%
                                </div>
                                <div className="text-xs font-bold uppercase tracking-[0.1em] text-dark/70">
                                    Recruiter Share
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="money-block p-6 border-4 border-teal bg-teal/5 text-center opacity-0">
                                ...
                                <div className="text-3xl md:text-4xl font-black mb-1 text-teal">
                                    $18,000
                                </div>
                                <div className="text-xs font-bold uppercase tracking-[0.1em] text-dark/70">
                                    Recruiter Receives
                            ...
                            <div className="money-block p-6 border-4 border-purple bg-purple/5 text-center opacity-0">
                                ...
                                <div className="text-3xl md:text-4xl font-black mb-1 text-purple">
                                    $6,000
                                </div>
                                <div className="text-xs font-bold uppercase tracking-[0.1em] text-dark/70">
                                    Platform Share
                        ...
                        <div className="mt-6 p-4 border-l-4 border-teal text-sm leading-relaxed text-dark/70">
                            ...
                            Platform share covers infrastructure, support,
                            payment processing, and continued development. Your
                            percentage increases with higher subscription tiers
                            -- Partner tier earns 85%.
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 overflow-hidden bg-dark">
                <div className="container mx-auto px-4">
                    <div className="pullquote max-w-4xl mx-auto relative p-8 md:p-12 border-4 border-yellow opacity-0">
                        ...
                        <p className="text-2xl md:text-3xl font-black uppercase tracking-tight leading-tight mt-4 text-white">
                            The future of recruiting is not solo. It is
                            networked. It is transparent. And it starts with one
                            role posted to the right marketplace.
                        </p>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center mb-12 opacity-0 max-w-4xl mx-auto">
                        ...
                        <p className="text-lg mb-10 text-cream/70">
                            Join Splits Network and experience the split-fee
                            model for yourself. Pick your path and start today.
                        </p>
                    </div>
