...
const recentUpdates = [
    ...
    },
    {
        ...
        description:
            "Core architecture built and internal testing completed. Microservices deployed, authentication configured, and foundational features validated.",
    },
];
...
const phase2Features = [
    {
        ...
        description:
            "Integrated payment flows with Stripe Connect. Companies pay platform, automatic splits distributed to recruiters.",
    },
    {
        icon: "fa-plug",
        iconColor: "text-info",
        ...
        description:
            "Connect with Gmail, Outlook, Calendly, LinkedIn, and other essential tools. Zapier integration for custom workflows.",
    },
    {
        icon: "fa-chart-line",
        iconColor: "text-primary",
        ...
        description:
            "Detailed performance metrics, ROI tracking, conversion rates, and custom reporting dashboards for both recruiters and companies.",
    },
    {
        ...
        title: "Mobile Apps",
        description:
            "Native iOS and Android apps for recruiters to manage candidates and track placements on the go.",
    },
];
...
const phase3Features = [
    {
        ...
        description:
            "Smart candidate-to-role matching using machine learning. Automatic recruiter recommendations based on specialties.",
    },
    {
        icon: "fa-users-gear",
        iconColor: "text-primary",
        ...
        description:
            "Support for multiple recruiters collaborating on a single placement with configurable split percentages.",
    },
    {
        icon: "fa-code",
        iconColor: "text-secondary",
        title: "Public API",
        description:
            "Full REST API with webhooks, OAuth 2.0, and comprehensive documentation for custom integrations.",
    },
    {
        icon: "fa-tags",
        iconColor: "text-success",
        ...
        description:
            "Recruiting firms can customize branding, domain, and certain features for their own recruiter networks.",
    },
];
...
const futureVision = [
    {
        icon: "fa-globe",
        text: "International expansion with multi-currency support",
    },
    {
        icon: "fa-building-columns",
        text: "Enterprise features for large recruiting firms and staffing agencies",
    },
    {
        icon: "fa-graduation-cap",
        text: "Training and certification programs for recruiters",
    },
    {
        icon: "fa-trophy",
        text: "Gamification and leaderboards to foster healthy competition",
    },
    {
        icon: "fa-handshake",
        text: "Marketplace for specialized recruiting services and consulting",
    },
];
...
const resourceLinks = [
    ...
    {
        href: "https://docs.splits.network",
        icon: "fa-book",
        iconColor: "text-info",
        title: "Documentation",
        description: "Read detailed guides and API docs",
        isExternal: true,
    },
    {
        href: "https://github.com/splits-network/splits",
        icon: "fa-github",
        iconColor: "",
        title: "Open Source",
        description: "View our public repositories",
        isExternal: true,
        isBrand: true,
    },
];
...
export function UpdatesContent() {
    ...
    useGSAP(
        () => {
            ...
            const heading =
                timelineRef.current.querySelector(".section-heading");
            const cards =
    ...
    useGSAP(
        () => {
            ...
            const heading =
                roadmapRef.current.querySelector(".section-heading");
            const phaseHeadings =
                roadmapRef.current.querySelectorAll(".phase-heading");
            const featureCards =
                roadmapRef.current.querySelectorAll(".feature-card");
    ...
    useGSAP(
        () => {
            ...
            const content = newsletterRef.current.querySelector(
                ".newsletter-content",
            );
    ...
    return (
        <>
            ...
            <section
                ref={heroRef}
                className="hero bg-gradient-to-r from-primary to-secondary text-primary-content py-20 overflow-hidden"
            >
                <div className="hero-content text-center max-w-5xl">
                    <div>
                        ...
                        <p className="text-xl opacity-90 max-w-3xl mx-auto">
                            ...
                            what's coming next for Splits Network
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section
                ref={bannerRef}
                className="py-12 bg-info text-info-content overflow-hidden"
            >
                <div className="container mx-auto px-4">
                    <div className="banner-content max-w-4xl mx-auto text-center">
                        <div className="badge badge-lg badge-success mb-4">
                            NOW LIVE
                        </div>
                        ...
                        <p className="text-lg opacity-90">
                            The foundation is here! Essential ATS, split
                            tracking, and recruiter network features are now
                            available.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="space-y-8">
                            {recentUpdates.map((update, index) => (
                                <div
                                    key={index}
                                    className="timeline-card card bg-base-200 shadow"
                                >
                                    <div className="card-body">
                                        <div className="flex flex-col lg:flex-row gap-6">
                                            <div className="flex-shrink-0">
                                                <div
                                                    className={`badge ${update.badgeClass} badge-lg`}
                                                >
                                                    {update.date}
                                                </div>
                                            </div>
                                            <div className="flex-grow">
                                                <h3 className="text-2xl font-bold mb-3">
                                                    <i
                                                        className={`fa-duotone fa-regular ${update.icon} ${update.iconColor}`}
                                                    ></i>{" "}
                                                    {update.title}
                                                </h3>
                                                    ...
                                                    <ul className="space-y-2 text-sm">
                                                        {update.bullets.map(
                                                            (
                                                                ...
                                                                >
                                                                    <i
                                                                        className={`fa-duotone fa-regular fa-arrow-right ${update.iconColor} mt-1`}
                                                                    ></i>
                                                                    <span>
                                                                        {bullet}
                                                                    </span>
                                    ...
                                    >
                                        <div className="card-body">
                                            <h4 className="card-title">
                                                <i
                                                    className={`fa-duotone fa-regular ${feature.icon} ${feature.iconColor}`}
                                                ></i>
                                                {feature.title}
                                            </h4>
                                ...
                                <div className="card-body">
                                    <ul className="space-y-3">
                                        {futureVision.map((item, index) => (
                                            ...
                                            >
                                                <i
                                                    className={`fa-duotone fa-regular ${item.icon} mt-1`}
                                                ></i>
                                                <span>{item.text}</span>
                                            </li>
                                        ))}
                        ...
                        <div className="feedback-card card bg-primary text-primary-content shadow">
                            <div className="card-body text-center p-12">
                                ...
                                <p className="text-lg opacity-90 mb-8">
                                    ...
                                    priorities. Share what features matter most
                                    to you, and vote on what we should build
                                    next.
                                </p>
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <a
                                        href="mailto:feedback@splits.network"
                                    ...
                                    <a
                                        ...
                                        className="btn btn-lg btn-outline btn-neutral"
                                    >
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="grid md:grid-cols-3 gap-6">
                            {resourceLinks.map((link, index) => {
                                const CardWrapper = link.isExternal
                                    ? "a"
                                    : Link;
                                ...
                                return (
                                    ...
                                    >
                                        <div className="card-body text-center">
                                            <i
                                                className={`${link.isBrand ? "fa-brands" : "fa-duotone fa-regular"} ${link.icon} text-4xl ${link.iconColor} mb-3`}
                                            ></i>
            ...
            >
                <div className="cta-content container mx-auto px-4 text-center">
                    ...
                    <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
                        Be part of the platform that's redefining split-fee
                        recruiting. Early users help shape the future.
                    </p>
