...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        url: "https://splits.network/updates",
    },
    ...buildCanonical("/updates"),
};
...
const keyStats = [
    ...
    {
        value: "3 Apps",
        label: "Portal, Candidate, Corporate",
        bg: "bg-teal",
        fg: "text-white",
    },
    {
...
const futureVision = [
    ...
    },
    {
        ...
        text: "Enterprise features for large recruiting firms",
        border: "border-teal",
        bg: "bg-teal",
        iconFg: "text-dark",
    },
    {
        ...
        text: "Training and certification programs",
        border: "border-yellow",
        bg: "bg-yellow",
        iconFg: "text-dark",
    },
    {
        ...
        text: "Gamification and leaderboards",
        border: "border-purple",
        bg: "bg-purple",
        iconFg: "text-white",
    },
    {
        ...
        text: "Specialized recruiting services marketplace",
        border: "border-coral",
        bg: "bg-coral",
        iconFg: "text-white",
    },
                ...
                <div className="container mx-auto px-4 relative z-10 py-20">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="hero-subtext text-lg md:text-xl leading-relaxed mb-10 text-cream/70 opacity-0">
                            We build in the open. Every feature shipped, every
                            milestone hit, every ambitious plan for what&apos;s
                            next -- laid out for the community that&apos;s
                            building this platform with us.
                        </p>
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="intro-section opacity-0">
                            ...
                            <p className="text-lg leading-relaxed mb-6 text-dark/80">
                                Splits Network started with a simple
                                observation: the recruiting industry runs on
                                trust, but the tools recruiters use are built
                                behind closed doors. We decided to do things
                                differently. Every feature we ship, every
                                decision we make, every roadmap item we
                                prioritize -- it&apos;s all here.
                            </p>

                            <p className="text-lg leading-relaxed mb-6 text-dark/80">
                                This page is a living document. It tracks where
                                we&apos;ve been, where we are now, and where
                                we&apos;re headed. We update it with every major
                                release. If you&apos;re evaluating the platform,
                                considering joining as a recruiter, or just
                                curious about how we operate -- this is the
                                place.
                            </p>

                            <p className="text-lg leading-relaxed text-dark/80">
                                We believe transparency isn&apos;t just a value.
                                It&apos;s a competitive advantage. When users
                                know exactly what they&apos;re getting and
                                what&apos;s coming, trust grows. And trust is
                ...
                <div className="container mx-auto px-4">
                    <div className="pullquote max-w-4xl mx-auto relative p-8 md:p-12 border-4 border-teal opacity-0">
                        ...
                        <p className="text-2xl md:text-3xl font-black uppercase tracking-tight leading-tight mt-4 text-white">
                            ...
                            livelihood, show them exactly how the sausage gets
                            made. Transparency isn&apos;t a feature. It&apos;s
                            the foundation.
                        </p>
                            ...
                            {timelineEvents.map((event, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-center flex-shrink-0">
                                        <div
                                            className={`w-20 md:w-24 py-2 text-center font-black text-sm md:text-base ${event.bg} ${event.fg}`}
                                        >
                                            {event.year}
                                        </div>
                                        {index < timelineEvents.length - 1 && (
                                            <div
                                                className={`w-1 flex-grow ${event.barBg}`}
                                    ...
                                    <div className="pb-8 md:pb-10">
                                        <h3
                                            className={`font-black text-lg md:text-xl uppercase tracking-wide mb-2 ${event.titleColor}`}
                                        >
                                            {event.title}
                                        </h3>
                        ...
                        <div className="roadmap-grid-1 grid md:grid-cols-2 gap-6">
                            {phase2Features.map((feature, index) => (
                                ...
                                >
                                    ...
                                    >
                                        <i
                                            className={`${feature.icon} text-2xl ${feature.iconColor}`}
                                        ></i>
                                    </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="pullquote max-w-4xl mx-auto relative p-8 md:p-12 border-4 border-coral opacity-0">
                        ...
                        <p className="text-2xl md:text-3xl font-black uppercase tracking-tight leading-tight mt-4 text-dark">
                            ...
                            building the infrastructure that makes collaborative
                            recruiting the default, not the exception.
                        </p>
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="vision-grid grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {futureVision.map((item, index) => (
                                ...
                                >
                                    <div
                                        className={`w-14 h-14 mx-auto mb-4 flex items-center justify-center ${item.bg}`}
                                    >
                                        <i
                                            className={`${item.icon} text-xl ${item.iconFg}`}
                                        ></i>
                                    </div>
            ...
            <section className="py-16 overflow-hidden bg-white">
                <div className="container mx-auto px-4">
                    <div className="pullquote max-w-4xl mx-auto relative p-8 md:p-12 border-4 border-yellow opacity-0">
                        ...
                        <p className="text-2xl md:text-3xl font-black uppercase tracking-tight leading-tight mt-4 text-dark">
                            The best platforms aren&apos;t built by companies
                            alone. They&apos;re shaped by the communities that
                            use them. This roadmap is yours as much as it is
                            ours.
                        </p>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center mb-12 opacity-0 max-w-4xl mx-auto">
                        ...
                        <p className="text-lg mb-10 text-cream/70">
                            ...
                            Tell us what features matter most, report issues, or
                            just say hello.
                        </p>
                    </div>
                    ...
                    <div className="cta-newsletter max-w-xl mx-auto text-center opacity-0">
                        <div className="p-8 border-4 border-purple">
                            ...
                            <p className="text-sm mb-6 text-cream/60">
                                Get notified when we ship new features and
                                updates. Monthly updates. No spam. Unsubscribe
                                anytime.
                            </p>
                            <div className="flex gap-0">
                                ...
                                />
                                <button className="px-6 py-3 font-bold uppercase tracking-wider text-sm border-4 border-purple bg-purple text-white transition-transform hover:-translate-y-0.5">
                                    Subscribe
                                </button>
                            </div>
                        </div>
