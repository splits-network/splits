...
const features = [
    {
        ...
        description:
            "Every split is clear upfront. No surprises, no hidden fees, no mystery math.",
        color: "bg-teal-500",
    },
    {
        ...
        description:
            "Platform handles all the math. Splits calculated automatically based on agreed terms.",
        color: "bg-coral-500",
    },
    {
        ...
        description:
            "Split terms locked in before work starts. No disputes, no renegotiations.",
        color: "bg-yellow-500",
    },
    {
        ...
        title: "Fast Payouts",
        description:
            "Get paid when placements close. Automated payout processing via Stripe.",
        color: "bg-purple-500",
    },
];
...
export default function SplitFeesMemphisPage() {
    return (
        <SplitFeesAnimator>
                ...
                <div className="container mx-auto px-4 relative z-10 py-20">
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <p className="hero-subtext text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed opacity-0 text-white/80">
                            The split-fee marketplace where recruiters get paid
                            what they're worth. No mystery math, no fee
                            disputes.
                        </p>
            ...
            <section
                id="how-it-works"
                className="split-how py-24 overflow-hidden bg-base-50"
            >
                        ...
                        {howItWorks.map((step, index) => (
                            ...
                            >
                                ...
                                <div className="mt-4 mb-4">
                                    <i
                                        className={`${step.icon} text-3xl text-base-950`}
                                    ></i>
                                </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="features-heading text-center mb-16 opacity-0 max-w-3xl mx-auto">
                        ...
                        <p className="text-lg text-base-950/70">
                            Every feature designed to protect recruiters and
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center mb-12 opacity-0 max-w-4xl mx-auto">
                        ...
                        <p className="text-xl mb-12 text-base-950/70">
                            Join the marketplace where recruiters get paid what
                            they deserve.
                        </p>
                    </div>
