...
const features = [
    {
        ...
        description:
            "Live metrics that update as your team works. See pipeline health, placement rates, and revenue at a glance.",
        color: "bg-yellow-500",
    },
    {
        ...
        description:
            "Individual and team metrics. Identify top performers and optimize recruiting workflows.",
        color: "bg-coral-500",
    },
    {
        ...
        description:
            "Build reports that matter to your business. Export data for executive summaries and board meetings.",
        color: "bg-teal-500",
    },
    {
        ...
        description:
            "Visualize candidate flow through stages. Spot bottlenecks before they become problems.",
        color: "bg-purple-500",
    },
];
...
export default function AnalyticsMemphisPage() {
    return (
        <AnalyticsAnimator>
                ...
                <div className="container mx-auto px-4 relative z-10 py-20">
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <p className="hero-subtext text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed opacity-0 text-white/80">
                            Dashboards that actually help you recruit better.
                            Live metrics, custom reports, and pipeline
                            analytics.
                        </p>
                        ...
                        <div className="hero-cta-row flex flex-col sm:flex-row gap-4 justify-center">
                            <a
                                href="/sign-up"
                                className="hero-cta-btn inline-flex items-center justify-center gap-3 px-8 py-4 text-lg font-bold uppercase tracking-wider border-4 border-yellow-500 bg-yellow-500 text-base-950 transition-transform hover:-translate-y-1 opacity-0"
                            >
            ...
            <section
                id="features"
                className="analytics-features py-24 overflow-hidden bg-base-50"
            >
                <div className="container mx-auto px-4">
                    <div className="features-heading text-center mb-16 opacity-0 max-w-3xl mx-auto">
                        <span className="inline-block px-4 py-1 text-xs font-bold uppercase tracking-[0.2em] mb-4 bg-yellow-500 text-base-950">
                            Features
                        </span>
                        ...
                        <p className="text-lg text-base-950/70">
                            Stop guessing. Start measuring. Every metric you
                            need to run a world-class recruiting operation.
                        </p>
                    </div>
            ...
            <section className="analytics-metrics-showcase py-24 overflow-hidden bg-white">
                <div className="container mx-auto px-4">
                    <div className="metrics-showcase-heading text-center mb-16 opacity-0 max-w-3xl mx-auto">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tight mb-6 text-base-950">
                            Metrics That{" "}
                            <span className="text-coral-500">Matter</span>
                        </h2>
                    </div>
                    ...
                    <div className="metrics-grid grid grid-cols-2 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        {metrics.map((metric, index) => (
                            <div
                                key={index}
                                className="metric-item relative p-6 border-4 border-base-950 bg-base-50 opacity-0 text-center"
                            >
                                <i
                                    className={`${metric.icon} text-4xl mb-3 ${metric.color}`}
                                ></i>
                                <h3 className="font-black text-sm uppercase tracking-wide text-base-950">
                                    {metric.label}
                                </h3>
                            </div>
                        ))}
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center mb-12 opacity-0 max-w-4xl mx-auto">
                        ...
                        <p className="text-xl mb-12 text-base-950/70">
                            Join teams who replaced spreadsheets with real-time
                            dashboards.
                        </p>
                    </div>
                    ...
                    <div className="cta-buttons flex flex-col sm:flex-row gap-4 justify-center opacity-0">
                        <a
                            href="/sign-up"
                            className="inline-flex items-center justify-center gap-3 px-8 py-4 text-lg font-bold uppercase tracking-wider border-4 border-yellow-500 bg-yellow-500 text-base-950 transition-transform hover:-translate-y-1"
                        >
                            <i className="fa-duotone fa-regular fa-rocket"></i>
                            Start Tracking
                        </a>
