...
const features = [
    {
        ...
        description:
            "Visual kanban boards that show exactly where every candidate stands. Drag, drop, done.",
        color: "bg-coral-500",
    },
    {
        ...
        description:
            "Complete profiles with resumes, notes, interview history, and communication logs in one place.",
        color: "bg-teal-500",
    },
    {
        ...
        description:
            "Internal notes, @mentions, and activity feeds keep everyone synchronized.",
        color: "bg-yellow-500",
    },
    {
        ...
        title: "Quick Actions",
        description:
            "Send emails, schedule interviews, and update statuses without leaving the page.",
        color: "bg-purple-500",
    },
];
...
export default function ATSMemphisPage() {
    return (
        <ATSAnimator>
            ...
            <section className="ats-hero relative min-h-[90vh] overflow-hidden flex items-center bg-base-950">
                ...
                <div className="memphis-shapes absolute inset-0 pointer-events-none overflow-hidden">
                    ...
                    <MemphisTriangle
                        ...
                        size="md"
                        rotation={-15}
                        className="absolute top-[35%] left-[45%] opacity-0"
                    />
                    ...
                    <MemphisPlus
                        color="yellow"
                        size="md"
                        className="absolute top-[75%] left-[38%] opacity-0"
                    />
                </div>
                ...
                <div className="container mx-auto px-4 relative z-10 py-20">
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <p className="hero-subtext text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed opacity-0 text-white/80">
                            Built-in ATS that actually works. Manage pipelines,
                            track applications, and never lose a candidate
                            again.
                        </p>
            ...
            <section
                id="features"
                className="ats-features py-24 overflow-hidden bg-base-50"
            >
                <div className="container mx-auto px-4">
                    <div className="features-heading text-center mb-16 opacity-0 max-w-3xl mx-auto">
                        ...
                        <p className="text-lg text-base-950/70">
                            No bloat, no complexity. Just the tools you actually
                            need to track candidates.
                        </p>
                    </div>
                    ...
                    <div className="features-grid grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        {features.map((feature, index) => (
                            ...
                            >
                                ...
                                />
                                <div
                                    className={`w-16 h-16 flex items-center justify-center mb-4 border-4 border-base-950`}
                                >
                                    <i
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center mb-12 opacity-0 max-w-4xl mx-auto">
                        ...
                        <p className="text-xl mb-12 text-base-950/70">
                            Join thousands of recruiters who never lose a
                            candidate.
                        </p>
                    </div>
