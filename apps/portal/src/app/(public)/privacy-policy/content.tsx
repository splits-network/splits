    ...
    return (
        <main className="overflow-hidden">
                            ...
                            <ul className="space-y-3 pl-4">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span>
                                        ...
                                        splits.network and applicant.network
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <i className="fa-duotone fa-regular fa-chevron-right text-primary text-sm mt-1.5 flex-shrink-0"></i>
                        ...
                        <div className="split-text-left lg:col-span-3">
                            ...
                            <div className="space-y-4 text-base-content/70 leading-relaxed text-lg">
                                ...
                                <p>
                                    ...
                                    choose to integrate with Splits Network.
                                </p>
                                <p>
                                    <strong className="text-base-content font-bold">
                                        Public Sources:
                    ...
                    <div className="article-block max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                            ...
                            <p>
                                ...
                                the core Splits Network platform: creating and
                                managing your account, facilitating
            ...
            {/* ═══════════════════════════════════════════════════════
                PULL QUOTE 1
               ═══════════════════════════════════════════════════════ */}
            <section className="pull-quote-block py-20 bg-base-300 text-base-content">
                <div className="container mx-auto px-6 lg:px-12">
                ...
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="article-block max-w-3xl mx-auto">
                        ...
                        <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                            ...
                            <p>
                                When a recruiter chooses to connect their Google
                                account, we request only the minimum scopes
                            ...
                            <p>
                                You can disconnect your Google account at any
                                time from your{" "}
                                <strong className="text-base-content">
                                    Account Settings &rarr; Integrations
                                </strong>{" "}
                                page. You can also revoke access directly from
                                your{" "}
                                <a
                                ...
                                . Revoking access does not affect your Splits
                                Network account.
                            </p>
                ...
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-start">
                        ...
                        <div className="split-text-left lg:col-span-3">
                            ...
                            <div className="space-y-6 text-base-content/70 leading-relaxed text-lg">
                                <p>
                                    Splits Network uses artificial intelligence
                                    and automated processing, powered by
                                    OpenAI&apos;s technology, to enhance our
                                    platform services. We are committed to using
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            ...
                            >
                                ...
                                <p className="text-sm text-base-content/60">
                                    The terms governing your use of the Splits
                                    Network platform.
                                </p>
