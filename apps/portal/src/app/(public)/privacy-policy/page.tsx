                ...
                <div className="container mx-auto px-4 max-w-4xl">
                    ...
                    <section id="cookies" className="mb-12">
                        ...
                        <div className="card bg-base-100 border border-base-300 shadow">
                            <div className="card-body">
                                <p className="mb-4">
                                    We use cookies and similar technologies to improve your experience. For detailed information, see our <Link href="/cookie-policy" className="link link-primary">Cookie Policy</Link>.
                                </p>
                    ...
                    <section className="py-12 text-center border-t border-base-300 mt-12">
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-4 justify-center flex-wrap">
                                <a href="/terms-of-service" className="link link-primary">Terms of Service</a>
                                <a href="/cookie-policy" className="link link-primary">Cookie Policy</a>
