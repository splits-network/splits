...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description:
            "Discover the connected ecosystem powering Splits Network. From email and calendar to automation and API access, integrate with the tools your team already uses.",
        url: "https://splits.network/integration-partners",
    },
    ...buildCanonical("/integration-partners"),
};
...
const integrationCategories = [
    {
        ...
        description:
            "Stay connected with candidates and teams through the channels they prefer.",
        integrations: [
    ...
    },
    {
        ...
        badgeText: "text-cream",
        description:
            "Automate interview scheduling and sync availability across platforms.",
        integrations: [
            {
                name: "Calendly",
    ...
    },
    {
        ...
        badgeText: "text-dark",
        description:
            "Source talent and enrich candidate profiles from professional networks.",
        integrations: [
            {
                name: "LinkedIn",
    ...
    },
    {
        ...
        badgeText: "text-cream",
        description:
            "Connect to thousands of apps with no-code workflow automation.",
        integrations: [
            {
                name: "Zapier",
                icon: "fa-duotone fa-regular fa-bolt",
    ...
    },
    {
        ...
        badgeText: "text-cream",
        description:
            "Build custom integrations with our comprehensive REST API and real-time webhooks.",
        integrations: [
            {
                name: "REST API",
                icon: "fa-duotone fa-regular fa-code",
        ...
        <IntegrationsAnimator>
            ...
            <section className="article-hero relative min-h-[70vh] overflow-hidden flex items-center bg-dark">
                ...
                <div className="memphis-shapes absolute inset-0 pointer-events-none overflow-hidden">
                    ...
                    {/* Connection nodes */}
                    <svg
                        className="memphis-shape absolute top-[35%] right-[5%] opacity-0"
                        width="80"
                        height="80"
                        viewBox="0 0 80 80"
                    >
                ...
                <div className="container mx-auto px-4 relative z-10 py-20">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="hero-subtext text-lg md:text-xl leading-relaxed mb-10 text-cream/70 opacity-0">
                            Your recruiting workflow touches a dozen tools every
                            day. Splits Network connects them all -- so data
                            flows, schedules sync, and nothing falls through the
                            cracks.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="article-section opacity-0">
                            ...
                            <p className="text-lg leading-relaxed mb-6 text-dark/80">
                                Recruiting doesn&apos;t happen in one tool. You
                                source on LinkedIn, schedule through Calendly,
                                communicate over Slack, and track everything in
                                your ATS. The average recruiter switches between
                                8 different applications every single day.
                            </p>

                            <p className="text-lg leading-relaxed mb-6 text-dark/80">
                                Every time you copy data from one system to
                                another, you lose time and risk errors. A
                                candidate&apos;s email gets mistyped. An
                                interview doesn&apos;t make it to the calendar.
                                A status update gets lost between tabs. These
                                aren&apos;t minor annoyances -- they&apos;re the
                                friction that slows down placements.
                            </p>

                            <p className="text-lg leading-relaxed text-dark/80">
                                Splits Network&apos;s integration ecosystem
                                eliminates that friction. Connect the tools you
                                already use, and let data flow automatically
                                between them. One source of truth. Zero manual
                                syncing.
                            </p>
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="pullquote max-w-4xl mx-auto relative p-8 md:p-12 border-4 border-teal opacity-0">
                        ...
                        <p className="text-2xl md:text-3xl font-black uppercase tracking-tight leading-tight mt-4 text-cream">
                            The best recruiting workflows don&apos;t require you
                            to think about tools. They just work -- connected,
                            automatic, invisible.
                        </p>
                        ...
                        <div className="categories-grid grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {integrationCategories.map((cat, index) => (
                                ...
                                >
                                    {/* Corner accent */}
                                    <div
                                        className={`absolute top-0 right-0 w-10 h-10 bg-${cat.colorClass}`}
                                    />

                                    {/* Category badge */}
                                    <span
                                        className={`inline-block px-3 py-1 text-[10px] font-bold uppercase tracking-[0.2em] mb-5 bg-${cat.colorClass} ${cat.badgeText}`}
                                    >
                                        {cat.category}
                                    </span>
                                    ...
                                    {/* Icon */}
                                    <div
                                        className={`w-14 h-14 flex items-center justify-center mb-4 border-4 border-${cat.colorClass}`}
                                    >
                                        <i
                                            className={`${cat.icon} text-2xl text-${cat.colorClass}`}
                                        ></i>
                                    </div>
                                            ...
                                            (integration, i) => (
                                                ...
                                                >
                                                    <div className="flex items-center gap-2">
                                                        <i
                                                            className={`${integration.icon} text-sm text-${cat.colorClass}`}
                                                        ></i>
                                                    ...
                                                    <span
                                                        className={`text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 bg-${cat.colorClass} ${cat.badgeText}`}
                                                    >
                                                        {integration.status}
                                                    </span>
                                                </div>
                            ...
                            {connectSteps.map((step, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-center flex-shrink-0">
                                        <div
                                            className={`w-16 md:w-20 py-2 text-center font-black text-lg md:text-xl ${step.bgClass} ${step.textClass}`}
                                        >
                                            {step.step}
                                        </div>
                                        {index < connectSteps.length - 1 && (
                                            <div
                                                className={`w-1 flex-grow min-h-[40px] ${step.bgClass} opacity-30`}
                                            />
                                        )}
                                    </div>
                                    ...
                                    <div className="pb-8 md:pb-10">
                                        <h3
                                            className={`font-black text-lg md:text-xl uppercase tracking-wide mb-2 ${step.titleClass}`}
                                        >
                                            {step.title}
                                        </h3>
                ...
                <div className="container mx-auto px-4">
                    <div className="pullquote max-w-4xl mx-auto relative p-8 md:p-12 border-4 border-coral opacity-0">
                        ...
                        <p className="text-2xl md:text-3xl font-black uppercase tracking-tight leading-tight mt-4 text-dark">
                            ...
                            share the same data, you stop managing tools and
                            start managing talent.
                        </p>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-5xl mx-auto">
                        <div className="roadmap-heading text-center mb-12 opacity-0">
                            ...
                            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight text-dark">
                                Coming <span className="text-teal">Soon</span>
                            </h2>
                        </div>
                        ...
                        <div className="coming-section opacity-0">
                            <p className="text-lg leading-relaxed mb-10 max-w-3xl mx-auto text-center text-dark/80">
                                We&apos;re building fast. These integrations are
                                actively in development and will be rolling out
                                throughout 2026. Request early access to get
                                notified when your favorite tools go live.
                            </p>
                        </div>
                        ...
                        <div className="roadmap-grid grid md:grid-cols-2 gap-6">
                            {comingSoonIntegrations.map((item, index) => (
                                ...
                                >
                                    {/* Corner accent */}
                                    <div
                                        className={`absolute top-0 right-0 w-10 h-10 bg-${item.colorClass}`}
                                    />

                                    <div className="flex items-center gap-3 mb-4">
                                        <div
                                            className={`w-12 h-12 flex items-center justify-center border-4 border-${item.colorClass}`}
                                        >
                                            <i
                                                className={`${item.icon} text-xl text-${item.colorClass}`}
                                            ></i>
                                        </div>
                                        <div>
                                            ...
                                            <span
                                                className={`text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 bg-${item.colorClass} ${item.badgeText}`}
                                            >
                                                {item.timeline}
                                            </span>
                                        </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="pullquote max-w-4xl mx-auto relative p-8 md:p-12 border-4 border-yellow opacity-0">
                        ...
                        <p className="text-2xl md:text-3xl font-black uppercase tracking-tight leading-tight mt-4 text-cream">
                            ...
                            more tools. It&apos;s about having tools that talk
                            to each other.
                        </p>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center mb-12 opacity-0 max-w-4xl mx-auto">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tight mb-6 leading-[1] text-cream">
                            Ready To <span className="text-coral">Connect</span>{" "}
                            Your Workflow?
                        </h2>
                        <p className="text-lg mb-10 text-cream/70">
                            Splits Network integrates with the tools you already
                            use. Pick your path and start building seamless
                            workflows today.
                        </p>
                    </div>
                    ...
                    <div className="cta-footer text-center opacity-0">
                        <p className="text-sm mb-3 text-cream/50">
                            Don&apos;t see the integration you need? Let us
                            know.
                        </p>
                        <a
                            href="mailto:integrations@splits.network"
