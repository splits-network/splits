...
const baselColors = [
    {
        ...
        hex: "#233876",
        usage: "Navigation, CTAs, brand anchors",
        swatch: "bg-primary",
    ...
    },
    {
        ...
        hex: "#0f9d8a",
        usage: "Supporting actions, confirmations",
        swatch: "bg-secondary",
    ...
    },
    {
        ...
        cssVar: "--color-accent",
        hex: "#db2777",
        usage: "Badges, highlights, focal points",
        swatch: "bg-accent",
...
const baseSurfaces = [
    ...
    },
    {
        ...
        token: "base-300",
        hex: "#e4e4e7",
        usage: "Borders, dividers, muted areas",
        swatch: "bg-base-300",
        text: "text-base-content",
    },
    {
        ...
        token: "base-content",
        hex: "#18181b",
        usage: "Default text on light surfaces",
        swatch: "bg-base-content",
        text: "text-base-100",
    },
];
...
const keyFacts = [
    ...
    {
        value: "$0",
        label: "Cost for Companies to Post",
        border: "border-secondary",
        text: "text-secondary",
    },
    {
        value: "0-100%",
        label: "Flexible Recruiter Split",
        ...
        <main ref={mainRef} className="overflow-hidden">
            ...
            <section className="hero-section relative min-h-[70vh] flex items-center bg-base-100">
                ...
                >
                    ...
                    <div
                        className="absolute inset-0 opacity-10 text-primary-content"
                        style={{
                            backgroundImage:
                        ...
                        <div className="lg:col-span-3 space-y-10">
                            <div className="overview-card border-l-4 border-primary pl-6 opacity-0">
                                ...
                                <p className="text-base text-base-content/70 leading-relaxed">
                                    Splits Network is a recruiting marketplace
                                    built for split-fee placements. Companies
                                    post roles at no cost. Specialized
                                    recruiters engage based on their expertise.
                                    The platform tracks every interaction,
                                    enforces agreed split terms, and distributes
                                    payments on verified outcomes -- replacing
                            ...
                            <div className="overview-card border-l-4 border-secondary pl-6 opacity-0">
                                ...
                                <div className="bg-neutral text-neutral-content p-6 shadow-md">
                                    <p className="italic leading-relaxed">
                                        ...
                                        roles and specialized recruiters compete
                                        to fill them. The platform provides a
                                        built-in applicant tracking system,
                                        transparent fee structures, and
                                        automated split accounting -- replacing
                                        the manual coordination that has defined
                                        collaborative recruiting for decades.
                                        Built by recruiting industry
                                        practitioners, not retrofitted from
                ...
                <div className="container mx-auto px-6 lg:px-12">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-12">
                        <div className="typo-card border-l-4 border-primary bg-base-200 p-8 shadow-sm opacity-0">
                            ...
                            <p className="text-sm text-base-content/60">
                                SF Pro on macOS, Segoe UI on Windows, Roboto on
                                Android. No web fonts to load -- renders
                            ...
                            <div className="mt-4 border-t border-base-300 pt-4">
                                ...
                                <p className="text-sm text-base-content/60 mt-1">
                                    Headlines, body text, navigation, buttons,
                                    form labels.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="typo-card border-l-4 border-secondary bg-base-200 p-8 shadow-sm opacity-0">
                            ...
                            <p className="text-sm text-base-content/60">
                                SF Mono on macOS, Cascadia Mono on Windows.
                                Reserved for contexts where fixed-width
                                alignment matters.
                            </p>
                            <div className="mt-4 border-t border-base-300 pt-4">
                                <span className="text-xs font-semibold text-base-content/40 uppercase tracking-wider">
                                ...
                                <p className="text-sm text-base-content/60 mt-1">
                                    Code references, data tokens, technical
                                    identifiers.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="typo-card border-l-4 border-accent bg-base-200 p-8 shadow-sm opacity-0">
                            ...
                            <div className="text-sm text-base-content/40 leading-relaxed mb-4">
                                Same system stack, maximum weight, tight
                                tracking
                            </div>
                            <p className="text-sm text-base-content/60">
                                The wordmark is set in the same system
                                sans-serif at weight 900. No custom font file --
                                the brand identity is purely typographic.
                            </p>
                            <div className="mt-4 border-t border-base-300 pt-4">
                                <span className="text-xs font-semibold text-base-content/40 uppercase tracking-wider">
                                    Reproduction:
                                ...
                                <p className="text-sm text-base-content/60 mt-1">
                                    When reproducing externally, use SF Pro
                                    Black or Segoe UI at maximum available
                                    weight.
                                </p>
                            </div>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    weight: "font-black",
                                    spec: "5xl–7xl / 900",
                                    desc: "Hero headlines and page-level titles. Tight tracking, minimal leading.",
                                },
                                {
                                    label: "Heading 1",
                                    ...
                                    weight: "font-black",
                                    spec: "4xl–5xl / 900",
                                    desc: "Section headings and primary content divisions.",
                                },
                                {
                                    label: "Heading 2",
                                    size: "text-2xl",
                                    weight: "font-bold",
                                    spec: "2xl / 700",
                                    desc: "Subsection titles, card headers, modal titles.",
                                },
                                {
                                    label: "Heading 3",
                                    size: "text-xl",
                                    weight: "font-bold",
                                    spec: "xl / 700",
                                    desc: "Panel headers, field groups, toolbar labels.",
                                },
                                {
                                    label: "Heading 4",
                                    size: "text-lg",
                                    ...
                                    spec: "lg / 600",
                                    desc: "Minor headings, list groups, sidebar labels.",
                                },
                            ].map((h, i) => (
                                <div
                                    key={i}
                                    className={`pb-6 ${i < 4 ? "border-b border-base-300" : ""}`}
                                >
                                    <div className="flex items-baseline justify-between mb-2">
                                        <h4
                                            className={`${h.size} ${h.weight} tracking-tight text-base-content`}
                                        >
                                            {h.label}
                                        </h4>
                                        <span className="text-sm font-medium text-base-content/40 hidden sm:block">
                                            {h.spec}
                                        </span>
                                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <p className="text-base text-base-content/70 leading-relaxed mt-2">
                                        The default for all readable content.
                                ...
                                <div className="border-t border-base-300 pt-4">
                                    <span className="text-xs font-semibold text-base-content/40 uppercase tracking-wider">
                                        text-sm (14px) — Supporting
                                    </span>
                                    <p className="text-sm text-base-content/60 mt-2">
                                        Metadata, captions, bylines, and
                                ...
                                <div className="border-t border-base-300 pt-4">
                                    ...
                                    <p className="text-xs text-base-content/50 mt-2">
                                        Reserved for non-human-facing content:
                                        timestamps, version numbers, system
                                        labels.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="typo-card bg-base-200 p-8 shadow-sm opacity-0">
                            ...
                            <div className="space-y-6">
                                <div>
                                    <span className="text-xs font-semibold text-base-content/40 uppercase tracking-wider mb-3 block">
                                        Buttons &amp; CTAs
                                    </span>
                                    <div
                ...
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="color-heading max-w-3xl mb-16 opacity-0">
                        ...
                        <p className="text-lg text-base-content/60 mt-4 leading-relaxed">
                            Semantic tokens that adapt across light and dark
                            themes
                        </p>
                    </div>
                            ...
                            >
                                ...
                                <div className="p-4">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <code className="text-xs font-mono text-base-content/40">
                                            {color.hex}
                                        </code>
                                    </div>
                                    <p className="text-sm text-base-content/50">
                ...
                <div className="container mx-auto px-6 lg:px-12">
                    ...
                    <div className="text-center border-t border-base-300 pt-12 max-w-4xl mx-auto">
                        <p className="text-base text-base-content/60 mb-8 max-w-2xl mx-auto">
                            For custom assets, executive interviews, or
                            materials not listed here, reach the press team
                            directly.
                        </p>
                        <a
                            href="mailto:press@splits.network"
