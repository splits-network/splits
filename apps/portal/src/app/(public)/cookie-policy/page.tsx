...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description:
            "Learn about how Splits Network uses cookies and similar tracking technologies to improve your experience and analyze platform usage.",
        url: "https://splits.network/cookie-policy",
    },
                ...
                <div className="container mx-auto px-4 max-w-4xl">
                        ...
                        <div className="card-body">
                            ...
                            <ul className="grid md:grid-cols-2 gap-3">
                                <li>
                                    ...
                                    >
                                        <i className="fa-duotone fa-regular fa-chevron-right text-accent text-sm"></i>
                                        What Are Cookies?
                                    </a>
                                </li>
                                <li>
                            ...
                            <div className="card bg-base-100 border border-base-300 shadow">
                                <div className="card-body">
                                    <p className="mb-4">
                                        ...
                                        your device when you visit websites.
                                        They store information about your
                                        preferences, settings, and activity to
                            ...
                            <div className="card bg-base-100 border border-base-300 shadow">
                                <div className="card-body">
                                    <h3 className="card-title text-xl mb-4">
                                        <i className="fa-duotone fa-regular fa-fingerprint text-accent mr-2"></i>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="card bg-base-100 border border-base-300 shadow">
                                <div className="card-body">
                                    ...
                                    <p className="text-sm mb-4">
                                        Help us understand how you use the
                                        platform.
                                    </p>
                                    <div className="overflow-x-auto">
                                        <table className="table table-sm w-full">
                            ...
                            <div className="card bg-base-100 border border-base-300 shadow">
                                <div className="card-body">
                                    ...
                                    <p className="text-sm mb-4">
                                        Used only with your consent. Can be
                                        disabled.
                                    </p>
                                    <div className="overflow-x-auto">
                                        <table className="table table-sm w-full">
                    ...
                    <section id="third-party" className="mb-12">
                        ...
                        <div className="card bg-base-100 border border-base-300 shadow">
                            <div className="card-body">
                                <p className="mb-6">
                                    Third-party services set cookies to enhance
                                    platform functionality:
                                </p>
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3 p-4 bg-base-200 rounded">
                                        <div className="w-10 h-10 rounded flex items-center justify-center bg-primary/20">
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-base-200 rounded">
                                        <div className="w-10 h-10 rounded flex items-center justify-center bg-secondary/20">
                                            <i className="fa-duotone fa-regular fa-credit-card text-secondary"></i>
                                        </div>
                                        <div>
                                            <strong className="text-sm">
                                                Stripe
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-base-200 rounded">
                                        <div className="w-10 h-10 rounded flex items-center justify-center bg-accent/20">
                                            <i className="fa-duotone fa-regular fa-user text-accent"></i>
                                        </div>
                                        <div>
                                            <strong className="text-sm">
                                                Clerk
                    ...
                    <section id="management" className="mb-12">
                        ...
                        <div className="space-y-4">
                            <div className="card bg-base-100 border border-base-300 shadow">
                                <div className="card-body">
                                    <h3 className="card-title mb-4">
                                        <i className="fa-duotone fa-regular fa-globe text-accent mr-2"></i>
                                        Browser Settings
                                    </h3>
                                    <p className="text-sm mb-4">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-3">
                                        ...
                                        <a
                                            href="https://support.microsoft.com/en-us/windows/manage-cookies-in-microsoft-edge-bda6aba4-d4ef-4ce9-a4d4-130180968852"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="btn btn-sm btn-outline"
                                        >
                            ...
                            <div className="card bg-base-100 border border-base-300 shadow">
                                <div className="card-body">
                                    <h3 className="card-title mb-4">
                                        <i className="fa-duotone fa-regular fa-cog text-accent mr-2"></i>
                                        Cookie Preferences
                                    </h3>
                                    <p className="text-sm">
                                        You can adjust cookie preferences in
                                        your account settings or through our
                                        cookie consent banner when you first
                                        visit.
                                    </p>
                                </div>
                            </div>
                    ...
                    <section id="consent" className="mb-12">
                        ...
                        <div className="space-y-4">
                            <div className="card bg-base-100 border border-base-300 shadow">
                                <div className="card-body">
                                    <p className="text-sm mb-4">
                                        By using Splits Network, you consent to
                                        our use of cookies as described in this
                                        policy. You can always change your
                                        preferences or delete cookies through
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-base-content/70 mt-1">
                                                    You'll see a cookie consent
                                                    banner on first visit.
                                                    Accept or customize your
                                                    preferences.
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div className="card bg-base-100 border border-base-300 shadow">
                            <div className="card-body">
                                <p className="text-sm mb-4">
                                    ...
                                    feature. Currently, web standards don't
                                    require websites to honor DNT signals.
                                    However, we respect user privacy choices.
                                </p>
                                <p className="text-sm">
                                    If you have DNT enabled and want us to
                                    respect it, please contact{" "}
                                    <a
                    ...
                    <section id="updates" className="mb-12">
                        ...
                        <div className="card bg-base-100 border border-base-300 shadow">
                            <div className="card-body">
                                <p className="mb-4">
                                    We may update this Cookie Policy as our use
                                    of cookies changes or for other operational,
                                ...
                                <ul className="space-y-2 text-sm">
                                    <li className="flex items-start gap-2">
                                        <i className="fa-duotone fa-regular fa-circle-check text-success flex-shrink-0 mt-1"></i>
                                        <span>
                                            Updated policy will be posted with a
                                    ...
                                    <li className="flex items-start gap-2">
                                        <i className="fa-duotone fa-regular fa-circle-check text-success flex-shrink-0 mt-1"></i>
                                        <span>
                                            Your continued use means you accept
                                            the changes
                                        </span>
                                    </li>
                                </ul>
