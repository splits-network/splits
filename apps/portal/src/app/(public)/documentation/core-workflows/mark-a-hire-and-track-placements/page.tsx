    ...
    return (
        <>
            <JsonLd
                ...
                id="docs-core-workflows-mark-a-hire-and-track-placements-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Marking a hire closes the application workflow and
                        creates a placement record. This record powers fee
                        calculations, recruiter earnings, and guarantee
                        tracking.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide explains when to mark a hire, what data is
                        captured, and how the placement appears in reporting. It
                        also clarifies how salary and fee details affect
                        downstream calculations.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page when a hire is confirmed and you need to
                        finalize the placement record accurately.
                    </p>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-base text-base-content/70">
                        ...
                        <li>
                            Select the action to mark the candidate as{" "}
                            <strong>Hired</strong>.
                        </li>
                        <li>
                            Confirm salary and placement details if prompted.
                        </li>
                        <li>
                            Verify the placement appears in{" "}
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        A placement record is created with fee calculations and
                        recruiter shares. Placement status may continue to track
                        guarantee periods.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            <strong>Symptom:</strong> The hire action is
                            unavailable.
                            <br />
                            <strong>Likely cause:</strong> The application is
                            not at the required stage.
                            <br />
                            <strong>Fix:</strong> Move the application to Offer
                            before marking hired.
                        </div>
                        <div>
                            <strong>Symptom:</strong> The placement does not
                            appear.
                            <br />
                            <strong>Likely cause:</strong> The action did not
                            complete or data is missing.
                            <br />
                            <strong>Fix:</strong> Refresh the page or contact
                            support.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Placement:</strong> The record created after
                            a hire to track fees and payouts.
                        </div>
                    </div>
                </section>
            </div>
