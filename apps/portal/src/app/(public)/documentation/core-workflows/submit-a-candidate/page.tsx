...
export default function SubmitCandidatePage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("core-workflows/submit-a-candidate")}
                id="docs-core-workflows-submit-a-candidate-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Submitting a candidate creates an application and starts
                        the formal review process. It signals to company teams
                        that a candidate is ready for evaluation.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide walks through the submission steps and
                        highlights the information that improves review
                        outcomes, such as notes and salary expectations. It also
                        explains where the application appears after submission.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page when you are preparing to move a candidate
                        into the pipeline or troubleshooting submission issues.
                    </p>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-base text-base-content/70">
                        <li>
                            Open the role and select{" "}
                            <strong>Submit Candidate</strong>.
                        </li>
                        <li>Choose the candidate from your list.</li>
                        <li>
                            Add notes, salary expectations, or pre-screen
                            answers.
                        </li>
                        <li>
                            Submit and confirm the application appears in
                            Applications.
                        </li>
                    </ol>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        The application enters the review pipeline. Status
                        updates and feedback appear in the application timeline.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            <strong>Symptom:</strong> The submit button is
                            disabled.
                            <br />
                            <strong>Likely cause:</strong> Required fields or
                            pre-screen answers are missing.
                            <br />
                            <strong>Fix:</strong> Complete required fields and
                            try again.
                        </div>
                        <div>
                            <strong>Symptom:</strong> The application is not
                            visible.
                            <br />
                            <strong>Likely cause:</strong> Filters or view mode
                            hide the record.
                            <br />
                            <strong>Fix:</strong> Clear filters or switch to the
                            list view.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Application:</strong> The record created
                            when a candidate is submitted to a role.
                        </div>
                    </div>
                </section>
            </div>
