...
export default function CreateAndPublishRolePage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("core-workflows/create-and-publish-a-role")}
                id="docs-core-workflows-create-and-publish-a-role-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Creating a role establishes the hiring objective,
                        compensation structure, and expectations for
                        submissions. It is the foundation for every downstream
                        workflow in the platform.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide explains how to enter role details in a way
                        that supports recruiter alignment and candidate quality.
                        It also clarifies which fields control visibility, fees,
                        and guarantees.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page when opening a new role, updating an
                        existing role, or troubleshooting why a role is not
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        ...
                        <div>
                            Compensation details and requirements from the
                            hiring team.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-base text-base-content/70">
                        <li>
                            Open <strong>Roles</strong> and select{" "}
                            <strong>Add Role</strong>.
                        </li>
                        <li>
                            Enter the role title, location, and key
                            requirements.
                        </li>
                        <li>
                            Complete compensation details (salary range, fee
                            percentage, guarantee period).
                        </li>
                        <li>Choose employment type and visibility options.</li>
                        <li>
                            Save the role and confirm it appears as{" "}
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        The role becomes visible to eligible recruiters.
                        Candidates can be submitted, and applications start
                        tracking against the role.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            Use clear salary ranges to improve candidate
                            matching.
                        </div>
                        <div>
                            Confirm fee percentage and guarantee period with
                            finance teams.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            ...
                            permission or no organization is linked.
                            <br />
                            <strong>Fix:</strong> Ask a company admin to grant
                            access or confirm organization setup.
                        </div>
                        <div>
                            <strong>Symptom:</strong> The role is not visible to
                            recruiters.
                            <br />
                            <strong>Likely cause:</strong> The role is paused or
                            missing required fields.
                            <br />
                            <strong>Fix:</strong> Verify status is Active and
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Guarantee period:</strong> The number of
                            days a placement is covered after hire.
                        </div>
                        <div>
                            <strong>Fee percentage:</strong> The percentage
                            applied to salary to calculate the placement fee.
                        </div>
                    </div>
                </section>
            </div>
