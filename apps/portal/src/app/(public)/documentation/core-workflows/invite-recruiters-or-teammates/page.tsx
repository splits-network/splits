    ...
    return (
        <>
            <JsonLd
                ...
                id="docs-core-workflows-invite-recruiters-or-teammates-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Invitations control who can access your organization and
                        what they can manage. This workflow protects sensitive
                        hiring data while enabling collaboration.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide explains how to send invites, assign the
                        correct role, and verify that access is granted. It also
                        clarifies what to do when invites are pending or
                        expired.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page when onboarding new recruiters or internal
                        teammates to keep access consistent and auditable.
                    </p>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        ...
                        <div>
                            Email address for the person you want to invite.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-base text-base-content/70">
                        <li>
                            Open <strong>Invitations</strong> or{" "}
                            <strong>Team</strong>.
                        </li>
                        <li>
                            Select <strong>Invite</strong> and enter the email
                            address.
                        </li>
                        <li>
                            Choose the appropriate role (Recruiter, Hiring
                            Manager, Company Admin).
                        </li>
                        <li>
                            Send the invitation and confirm the status is
                            listed.
                        </li>
                    </ol>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        The invitee receives an email and gains access after
                        accepting. Their navigation updates based on the role
                        you assign.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        ...
                        <div>
                            Resend invitations if a teammate misses the email.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            <strong>Symptom:</strong> An invitation never
                            arrives.
                            <br />
                            <strong>Likely cause:</strong> Email filtered or
                            typo in address.
                            <br />
                            <strong>Fix:</strong> Confirm the email and resend
                            the invite.
                        </div>
                        <div>
                            <strong>Symptom:</strong> The invitee cannot see
                            expected pages.
                            <br />
                            <strong>Likely cause:</strong> Role assigned
                            incorrectly.
                            <br />
                            <strong>Fix:</strong> Update their role in Team or
                            resend the invite.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Invitation:</strong> An email-based request
                            to join an organization and receive permissions.
                        </div>
                    </div>
                </section>
            </div>
