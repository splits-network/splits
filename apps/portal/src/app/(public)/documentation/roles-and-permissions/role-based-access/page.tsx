...
export default function RoleBasedAccessPage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("roles-and-permissions/role-based-access")}
                id="docs-roles-and-permissions-role-based-access-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        ...
                        in the portal. This page explains why navigation changes
                        and how permissions map to workflows.
                    </p>
                    <p className="text-base text-base-content/70">
                        It provides a practical access matrix so you can quickly
                        identify which role owns a task or page. This reduces
                        confusion when teams collaborate across recruiting and
                        hiring functions.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this guide when assigning roles or troubleshooting
                        missing pages to avoid unnecessary delays.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            Role changes update the navigation automatically.
                        </div>
                        <div>
                            Ask a company admin to confirm your role if items
                            are missing.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            <strong>Symptom:</strong> I see fewer pages than a
                            teammate.
                            <br />
                            <strong>Likely cause:</strong> Your role permissions
                            are different.
                            <br />
                            <strong>Fix:</strong> Ask a company admin to review
                            your role assignment.
                        </div>
                        <div>
                            <strong>Symptom:</strong> I should have access but
                            do not.
                            <br />
                            <strong>Likely cause:</strong> You are linked to the
                            wrong organization.
                            <br />
                            <strong>Fix:</strong> Confirm your organization in
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Role-based access:</strong> Permissions
                            assigned to your account that control what pages and
