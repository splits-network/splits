...
export default function CompanyAdminCapabilitiesPage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("roles-and-permissions/company-admin")}
                id="docs-roles-and-permissions-company-admin-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Company admins manage the organization's access,
                        settings, and billing. This page summarizes the controls
                        that keep teams aligned and compliant.
                    </p>
                    <p className="text-base text-base-content/70">
                        It outlines what admins can configure, how they assign
                        roles, and where to resolve team access issues. If you
                        are responsible for enabling others, this is your
                        reference.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this guide to ensure the right people have the right
                        permissions before roles go live or hiring decisions
                        begin.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            ...
                            Settings.
                            <br />
                            <strong>Likely cause:</strong> You are not assigned
                            as company admin.
                            <br />
                            <strong>Fix:</strong> Ask an existing company admin
                            to update your role.
                        </div>
                        <div>
                            <strong>Symptom:</strong> Team members cannot see
                            roles.
                            <br />
                            <strong>Likely cause:</strong> Their role
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Company Admin:</strong> A user with
                            permissions to manage settings, billing, and team
                            access.
                        </div>
                        <div>
                            <strong>Team:</strong> The list of users associated
