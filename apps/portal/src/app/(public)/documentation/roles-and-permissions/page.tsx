...
export default function RolesAndPermissionsIndexPage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("roles-and-permissions")}
                id="docs-roles-and-permissions-jsonld"
            />
            <div className="space-y-8">
                <div className="space-y-3">
                    ...
                    <p className="text-base text-base-content/70 max-w-3xl">
                        Understand what each role can see and do in Splits
                        Network, and how permissions affect workflows.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    >
                        <div className="card-body">
                            ...
                            <p className="text-sm text-base-content/70">
                                What recruiters can access across roles,
                                candidates, applications, and placements.
                            </p>
                        </div>
                    </Link>
                    <Link
                    ...
                    >
                        <div className="card-body">
                            ...
                            <p className="text-sm text-base-content/70">
                                Review applications, collaborate with
                                recruiters, and manage company workflows.
                            </p>
                        </div>
                    </Link>
                    <Link
                    ...
                    >
                        <div className="card-body">
                            ...
                            <p className="text-sm text-base-content/70">
                                Manage settings, teams, and permissions across
                                the organization.
                            </p>
                        </div>
                    </Link>
                    ...
                    >
                        <div className="card-body">
                            ...
                            <p className="text-sm text-base-content/70">
                                How access is determined and why navigation
                                changes by role.
                            </p>
                        </div>
                    </Link>
