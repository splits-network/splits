...
export default function FirstTimeSetupPage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("getting-started/first-time-setup")}
                id="docs-getting-started-first-time-setup-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        First-time setup ensures your account is linked to the
                        correct organization and role. Without that, the portal
                        cannot load the right navigation or data for you.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide walks through the minimum steps to get
                        access, complete onboarding, and verify that your
                        dashboard and core pages load correctly. It also
                        clarifies what information you may need from your
                        company or recruiting team.
                    </p>
                    <p className="text-base text-base-content/70">
                        If anything is missing after setup, this page helps you
                        diagnose whether the issue is permissions, organization
                        linkage, or incomplete onboarding steps.
                    </p>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-base text-base-content/70">
                        ...
                        <li>
                            Confirm your email and complete any required profile
                            fields.
                        </li>
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Once onboarding is complete, your navigation updates
                        based on your role, and you can begin creating roles or
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            Use the same email address your organization
                            invited.
                        </div>
                        <div>
                            Ask a company admin to resend the invitation if it
                            expired.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            <strong>Symptom:</strong> I cannot access the portal
                            after sign-in.
                            <br />
                            <strong>Likely cause:</strong> Your invitation is
                            missing or expired.
                            <br />
                            <strong>Fix:</strong> Ask a company admin to resend
                            the invite.
                        </div>
                        <div>
                            <strong>Symptom:</strong> I do not see my company
                            name.
                            <br />
                            <strong>Likely cause:</strong> Your account is not
                            linked to an organization.
                            <br />
                            <strong>Fix:</strong> Contact a company admin to
                            link you or open a support request.
                        </div>
                        <div>
                            <strong>Symptom:</strong> The onboarding wizard
                            keeps reopening.
                            <br />
                            <strong>Likely cause:</strong> Required steps were
                            not completed.
                            <br />
                            <strong>Fix:</strong> Complete all required fields
                            and save.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Organization:</strong> The company or
                            recruiting team you belong to in Splits Network.
                        </div>
                        <div>
                            <strong>Onboarding:</strong> The setup flow that
                            captures your role and required profile information.
                        </div>
                    </div>
                </section>
            </div>
