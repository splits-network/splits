...
export default function WhatIsSplitsNetworkPage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("getting-started/what-is-splits-network")}
                id="docs-getting-started-what-is-splits-network-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Splits Network is built to align recruiters, hiring
                        managers, and company admins around the same hiring
                        workflow. It keeps role details, submissions, and
                        decisions in one place so handoffs are clear.
                    </p>
                    <p className="text-base text-base-content/70">
                        This page explains the platform at a high level so you
                        can understand why each feature exists and how it
                        connects to your daily work. It is the best starting
                        point if you are new or need a fast refresher.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use the links below to move into setup and navigation,
                        then dive into the workflows that match your
                        responsibilities. The goal is to help you move from
                        context to action without guessing.
                    </p>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        ...
                        decisions, this documentation helps you understand what
                        to do, where to do it, and what to expect next.
                    </p>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        ...
                        <div>
                            Assigned to an organization or recruiting team.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <ol className="list-decimal list-inside space-y-2 text-base text-base-content/70">
                        ...
                        <li>
                            Review Navigation Overview to learn where work
                            lives.
                        </li>
                        <li>
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        ...
                        candidates, review applications, and track placements
                        based on your role and organization permissions.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        ...
                        <div>
                            Messages and Notifications keep collaboration
                            visible.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            <strong>Symptom:</strong> I do not know what role I
                            am.
                            <br />
                            <strong>Likely cause:</strong> Your organization
                            admin has not clarified permissions.
                            <br />
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Role:</strong> The permission set that
                            controls what you can see and do in the portal.
                        </div>
                        <div>
                            <strong>Placement:</strong> A successful hire tied
                            to a role and candidate, used to track fees and
                            earnings.
                        </div>
                    </div>
                </section>
