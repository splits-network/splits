...
export default function NotificationsGuidePage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("feature-guides/notifications")}
                id="docs-feature-guides-notifications-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Notifications surface activity that requires attention,
                        such as new messages or stage updates. They help you
                        stay informed without constantly checking every page.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide explains how notifications are organized,
                        what priority indicators mean, and how to jump directly
                        to the related item. It also clarifies why some alerts
                        may not appear.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page to interpret alerts, reduce noise, and
                        ensure you do not miss critical updates.
                    </p>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        ...
                        <div>
                            Active roles or applications generating updates.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            Use notification actions to jump directly to pending
                            tasks.
                        </div>
                        <div>
                            Clear old notifications to keep the list focused.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            ...
                            <br />
                            <strong>Likely cause:</strong> Filters or read
                            status hides them.
                            <br />
                            <strong>Fix:</strong> Adjust filters or refresh the
                            page.
                        </div>
                        <div>
                            <strong>Symptom:</strong> A notification link fails.
                            <br />
                            <strong>Likely cause:</strong> The underlying record
                            was removed or permissions changed.
                            <br />
                            <strong>Fix:</strong> Confirm access or contact
                            support.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Priority:</strong> The urgency level
