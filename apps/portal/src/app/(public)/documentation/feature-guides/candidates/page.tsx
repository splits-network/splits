...
export default function CandidatesGuidePage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("feature-guides/candidates")}
                id="docs-feature-guides-candidates-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Candidate profiles capture sourcing details,
                        verification status, and notes that support submissions.
                        Clean data improves hiring decisions and reduces
                        friction.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide explains how to work with candidate lists and
                        detail views, including marketplace visibility where
                        applicable. It also clarifies how verification status
                        impacts submission readiness.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page when updating candidate information,
                        preparing submissions, or troubleshooting missing or
                        masked data.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            ...
                            <br />
                            <strong>Likely cause:</strong> Candidate is owned by
                            another recruiter.
                            <br />
                            <strong>Fix:</strong> Confirm permissions or request
                            access.
                        </div>
                        <div>
                            <strong>Symptom:</strong> Candidates are missing
                            from the list.
                            <br />
                            <strong>Likely cause:</strong> Filters or visibility
                            settings are applied.
                            <br />
                            <strong>Fix:</strong> Clear filters or switch view
                            modes.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Verification status:</strong> The state of
                            candidate review (unverified, pending, verified,
                            rejected).
                        </div>
                    </div>
                </section>
