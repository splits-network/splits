...
export default function ApplicationsGuidePage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("feature-guides/applications")}
                id="docs-feature-guides-applications-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Applications are the operational record of candidate
                        submissions and decisions. They capture stage history,
                        notes, and documents in one place.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide explains how to interpret the applications
                        list, review detail panels, and understand stage
                        requirements. It also highlights where collaboration and
                        approvals happen.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page to navigate application data, coordinate
                        reviews, or resolve stage-related issues.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        ...
                        <div>
                            Check pre-screen answers before scheduling
                            interviews.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            <strong>Symptom:</strong> I cannot see application
                            details.
                            <br />
                            <strong>Likely cause:</strong> The application is
                            not assigned to your organization.
                            <br />
                            <strong>Fix:</strong> Confirm the role owner or ask
                            a company admin.
                        </div>
                        <div>
                            ...
                            <br />
                            <strong>Fix:</strong> Ask an admin or recruiter to
                            update the stage.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Application timeline:</strong> The history
                            of stage changes and actions.
                        </div>
                    </div>
                </section>
            </div>
