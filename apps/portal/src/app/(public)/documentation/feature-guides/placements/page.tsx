...
export default function PlacementsGuidePage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("feature-guides/placements")}
                id="docs-feature-guides-placements-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Placements represent successful hires and capture fee
                        and earnings data. They connect hiring outcomes to
                        financial tracking.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide explains how placement lists are structured,
                        what the key fields mean, and how guarantee periods are
                        tracked. It also highlights where to verify fee
                        calculations.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page when reconciling earnings, reviewing hire
                        outcomes, or investigating placement discrepancies.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            Confirm fee percentage aligns with the role record.
                        </div>
                        <div>
                            Use filters to view placements by time period.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            <strong>Symptom:</strong> Placement data looks
                            incorrect.
                            <br />
                            <strong>Likely cause:</strong> Salary or fee values
                            were updated after hire.
                            <br />
                            <strong>Fix:</strong> Confirm the application
                            details and contact support if needed.
                        </div>
                        <div>
                            <strong>Symptom:</strong> I cannot access
                            Placements.
                            <br />
                            <strong>Likely cause:</strong> Your role does not
                            include placements access.
                            <br />
                            <strong>Fix:</strong> Ask an admin to confirm
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Recruiter share:</strong> The portion of the
                            placement fee paid to the recruiter.
                        </div>
                    </div>
                </section>
            </div>
