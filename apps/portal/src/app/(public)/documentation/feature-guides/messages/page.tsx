...
export default function MessagesGuidePage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("feature-guides/messages")}
                id="docs-feature-guides-messages-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Messages provide a shared space for recruiter and
                        company communication. They keep decisions and timing
                        aligned across teams.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide explains how to navigate conversations,
                        interpret unread indicators, and connect messages to
                        roles and applications. It also clarifies when to use
                        messages versus notes.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page to manage collaboration, track
                        conversation history, or troubleshoot missing threads.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            ...
                            <br />
                            <strong>Likely cause:</strong> Sync delay or cached
                            view.
                            <br />
                            <strong>Fix:</strong> Refresh the page to update
                            counts.
                        </div>
                        <div>
                            <strong>Symptom:</strong> I cannot find a
                            conversation.
                            <br />
                            <strong>Likely cause:</strong> You are not assigned
                            to the role or application.
                            <br />
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Conversation:</strong> A thread of messages
                            tied to a role or application.
                        </div>
                    </div>
                </section>
            </div>
