...
export default function BillingGuidePage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("feature-guides/billing")}
                id="docs-feature-guides-billing-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Billing centralizes subscription status, invoices, and
                        payment methods. It is the source of truth for plan
                        details and renewal timing.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide explains where to view plan information,
                        update payment methods, and download invoices. It also
                        clarifies common issues that can block billing updates.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page when managing subscriptions, reconciling
                        invoices, or troubleshooting payment problems.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            Keep billing contacts updated to avoid missed
                            invoices.
                        </div>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            <strong>Symptom:</strong> Payment method fails to
                            update.
                            <br />
                            <strong>Likely cause:</strong> Card validation
                            error.
                            <br />
                            <strong>Fix:</strong> Retry with a different payment
                            method.
                        </div>
                        <div>
                            <strong>Symptom:</strong> Billing page is blank.
                            <br />
                            <strong>Likely cause:</strong> Subscription data
                            failed to load.
                            <br />
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Subscription:</strong> The plan that governs
                            access and billing terms.
                        </div>
                    </div>
                </section>
            </div>
