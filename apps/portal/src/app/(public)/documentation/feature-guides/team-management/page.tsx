...
export default function TeamManagementGuidePage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("feature-guides/team-management")}
                id="docs-feature-guides-team-management-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            Audit team roles quarterly to keep access correct.
                        </div>
                        <div>
                            Use invitations for new team members instead of
                            sharing credentials.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            <strong>Symptom:</strong> I cannot edit a team
                            member.
                            <br />
