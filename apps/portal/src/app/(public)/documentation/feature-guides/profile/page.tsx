            ...
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        The profile page stores your personal information,
                        preferences, and visibility settings. Keeping it current
                        improves collaboration and notifications.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide explains which fields affect contact details,
                        marketplace visibility, and notification preferences. It
                        also clarifies what is required versus optional.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page when updating contact info, adjusting
                        visibility, or troubleshooting missing preferences.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            Keep contact info current for recruiter
                            collaboration.
                        </div>
                        <div>
                            Review visibility settings if you join the
                            marketplace.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            <strong>Symptom:</strong> Profile changes do not
                            save.
                            <br />
                            <strong>Likely cause:</strong> Required fields are
                            missing.
                            <br />
                        ...
                        <div>
                            <strong>Symptom:</strong> I cannot see marketplace
                            settings.
                            <br />
                            <strong>Likely cause:</strong> Marketplace is not
                            enabled for your account.
                            <br />
                            <strong>Fix:</strong> Contact support or your admin
                            to enable it.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Marketplace visibility:</strong> Controls
                            whether recruiters can view your public profile.
                        </div>
                    </div>
                </section>
            </div>
