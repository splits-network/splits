...
export default function InvitationsGuidePage() {
    return (
        <>
            <JsonLd
                data={getDocJsonLd("feature-guides/invitations")}
                id="docs-feature-guides-invitations-jsonld"
            />
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Invitations are how new teammates and collaborators gain
                        access to your organization. They govern roles,
                        permissions, and visibility.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide outlines the invitations list, status
                        tracking, and resend or revoke actions. It helps you
                        ensure the right people have the right access.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page when onboarding new users or resolving
                        access delays caused by pending invites.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            <strong>Symptom:</strong> An invite shows pending
                            for too long.
                            <br />
                            <strong>Likely cause:</strong> The invitee has not
                            accepted.
                            <br />
                            <strong>Fix:</strong> Resend the invitation or
                            confirm their email.
                        </div>
                        <div>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Invitation status:</strong> Pending,
