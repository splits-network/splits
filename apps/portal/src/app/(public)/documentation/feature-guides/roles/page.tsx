            ...
            <div className="space-y-10">
                ...
                <section className="space-y-4">
                    ...
                    <p className="text-base text-base-content/70">
                        Roles define the hiring objectives, compensation
                        structure, and submission rules that power the rest of
                        the workflow. Keeping role data accurate keeps the
                        pipeline healthy.
                    </p>
                    <p className="text-base text-base-content/70">
                        This guide details how to navigate the roles list,
                        review role details, and manage status changes. It also
                        explains how role ownership affects who can edit or
                        publish updates.
                    </p>
                    <p className="text-base text-base-content/70">
                        Use this page when you need to manage role data,
                        troubleshoot visibility issues, or review performance
                        trends.
                    </p>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            Use view toggles to switch between grid and table.
                        </div>
                        <div>
                            Keep role status updated to avoid stale submissions.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-3 text-base text-base-content/70">
                        <div>
                            ...
                            <br />
                            <strong>Likely cause:</strong> You are not the role
                            owner or admin.
                            <br />
                        ...
                        <div>
                            <strong>Symptom:</strong> Role status options are
                            missing.
                            <br />
                            <strong>Likely cause:</strong> The role is locked by
                            another workflow.
                            <br />
                            <strong>Fix:</strong> Contact support or check with
                            the role owner.
                        </div>
                    </div>
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <div className="space-y-2 text-base text-base-content/70">
                        <div>
                            <strong>Role status:</strong> Active, Paused,
                            Filled, or Closed.
                        </div>
                    </div>
                </section>
