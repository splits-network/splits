...
const successStories = [
    {
        ...
        avatar: "fa-user-tie",
        story: "I've increased my income by 40% since joining Splits Network. The collaborative approach lets me focus on what I do best while earning from roles I couldn't fill alone.",
        earnings: "$120k+ in 6 months",
        placements: 8,
    },
    {
        name: "David Chen",
        role: "Tech Recruiter",
        avatar: "fa-code",
        story: "The transparency is incredible. I know exactly what I'll earn before I submit a candidate. No more guessing or waiting for commission calculations.",
        earnings: "$85k+ in 4 months",
        placements: 12,
    },
    {
        ...
        avatar: "fa-user-md",
        story: "Being able to collaborate with other recruiters has opened doors to companies I never could have reached on my own. It's changed my entire business.",
        earnings: "$200k+ in 8 months",
        placements: 15,
    },
];
                        ...
                        <div className="animate-section lg:order-first">
                            <div className="relative">
                                <img
                                    ...
                                    className="rounded-2xl shadow-2xl w-full h-96 object-cover object-[5%_30%]"
                                />
            ...
            <section className="py-24 px-4">
                <div className="max-w-7xl mx-auto">
                    <div className="animate-section text-center mb-16">
                        ...
                        <p className="text-xl text-base-content/80 max-w-3xl mx-auto">
                            Real results from real recruiters who've transformed
                            their business with Splits Network.
                        </p>
                    </div>
                            ...
                            <div key={story.name} className="animate-card">
                                <div className="card bg-base-100 shadow-lg h-full">
                                    <div className="card-body">
                                        <div className="flex items-center gap-4 mb-6">
                                            <div className="avatar avatar-placeholder">
                                                <div className="bg-primary text-primary-content rounded-full w-12">
                                                    <i
                                                        className={`fa-duotone fa-regular ${story.avatar} text-xl`}
                                                    ></i>
                                                </div>
                                            </div>
                                            <div>
                                        ...
                                        <blockquote className="text-base-content/80 mb-6 flex-grow">
                                            "{story.story}"
                                        </blockquote>
