...
interface HiringManagerAnimatorProps {
    children: ReactNode;
}

export function HiringManagerAnimator({ children }: HiringManagerAnimatorProps) {
    ...
    useGSAP(
        () => {
            ...
            // ════════════════════════════════════════
            // RESPONSIBILITIES CARDS — stagger slide-right
            // ════════════════════════════════════════
            const responsibilitiesContainer = $1(".responsibilities-container");
            if (responsibilitiesContainer) {
                gsap.fromTo(
                    ...
                    { opacity: 0, x: -25 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: responsibilitiesContainer, start: "top 75%" },
                    },
                );
            }
            ...
            // ════════════════════════════════════════
            const submissionContainer = $1(".submission-container");
            if (submissionContainer) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 20 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: submissionContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // EVALUATION CARDS
            // ════════════════════════════════════════
            const evaluationContainer = $1(".evaluation-container");
            if (evaluationContainer) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 25, scale: 0.95 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: evaluationContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // ACCESS SCOPE CARDS
            // ════════════════════════════════════════
            const accessContainer = $1(".access-container");
            if (accessContainer) {
                gsap.fromTo(
                    $(".access-card"),
                    { opacity: 0, y: 25, scale: 0.95 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: accessContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // CTA / NEXT STEPS
            // ════════════════════════════════════════
            const ctaSection = $1(".hiring-manager-cta");
            if (ctaSection) {
