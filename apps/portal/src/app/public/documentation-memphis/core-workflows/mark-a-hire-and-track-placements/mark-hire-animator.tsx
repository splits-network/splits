...
interface MarkHireAnimatorProps {
    children: ReactNode;
}

export function MarkHireAnimator({ children }: MarkHireAnimatorProps) {
    ...
    useGSAP(
        () => {
            ...
            // ════════════════════════════════════════
            // STEP CARDS — stagger with slide-right
            // ════════════════════════════════════════
            ...
            if (stepsContainer) {
                gsap.fromTo(
                    ...
                    { opacity: 0, x: -25 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.normal,
                        scrollTrigger: { trigger: stepsContainer, start: "top 80%" },
                    },
                );
            }

            // ════════════════════════════════════════
            // FEE BREAKDOWN CARDS — stagger with scale
            // ════════════════════════════════════════
            ...
            const detailsContainer = $1(".details-container");
            if (detailsContainer) {
                gsap.fromTo(
                    $(".detail-card"),
                    { opacity: 0, y: 25 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.normal,
                        scrollTrigger: { trigger: detailsContainer, start: "top 80%" },
                    },
                );
            }

            // ════════════════════════════════════════
            // STATUS CARDS — placement status flow
            // ════════════════════════════════════════
            ...
            const ctaSection = $1(".mark-hire-cta");
            if (ctaSection) {
