...
interface ReviewAppsAnimatorProps {
    children: ReactNode;
}

export function ReviewAppsAnimator({ children }: ReviewAppsAnimatorProps) {
    ...
    useGSAP(
        () => {
            ...
            // ════════════════════════════════════════
            // PIPELINE STAGES — stagger with slide-right
            // ════════════════════════════════════════

            const pipelineContainer = $1(".pipeline-container");
            if (pipelineContainer) {
                gsap.fromTo(
                    ...
                    { opacity: 0, x: -25 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.normal,
                        scrollTrigger: { trigger: pipelineContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // ════════════════════════════════════════
            // PRACTICE CARDS — tips / best practices
            // ════════════════════════════════════════
