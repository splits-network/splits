...
interface SubmitCandidateAnimatorProps {
    children: ReactNode;
}

export function SubmitCandidateAnimator({ children }: SubmitCandidateAnimatorProps) {
    ...
    useGSAP(
        () => {
            ...
            // ════════════════════════════════════════
            // PREREQ CARDS — stagger with scale
            // ════════════════════════════════════════
            const prereqContainer = $1(".prereq-container");
            if (prereqContainer) {
                gsap.fromTo(
                    $(".prereq-card"),
                    { opacity: 0, y: 30, scale: 0.95 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: prereqContainer, start: "top 80%" },
                    },
                );
            }

            // ════════════════════════════════════════
            // STEP CARDS — stagger slide-right
            // ════════════════════════════════════════
            ...
            // ════════════════════════════════════════
            // INFO FIELD ROWS — stagger fade-left
            // ════════════════════════════════════════
            const infoContainer = $1(".info-container");
            if (infoContainer) {
                gsap.fromTo(
                    $(".info-row"),
                    { opacity: 0, x: -15 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.tight,
                        scrollTrigger: { trigger: infoContainer, start: "top 75%" },
                    },
                );
            }

            // ════════════════════════════════════════
            // STATUS CARDS — stagger slide-right
            // ════════════════════════════════════════
            ...
            if (statusContainer) {
                gsap.fromTo(
                    ...
                    { opacity: 0, x: -20 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.normal,
                        scrollTrigger: { trigger: statusContainer, start: "top 80%" },
                    },
                );
            }

            // ════════════════════════════════════════
            // ROLE CARDS — stagger with scale
            // ════════════════════════════════════════
            ...
            // REJECTION CARDS
            // ════════════════════════════════════════
            const rejectionContainer = $1(".rejection-container");
            if (rejectionContainer) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 20 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: rejectionContainer, start: "top 80%" },
                    },
                );
            }
