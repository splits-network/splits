...
interface CandidatesAnimatorProps {
    children: ReactNode;
}

export function CandidatesAnimator({ children }: CandidatesAnimatorProps) {
    ...
    useGSAP(
        () => {
            ...
            // ════════════════════════════════════════
            // PROFILE STEP CARDS — stagger slide-right
            // ════════════════════════════════════════
            const profileContainer = $1(".profile-container");
            if (profileContainer) {
                gsap.fromTo(
                    $(".profile-card"),
                    { opacity: 0, x: -25 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: profileContainer, start: "top 75%" },
                    },
                );
            }
            ...
            // ════════════════════════════════════════
            const verificationContainer = $1(".verification-container");
            if (verificationContainer) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 20 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: verificationContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // SKILL TAG CARDS
            // ════════════════════════════════════════
            const skillsContainer = $1(".skills-container");
            if (skillsContainer) {
                gsap.fromTo(
                    $(".skill-card"),
                    { opacity: 0, y: 25, scale: 0.95 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: skillsContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // DOCUMENT CARDS
            // ════════════════════════════════════════
            const docsContainer = $1(".docs-container");
            if (docsContainer) {
                gsap.fromTo(
                    $(".doc-card"),
                    { opacity: 0, x: -15 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.tight,
                        scrollTrigger: { trigger: docsContainer, start: "top 75%" },
                    },
                );
            }
            ...
            // SEARCH FILTER CARDS
            // ════════════════════════════════════════
            const searchContainer = $1(".search-container");
            if (searchContainer) {
                gsap.fromTo(
                    $(".search-card"),
                    { opacity: 0, y: 20 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: searchContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // MATCHING CARDS
            // ════════════════════════════════════════
            const matchContainer = $1(".match-container");
            if (matchContainer) {
                gsap.fromTo(
                    $(".match-card"),
                    { opacity: 0, x: -20 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.normal,
                        scrollTrigger: { trigger: matchContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // PRIVACY CARDS
            // ════════════════════════════════════════
            const privacyContainer = $1(".privacy-container");
            if (privacyContainer) {
                gsap.fromTo(
                    $(".privacy-card"),
                    { opacity: 0, y: 25, scale: 0.95 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: privacyContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // CTA / NEXT STEPS
            // ════════════════════════════════════════
            const ctaSection = $1(".candidates-cta");
            if (ctaSection) {
