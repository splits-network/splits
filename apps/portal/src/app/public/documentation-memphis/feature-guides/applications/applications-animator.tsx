...
interface ApplicationsAnimatorProps {
    children: ReactNode;
}

export function ApplicationsAnimator({ children }: ApplicationsAnimatorProps) {
    ...
    useGSAP(
        () => {
            ...
            // ════════════════════════════════════════
            // STAGE CARDS — stagger with slide-right
            // ════════════════════════════════════════

            const stagesContainer = $1(".stages-container");
            if (stagesContainer) {
                gsap.fromTo(
                    $(".stage-card"),
                    { opacity: 0, x: -25 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.normal,
                        scrollTrigger: { trigger: stagesContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // ════════════════════════════════════════
            // DETAIL CARDS — stagger with scale
            // ════════════════════════════════════════
            ...
            const rolesContainer = $1(".roles-container");
            if (rolesContainer) {
                gsap.fromTo(
                    $(".role-card"),
                    { opacity: 0, y: 25 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.normal,
                        scrollTrigger: { trigger: rolesContainer, start: "top 80%" },
                    },
                );
            }
