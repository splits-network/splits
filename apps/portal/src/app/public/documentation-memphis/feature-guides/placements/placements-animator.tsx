...
interface PlacementsAnimatorProps {
    children: ReactNode;
}

export function PlacementsAnimator({ children }: PlacementsAnimatorProps) {
    ...
    useGSAP(
        () => {
            ...
            // ════════════════════════════════════════
            // CREATION STEP CARDS -- stagger slide-right
            // ════════════════════════════════════════
            const creationContainer = $1(".creation-container");
            if (creationContainer) {
                gsap.fromTo(
                    ...
                    { opacity: 0, x: -25 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: creationContainer, start: "top 75%" },
                    },
                );
            }

            // ════════════════════════════════════════
            // FEE CARDS -- stagger with scale
            // ════════════════════════════════════════
            const feeContainer = $1(".fee-container");
            if (feeContainer) {
                gsap.fromTo(
                    $(".fee-card"),
                    { opacity: 0, y: 25, scale: 0.95 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: feeContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // EARNINGS CARDS
            // ════════════════════════════════════════
            const earningsContainer = $1(".earnings-container");
            if (earningsContainer) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 20 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: earningsContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // STATUS CARDS
            // ════════════════════════════════════════
            const statusContainer = $1(".status-container");
            if (statusContainer) {
                gsap.fromTo(
                    $(".status-card"),
                    { opacity: 0, x: -15 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.tight,
                        scrollTrigger: { trigger: statusContainer, start: "top 75%" },
                    },
                );
            }
            ...
            // VERIFICATION CARDS
            // ════════════════════════════════════════
            const verifyContainer = $1(".verify-container");
            if (verifyContainer) {
                gsap.fromTo(
                    $(".verify-card"),
                    { opacity: 0, y: 25, scale: 0.95 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: verifyContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // REPORTING CARDS
            // ════════════════════════════════════════
            const reportingContainer = $1(".reporting-container");
            if (reportingContainer) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 20 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: reportingContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // DISPUTE CARDS
            // ════════════════════════════════════════
            const disputeContainer = $1(".dispute-container");
            if (disputeContainer) {
                gsap.fromTo(
                    $(".dispute-card"),
                    { opacity: 0, x: -20 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.normal,
                        scrollTrigger: { trigger: disputeContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // CTA / NEXT STEPS
            // ════════════════════════════════════════
            const ctaSection = $1(".placements-cta");
            if (ctaSection) {
