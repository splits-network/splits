...
export function DashboardAnimator({ children }: DashboardAnimatorProps) {
    ...
    useGSAP(
        () => {
            ...
            // ════════════════════════════════════════
            // ROLE CARDS -- stagger slide-right
            // ════════════════════════════════════════
            ...
            // ════════════════════════════════════════
            // METRIC CARDS -- stagger with scale
            // ════════════════════════════════════════
            const metricContainer = $1(".metric-container");
            if (metricContainer) {
                gsap.fromTo(
                    $(".metric-card"),
                    { opacity: 0, y: 25, scale: 0.95 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: metricContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // FILTER CARDS
            // ════════════════════════════════════════
            const filterContainer = $1(".filter-container");
            if (filterContainer) {
                gsap.fromTo(
                    $(".filter-card"),
                    { opacity: 0, y: 20 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: filterContainer, start: "top 80%" },
                    },
                );
            }

            // ════════════════════════════════════════
            // REFRESH CARDS -- stagger slide-right
            // ════════════════════════════════════════
            const refreshContainer = $1(".refresh-container");
            if (refreshContainer) {
                gsap.fromTo(
                    $(".refresh-card"),
                    { opacity: 0, x: -20 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.normal,
                        scrollTrigger: { trigger: refreshContainer, start: "top 80%" },
                    },
                );
            }

            // ════════════════════════════════════════
            // EXPORT CARDS -- stagger with scale
            // ════════════════════════════════════════
            const exportContainer = $1(".export-container");
            if (exportContainer) {
                gsap.fromTo(
                    $(".export-card"),
                    { opacity: 0, y: 30, scale: 0.95 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: exportContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // FAQ CARDS
            // ════════════════════════════════════════
            const faqContainer = $1(".faq-container");
            if (faqContainer) {
                gsap.fromTo(
                    $(".faq-card"),
                    { opacity: 0, y: 20 },
            ...
            // CTA / NEXT STEPS
            // ════════════════════════════════════════
            const ctaSection = $1(".dashboard-cta");
            if (ctaSection) {
