...
interface NotificationsAnimatorProps {
    children: ReactNode;
}

export function NotificationsAnimator({ children }: NotificationsAnimatorProps) {
    ...
    useGSAP(
        () => {
            ...
            // ════════════════════════════════════════
            // TYPE CARDS -- stagger slide-right
            // ════════════════════════════════════════
            ...
            // PREFERENCE CARDS
            // ════════════════════════════════════════
            const preferenceContainer = $1(".preference-container");
            if (preferenceContainer) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 25, scale: 0.95 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: preferenceContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // MANAGING CARDS
            // ════════════════════════════════════════
            const managingContainer = $1(".managing-container");
            if (managingContainer) {
                gsap.fromTo(
                    $(".managing-card"),
                    { opacity: 0, y: 20 },
                    {
                        ...
                        ease: E.gentle,
                        stagger: S.normal,
                        scrollTrigger: { trigger: managingContainer, start: "top 80%" },
                    },
                );
            }
            ...
            // HISTORY CARDS
            // ════════════════════════════════════════
            const historyContainer = $1(".history-container");
            if (historyContainer) {
                gsap.fromTo(
                    $(".history-card"),
                    { opacity: 0, x: -15 },
                    {
                        ...
                        ease: E.smooth,
                        stagger: S.tight,
                        scrollTrigger: { trigger: historyContainer, start: "top 75%" },
                    },
                );
            }
            ...
            // CTA / NEXT STEPS
            // ════════════════════════════════════════
            const ctaSection = $1(".notifications-cta");
            if (ctaSection) {
