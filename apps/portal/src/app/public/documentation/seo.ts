...
export const DOCS_METADATA: Record<string, DocMeta> = {
    ...
    "roles-and-permissions": {
        ...
        canonicalPath: "/public/documentation/roles-and-permissions",
    },
    ...
    "core-workflows": {
        ...
        canonicalPath: "/public/documentation/core-workflows",
    },
...
export function getDocMetadata(slug: string): Metadata {
    ...
    if (!entry) {
        return {
            ...
            ...buildCanonical("/public/documentation"),
        };
    }
