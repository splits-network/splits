    ...
    return (
        <div className="space-y-10">
            ...
            <section className="space-y-3">
                ...
                <div className="space-y-2 text-base text-base-content/70">
                    <div>Use the Roles page to track ownership and status changes.</div>
                    <div>Keep application notes updated for transparent handoffs.</div>
                </div>
            </section>
            ...
            <section className="space-y-3">
                ...
                <div className="space-y-3 text-base text-base-content/70">
                    <div>
                        ...
                        <br />
                        <strong>Likely cause:</strong> Candidate access is restricted for your role or organization.
                        <br />
                        <strong>Fix:</strong> Ask a company admin to confirm recruiter permissions.
                    </div>
                    <div>
                        <strong>Symptom:</strong> I cannot submit a candidate.
                        <br />
                        <strong>Likely cause:</strong> The role is paused or closed.
                        <br />
                        <strong>Fix:</strong> Confirm role status in Roles or contact the role owner.
                    </div>
                </div>
            </section>
            ...
            <section className="space-y-3">
                ...
                <div className="space-y-2 text-base text-base-content/70">
                    <div>
                        <strong>Recruiter:</strong> A user who sources and submits candidates to roles.
                    </div>
                    <div>
                        <strong>Placement:</strong> A successful hire tracked for fee and earnings.
                    </div>
                </div>
            </section>
        </div>
