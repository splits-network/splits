                ...
                <section className="py-20 bg-base-200 overflow-hidden">
                    <div className="container mx-auto px-4">
                        <div className="max-w-6xl mx-auto">
                            <h2 className="text-4xl font-bold mb-12 text-center opacity-0">What We'll Cover</h2>
                                ...
                                {blogTopics.map((topic, index) => (
                                    <div key={index} className="card bg-base-100 shadow hover:-translate-y-1 hover:shadow-lg transition-all">
                                        <div className="card-body">
                                            <div className={`w-12 h-12 rounded-full ${topic.bgColor} flex items-center justify-center mb-4`}>
                ...
                <section className="py-20 bg-neutral text-neutral-content overflow-hidden">
                    <div className="container mx-auto px-4">
                        <div className="max-w-5xl mx-auto text-center">
                            <div>
                                <h2 className="text-4xl font-bold mb-8 opacity-0">In the Meantime</h2>
