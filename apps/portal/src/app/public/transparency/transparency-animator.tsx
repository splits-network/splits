...
interface TransparencyAnimatorProps {
    children: ReactNode;
}

export function TransparencyAnimator({ children }: TransparencyAnimatorProps) {
        ...
        () => {
            ...
            gsap.fromTo(
                ...
                { opacity: 0, scale: 0.8 },
                {
                    ...
                    ease: E.bounce,
                    stagger: S.normal,
                    scrollTrigger: { trigger: $1(".transparency-stats"), start: "top 90%" },
                },
            );
            ...
            // ════════════════════════════════════════
            const articleSections = [".transparency-intro", ".transparency-privacy"];
            articleSections.forEach((sel) => {
                const section = $1(sel);
                if (!section) return;
                const inner = section.querySelector(".intro-section, .privacy-section");
                if (inner) {
                    gsap.fromTo(
                        inner,
                        { opacity: 0, y: 40 },
            ...
            // ════════════════════════════════════════
            // COMPARISON CARDS (Old Way vs New Way)
            // ════════════════════════════════════════
            gsap.fromTo(
                ...
                { opacity: 0, y: 30 },
                {
                    ...
                    scrollTrigger: { trigger: $1(".transparency-comparison"), start: "top 75%" },
                },
            );
            ...
            // ════════════════════════════════════════
            // WHAT WE SHARE GRID (benefit cards)
            // ════════════════════════════════════════
            gsap.fromTo(
                $1(".share-heading"),
                { opacity: 0, y: 30 },
                {
                    opacity: 1, y: 0,
                    duration: D.normal, ease: E.smooth,
                    scrollTrigger: { trigger: $1(".transparency-share"), start: "top 75%" },
                },
            );
            ...
            gsap.fromTo(
                ...
                { opacity: 0, y: 50, scale: 0.85, rotation: -3 },
                {
                    ...
                    ease: E.bounce,
                    stagger: S.normal,
                    scrollTrigger: { trigger: $1(".share-grid"), start: "top 80%" },
                },
            );
            ...
            gsap.fromTo(
                ...
                { opacity: 0, y: 50 },
                {
                    ...
                    scrollTrigger: { trigger: $1(".transparency-cta"), start: "top 80%" },
                },
            );
