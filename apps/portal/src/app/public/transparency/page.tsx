...
const keyStats = [
    { value: "100%", label: "Fee Visibility", bg: "bg-coral", text: "text-white" },
    { value: "Real-Time", label: "Placement Tracking", bg: "bg-teal", text: "text-white" },
    { value: "Open", label: "Platform Economics", bg: "bg-yellow", text: "text-dark" },
    { value: "Zero", label: "Hidden Costs", bg: "bg-purple", text: "text-white" },
];
                        ...
                        <div className="privacy-section opacity-0">
                            <div className="text-center mb-12">
                                ...
                                <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight text-white">
                                    Privacy &amp;{" "}
                                    <span className="text-yellow">Protection</span>
                                </h2>
