        ...
        () => {
            ...
            gsap.fromTo(
                ...
                { opacity: 0, scale: 0.8 },
                {
                    ...
                    ease: E.bounce,
                    stagger: S.normal,
                    scrollTrigger: { trigger: $1(".integrations-stats"), start: "top 90%" },
                },
            );

            // ════════════════════════════════════════
            // ARTICLE SECTIONS (text blocks)
            // ════════════════════════════════════════
            const articleSections = [".integrations-intro", ".integrations-how-it-works", ".integrations-coming-soon"];
            articleSections.forEach((sel) => {
                const section = $1(sel);
                if (!section) return;
                const inner = section.querySelector(".article-section, .how-section, .coming-section");
                if (inner) {
                    gsap.fromTo(
                        inner,
                        { opacity: 0, y: 40 },
            ...
            gsap.fromTo(
                ...
                { opacity: 0, y: 30 },
                {
                    ...
                    scrollTrigger: { trigger: $1(".integrations-categories"), start: "top 75%" },
                },
            );
            ...
            gsap.fromTo(
                ...
                { opacity: 0, y: 50, scale: 0.85, rotation: -3 },
                {
                    ...
                    ease: E.bounce,
                    stagger: S.normal,
                    scrollTrigger: { trigger: $1(".categories-grid"), start: "top 80%" },
                },
            );
            ...
            // IMAGE BREAK
            // ════════════════════════════════════════
            const imageCaptions = [".image-caption"];
            ...
            gsap.fromTo(
                ...
                { opacity: 0, y: 30 },
                {
                    opacity: 1, y: 0,
                    duration: D.normal, ease: E.smooth,
                    scrollTrigger: { trigger: $1(".integrations-how-it-works"), start: "top 75%" },
                },
            );
            ...
            gsap.fromTo(
                ...
                { opacity: 0, x: -40 },
                {
                    ...
                    ease: E.bounce,
                    stagger: S.loose,
                    scrollTrigger: { trigger: $1(".steps-list"), start: "top 80%" },
                },
            );
            ...
            gsap.fromTo(
                ...
                { opacity: 0, y: 30 },
                {
                    opacity: 1, y: 0,
                    duration: D.normal, ease: E.smooth,
                    scrollTrigger: { trigger: $1(".integrations-coming-soon"), start: "top 75%" },
                },
            );
            ...
            gsap.fromTo(
                ...
                { opacity: 0, y: 50, scale: 0.9, rotation: -2 },
                {
                    ...
                    ease: E.bounce,
                    stagger: S.normal,
                    scrollTrigger: { trigger: $1(".roadmap-grid"), start: "top 80%" },
                },
            );
            ...
            gsap.fromTo(
                ...
                { opacity: 0, y: 50 },
                {
                    ...
                    scrollTrigger: { trigger: $1(".integrations-cta"), start: "top 80%" },
                },
            );
