...
const pipelineStages = [
    {
        stage: "Submitted",
        date: "Day 1",
        detail: "Resume and profile sent to Meridian Tech",
    ...
    },
    {
        stage: "Screening",
        date: "Day 3",
        detail: "Phone screen scheduled with hiring manager",
        status: "complete" as const,
    ...
    },
    {
        stage: "Interview",
        date: "Day 8",
        detail: "Technical panel -- 4 interviewers, 90 minutes",
        status: "complete" as const,
    ...
    },
    {
        stage: "Final Round",
        date: "Day 12",
        detail: "VP of Engineering conversation. Culture fit.",
        status: "complete" as const,
    ...
    },
    {
        ...
        date: "Day 15",
        detail: "$155K base + equity. Marcus reviews.",
        status: "complete" as const,
        accent: "coral" as const,
    },
    {
        stage: "Placed",
        date: "Day 18",
        detail: "Offer accepted. Start date confirmed.",
        status: "complete" as const,
        accent: "teal" as const,
    },
];
...
const systemMetrics = [
    {
        ...
        description:
            "Shared pipelines and real-time updates cut placement timelines by more than half compared to traditional split deals.",
        accent: "coral" as const,
    },
    {
        value: "100%",
        ...
        description:
            "Every split is visible to every party. Before, during, and after the deal closes. No retroactive adjustments.",
        accent: "teal" as const,
    },
    {
        value: "0",
        ...
        description:
            "Terms are locked at submission. The platform calculates every payout automatically. Nothing to argue about.",
        accent: "yellow" as const,
    },
    {
        value: "73%",
        label: "Recruiters Want This",
        description:
            "Nearly three-quarters of independent recruiters say they need collaborative infrastructure for split-fee placements.",
        accent: "purple" as const,
    },
];
        ...
        <>
            ...
            <section className="relative min-h-[100vh] overflow-hidden flex items-center bg-dark">
                ...
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    {/* Hollow circle — top left */}
                    <div className="absolute top-[6%] left-[3%] w-32 h-32 rounded-full border-[6px] border-coral opacity-30" />
                    {/* Solid teal circle — right */}
                    <div className="absolute top-[60%] right-[5%] w-24 h-24 rounded-full bg-teal opacity-20" />
                    {/* Rotated purple square */}
                    <div className="absolute top-[15%] right-[10%] w-20 h-20 rotate-12 bg-purple opacity-25" />
                    {/* Yellow diamond */}
                    <div className="absolute bottom-[20%] left-[8%] w-16 h-16 rotate-45 bg-yellow opacity-20" />
                    {/* Coral rectangle */}
                    <div className="absolute bottom-[30%] right-[25%] w-28 h-10 -rotate-6 border-4 border-coral opacity-15" />
                    {/* Dot grid */}
                    ...
                    {/* Zigzag */}
                    <svg
                        className="absolute bottom-[12%] right-[40%] opacity-15"
                        width="120"
                        height="35"
                        viewBox="0 0 120 35"
                    >
                        <polyline
                            points="0,28 15,7 30,28 45,7 60,28 75,7 90,28 105,7 120,28"
                            fill="none"
                    ...
                    {/* Plus sign */}
                    <svg
                        className="absolute top-[70%] left-[30%] opacity-20"
                        width="44"
                        height="44"
                        viewBox="0 0 44 44"
                    >
                        <line
                            x1="22" y1="5" x2="22" y2="39"
            ...
            <section className="py-24 bg-cream overflow-hidden">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        {/* The story */}
                        <div className="space-y-6 text-lg leading-relaxed text-dark/80 max-w-3xl">
                            <p>
                            ...
                            <div className="border-4 border-coral bg-white p-8 my-8">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
                            {[
                                ...
                                <div
                                    key={i}
                                    className="border-4 border-dark bg-white p-4 text-center"
                                >
                                    <div className={`text-3xl font-black mb-1 ${ACCENT[stat.accent].text}`}>
                                        {stat.value}
                                    </div>
            ...
            <section className="py-24 bg-white overflow-hidden">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        {/* Dashboard mockup — Sarah's first login */}
                        <div className="mt-12 border-4 border-dark bg-cream p-6">
                            ...
                            {/* Welcome state */}
                            <div className="mb-6">
                                <div className="text-sm text-dark/40 uppercase tracking-wider font-bold mb-1">
                                    Welcome back
                                </div>
                                <div className="font-black text-2xl text-dark">
                                    Sarah Chen
                                </div>
                                <div className="text-base text-dark/60">
                                    Full-Stack Engineering | Pacific Northwest
                                </div>
                            </div>
                            ...
                            {/* The roles that match */}
                            <div className="border-4 border-dark/10 bg-white p-4">
                                <div className="text-sm font-black uppercase tracking-wider text-dark/50 mb-3">
                                    Roles Matching Your Specialization
                                </div>
                                {[
                                    {
                                    ...
                                    <div
                                        key={i}
                                        className={`flex flex-col md:flex-row md:items-center justify-between p-3 border-b-4 border-dark/5 last:border-b-0 gap-2`}
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-sm text-dark/50">
                                                    ...
                                                    {role.fee} fee | {role.split} split
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-3">
                                            <span className={`text-lg font-black ${ACCENT[role.accent].text}`}>
                                                {role.payout}
                                            </span>
                        ...
                        <div className="mt-10 max-w-3xl">
                            ...
                            <p className="text-lg leading-relaxed text-dark/80 mt-6">
                                She clicked on the Meridian Tech role. Senior React
                                Developer. $150K salary. 20% placement fee. 75/25
                                split. Her share: $22,500. Locked.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-6 text-lg leading-relaxed text-dark/80 max-w-3xl">
                            ...
                            <p>
                                ...
                                Sarah&apos;s network for two years. They had coffee
                                every quarter. She knew his salary expectations, his
                                commute preferences, his feelings about open-plan
                                offices.
                            </p>
                            <p>
                                She also knew he would crush the Meridian Tech
                                interview.
                            </p>
                        </div>

                        {/* Role details card — what Sarah sees */}
                            ...
                            <div className="border-4 border-dark bg-white p-6">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div
                                            key={i}
                                            className="flex justify-between items-center border-b-4 border-dark/5 pb-2 last:border-b-0"
                                        >
                                            <span className="text-sm font-bold uppercase tracking-wider text-dark/50">
                                                {item.label}
                                            </span>
                                            <span className="font-black text-base text-dark">
                                                {item.value}
                                            </span>
                                        </div>
                                    ))}
                        ...
                        <div className="mt-10 max-w-3xl">
                            <p className="text-lg leading-relaxed text-dark/80">
                                ...
                                submission, locked the split terms, and started the
                                clock. From this moment forward, every interaction
                                between Marcus, Sarah, and Meridian Tech would be
                                tracked in the pipeline.
                            </p>
                            <p className="text-lg leading-relaxed text-dark/80 mt-6 font-bold">
                                No handshakes. No email threads. No faith-based
                                accounting.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="relative inline-block">
                            ...
                            <div className="border-l-4 border-yellow px-8 py-6">
                                <p className="text-2xl md:text-3xl font-black uppercase tracking-tight text-white leading-tight">
                                    ...
                                    same{" "}
                                    <span className="text-yellow">outcome.</span>{" "}
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-6 text-lg leading-relaxed text-dark/80 max-w-3xl">
                            <p>
                                ...
                                The resume goes in. Silence comes out. Days become
                                weeks. The recruiter chases. The hiring manager
                                forgets. The candidate takes another offer.
                            </p>
                            <p>
                                Sarah did not chase anyone. She watched.
                            </p>
                        </div>

                        {/* Pipeline visualization */}
                        <div className="mt-12 border-4 border-dark bg-cream p-6">
                            <div className="flex items-center gap-2 mb-6 pb-4 border-b-4 border-dark/10">
                                <div className="w-3 h-3 rounded-full bg-coral" />
                                <div className="w-3 h-3 rounded-full bg-yellow" />
                                <div className="w-3 h-3 rounded-full bg-teal" />
                                <span className="ml-3 text-xs font-mono text-dark/40">
                                    splits.network/pipeline/meridian-tech
                                </span>
                            </div>
                            ...
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    ...
                                    <div className="text-base text-dark/60">
                                        Senior React Developer at Meridian Tech
                                    </div>
                                </div>
                                <div className="px-4 py-2 bg-teal text-dark font-black text-sm uppercase tracking-wider border-4 border-dark">
                                    Placed
                                </div>
                            </div>
                                    ...
                                    <div key={i} className="flex items-stretch gap-4">
                                        ...
                                        <div className="flex flex-col items-center w-8 flex-shrink-0">
                                            ...
                                            {i < pipelineStages.length - 1 && (
                                                <div className="w-1 flex-1 bg-dark/20" />
                                            )}
                                        </div>
                                        {/* Stage content */}
                                        <div className="pb-6 flex-1">
                                            <div className="flex flex-col md:flex-row md:items-center gap-1 md:gap-3">
                                                ...
                                                <span className={`text-sm font-bold ${ACCENT[stage.accent].text}`}>
                                                    {stage.date}
                                                </span>
                                            </div>
                        ...
                        {/* Narrative continues */}
                        <div className="mt-10 max-w-3xl space-y-6 text-lg leading-relaxed text-dark/80">
                            <p>
                                Every stage transition triggered a notification.
                                Sarah knew when Marcus was scheduled. She knew when
                                feedback arrived. She knew when the hiring manager
                                flagged him as a top candidate after the technical
                                panel.
                            </p>
                            <p>
                                She also knew exactly what Meridian Tech&apos;s
                                timeline looked like, because the platform showed
                                her. No calling the hiring manager&apos;s assistant.
                                No &ldquo;just checking in&rdquo; emails. The
                                pipeline was the single source of truth.
                            </p>
                            <p className="font-bold">
                                Day 8: Marcus nailed the technical interview. Four
                                interviewers. Ninety minutes. Unanimous thumbs up.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 bg-dark overflow-hidden">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-6 text-lg leading-relaxed text-white/70 max-w-3xl">
                            <p>
                                Day 15. Sarah&apos;s phone buzzed at 2:38 PM.
                            </p>
                            <p className="text-2xl font-black text-white uppercase tracking-tight">
                                &ldquo;Offer extended to Marcus Williams. $155K base
                                + equity package. Review in your dashboard.&rdquo;
                            </p>
                            <p>
                                She opened the platform. The offer details were
                                already there. Salary, start date, benefits summary.
                                And underneath all of it, the number she cared about
                                most:
                            </p>
                        </div>

                        {/* The payout card */}
                        <div className="mt-12 border-4 border-teal bg-white/5 p-8 md:p-10">
                            <div className="text-center">
                                <div className="text-sm font-bold uppercase tracking-[0.2em] text-white/40 mb-4">
                                    Placement Confirmed -- Your Payout
                                </div>
                                <div className="text-7xl md:text-8xl font-black text-teal mb-4">
                                    $22,500
                                </div>
                                    ...
                                    {[
                                        {
                                            ...
                                            detail: "Marcus started. Confirmed by Meridian.",
                                            accent: "coral" as const,
                                        },
                                        {
                                            icon: "fa-duotone fa-regular fa-calculator",
                                            title: "Fee Calculated",
                                            detail: "$30K fee. $22.5K to Sarah. Automatic.",
                                            accent: "yellow" as const,
                                        },
                                        {
                                            icon: "fa-duotone fa-regular fa-money-bill-transfer",
                                            title: "Payout Processed",
                                            detail: "$22,500 deposited. On schedule.",
                                            accent: "teal" as const,
                                        },
                                    ].map((step, i) => (
                                        <div
                                            key={i}
                                            className="border-4 border-white/10 bg-white/5 p-4 text-center"
                                        >
                                            ...
                                            <div className="font-black text-base uppercase tracking-wide text-white mb-1">
                                                {step.title}
                                            </div>
                        ...
                        <div className="mt-10 max-w-3xl">
                            <p className="text-lg leading-relaxed text-white/70">
                                ...
                                Not a dollar more. Not a dollar less. Eighteen days
                                from submission to payout.
                            </p>
                            <p className="text-lg leading-relaxed text-white/50 mt-6">
                                She thought about the Denver deal. The missing
                                $7,000. The three months of chasing invoices. The
                                sinking feeling that she had been played and could not
                                prove it.
                            </p>
                            <p className="text-xl leading-relaxed text-white font-black mt-6">
                                That world is over.
                            </p>
                        </div>
                    </div>
            ...
            {/* ═══════════════════════════════════════════════════════════════════
                STATS BAR — THE STORY IN NUMBERS
            ═══════════════════════════════════════════════════════════════════ */}
                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
                        {storyStats.map((stat, i) => (
                            <div
                                key={i}
                                className="border-4 border-dark bg-white p-6 text-center"
                            >
                                <div className={`text-3xl md:text-4xl font-black mb-1 ${ACCENT[stat.accent].text}`}>
                                    {stat.value}
                                </div>
                                <div className="text-sm font-bold uppercase tracking-wider text-dark/50">
                                    {stat.label}
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
                        {systemMetrics.map((metric, i) => (
                            <div
                                key={i}
                                className="relative border-4 border-dark bg-cream p-8 text-center"
                            >
                                {/* Color top bar */}
                                ...
                                <div className={`text-5xl font-black mb-3 ${ACCENT[metric.accent].text}`}>
                                    {metric.value}
                                </div>
                            ...
                            return (
                                ...
                                >
                                    <details className="group">
                                        ...
                                        <div className="px-5 pb-5 border-t-4 border-dark/10 bg-white">
            ...
            <section className="py-28 bg-dark overflow-hidden relative">
                {/* Memphis decorations */}
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    <div className="absolute top-[8%] left-[5%] w-20 h-20 rotate-12 bg-coral opacity-20" />
                    ...
                    <div className="absolute top-[45%] right-[40%] w-16 h-16 rotate-45 border-4 border-yellow opacity-10" />
                    <svg
                        className="absolute bottom-[30%] left-[30%] opacity-15"
                        width="100"
                        height="30"
                        viewBox="0 0 100 30"
                    >
                    ...
                    <svg
                        className="absolute top-[35%] left-[60%] opacity-15"
                        width="44"
                        height="44"
                        viewBox="0 0 44 44"
                    >
                    ...
                    {/* Dot cluster */}
                    <div className="absolute top-[65%] right-[6%] opacity-15">
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center mb-14 max-w-4xl mx-auto">
                        ...
                        <h2 className="text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight mb-8 leading-[0.95] text-white">
                            Your Story{" "}
                            <span className="text-teal">Starts</span>
                            <br />
                            With One{" "}
                            <span className="text-coral">Placement.</span>
                        </h2>
                        <p className="text-xl text-white/60 mb-4 max-w-2xl mx-auto">
                            ...
                            that arrived exactly when and how the platform said it
                            would.
                        </p>
                        ...
                        {[
                            {
                                ...
                                title: "Recruiters",
                                desc: "Browse roles. Submit candidates. Watch every dollar tracked from submission to payout.",
                                link: "/join",
                                accent: "teal" as const,
                            },
                            {
                                ...
                                title: "Companies",
                                desc: "Post one role. Activate dozens of specialized recruiters. Pay only when someone starts.",
                                link: "/join",
                                accent: "coral" as const,
                            },
                            {
                                ...
                                title: "Candidates",
                                desc: "Get represented by recruiters competing to find you the right fit. Your career, amplified.",
                    ...
                    <p className="text-center text-sm max-w-xl mx-auto text-white/40 uppercase tracking-wider font-bold">
                        Join the recruiters and companies already building their
                        placement stories on Splits Network.
                    </p>
                </div>
