...
interface SplitFeesAnimatorProps {
    children: ReactNode;
}

export function SplitFeesAnimator({ children }: SplitFeesAnimatorProps) {
            ...
            if (howHeading) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 40 },
                    {
                        ...
                        duration: D.normal,
                        ease: E.smooth,
                        scrollTrigger: { trigger: $1(".split-how"), start: "top 75%" },
                    },
                );
            }

            const howSteps = $(".how-step-card");
            if (howSteps.length) {
                gsap.fromTo(
                    howSteps,
            ...
            if (featuresHeading) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 40 },
                    {
                        ...
                        duration: D.normal,
                        ease: E.smooth,
                        scrollTrigger: { trigger: $1(".split-features"), start: "top 75%" },
                    },
                );
            }
            ...
            if (benefitBlocks.length) {
                gsap.fromTo(
                    ...
                    { opacity: 0, scale: 0.8 },
                    {
                        ...
                        ease: E.bounce,
                        stagger: S.normal,
                        scrollTrigger: { trigger: $1(".split-benefits"), start: "top 85%" },
                    },
                );
            }
            ...
            if (useCasesHeading) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 40 },
                    {
                        ...
                        duration: D.normal,
                        ease: E.smooth,
                        scrollTrigger: { trigger: $1(".split-use-cases"), start: "top 75%" },
                    },
                );
            }
            ...
            if (useCaseCards.length) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 60, rotation: -5 },
                    {
                        ...
                        ease: E.bounce,
                        stagger: S.loose,
                        scrollTrigger: { trigger: $1(".use-cases-grid"), start: "top 80%" },
                    },
                );
            }
            ...
            if (ctaContent) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 50 },
                    {
                        ...
                        duration: D.hero,
                        ease: E.smooth,
                        scrollTrigger: { trigger: $1(".split-cta"), start: "top 80%" },
                    },
                );
            }
