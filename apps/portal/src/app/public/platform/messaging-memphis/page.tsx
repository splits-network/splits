...
export const metadata: Metadata = {
    ...
    description: "In-platform messaging for recruiters, companies, and candidates. Centralized communication with real-time chat and conversation history.",
};

const features = [
    { icon: "fa-duotone fa-regular fa-comments", title: "Real-Time Chat", description: "Instant messaging between recruiters, hiring managers, and candidates. No email lag.", color: "bg-purple-500" },
    { icon: "fa-duotone fa-regular fa-inbox", title: "Unified Inbox", description: "All conversations in one place. Stop juggling email threads, texts, and phone calls.", color: "bg-coral-500" },
    { icon: "fa-duotone fa-regular fa-clock-rotate-left", title: "Full History", description: "Every message saved and searchable. Never lose track of candidate communication.", color: "bg-teal-500" },
    { icon: "fa-duotone fa-regular fa-bell", title: "Smart Notifications", description: "Get alerted when it matters. Mute when you need focus. You control the noise.", color: "bg-yellow-500" },
];

const benefits = [
    { metric: "Zero", label: "Lost Messages", description: "All communication tracked and saved", color: "bg-purple-500" },
    { metric: "50%", label: "Faster Response", description: "Real-time vs email back-and-forth", color: "bg-coral-500" },
    { metric: "100%", label: "Context", description: "Full conversation history always available", color: "bg-teal-500" },
    { metric: "1 Place", label: "All Communication", description: "No more scattered threads", color: "bg-yellow-500" },
];

const useCases = [
    { title: "Recruiter-Candidate Chat", text: "Quick check-ins, interview scheduling, and feedback loops without email overhead.", icon: "fa-duotone fa-regular fa-comment-dots", color: "text-purple-500", borderColor: "border-purple-500" },
    { title: "Team Collaboration", text: "Internal notes and discussions on candidate profiles. Keep the team aligned.", icon: "fa-duotone fa-regular fa-users-medical", color: "text-coral-500", borderColor: "border-coral-500" },
    { title: "Client Updates", text: "Share candidate progress with hiring managers in real time. Transparency builds trust.", icon: "fa-duotone fa-regular fa-handshake-angle", color: "text-teal-500", borderColor: "border-teal-500" },
];
...
export default function MessagingMemphisPage() {
    return (
        <MessagingAnimator>
            <section className="messaging-hero relative min-h-[90vh] overflow-hidden flex items-center bg-base-950">
                <div className="memphis-shapes absolute inset-0 pointer-events-none overflow-hidden">
                    ...
                    <svg className="memphis-shape absolute bottom-[15%] right-[45%] opacity-0" width="100" height="35" viewBox="0 0 100 35">
                        <polyline points="0,25 12,8 25,25 38,8 50,25 62,8 75,25 88,8 100,25" fill="none" stroke="rgb(255 115 115)" strokeWidth="3" strokeLinecap="round" />
                    </svg>
                </div>
                    ...
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <h1 className="hero-headline text-5xl md:text-7xl lg:text-8xl font-black leading-[0.95] mb-8 opacity-0 uppercase tracking-tight text-white">
                            ...
                            <span className="relative inline-block">
                                <span className="text-purple-500">Communication</span>
                        ...
                        <p className="hero-subtext text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed opacity-0 text-white/80">
                            Stop losing messages in email threads. Real-time chat, unified inbox, full conversation history.
                        </p>

                        <div className="hero-cta-row flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="/sign-up" className="hero-cta-btn inline-flex items-center justify-center gap-3 px-8 py-4 text-lg font-bold uppercase tracking-wider border-4 border-purple-500 bg-purple-500 text-white transition-transform hover:-translate-y-1 opacity-0">
            ...
            <section id="features" className="messaging-features py-24 overflow-hidden bg-base-50">
                <div className="container mx-auto px-4">
                    <div className="features-heading text-center mb-16 opacity-0 max-w-3xl mx-auto">
                        <span className="inline-block px-4 py-1 text-xs font-bold uppercase tracking-[0.2em] mb-4 bg-purple-500 text-white">Features</span>
                        <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tight mb-6 text-base-950">
                            Communication <span className="text-purple-500">Made Simple</span>
                        </h2>
                        <p className="text-lg text-base-950/70">Everything you need to stay connected with candidates and teams.</p>
                    </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="use-cases-heading text-center mb-16 opacity-0 max-w-3xl mx-auto">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tight mb-6 text-white">
                            Perfect For <span className="text-coral-500">Every Conversation</span>
                        </h2>
                    </div>
            ...
            <section className="messaging-cta relative py-24 overflow-hidden bg-base-50">
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center mb-12 opacity-0 max-w-4xl mx-auto">
                        ...
                        <p className="text-xl mb-12 text-base-950/70">Join teams who ditched email chaos for real-time communication.</p>
                    </div>

                    <div className="cta-buttons flex flex-col sm:flex-row gap-4 justify-center opacity-0">
                        <a href="/sign-up" className="inline-flex items-center justify-center gap-3 px-8 py-4 text-lg font-bold uppercase tracking-wider border-4 border-purple-500 bg-purple-500 text-white transition-transform hover:-translate-y-1">
                            <i className="fa-duotone fa-regular fa-rocket"></i>
                            Get Started
                        </a>
