...
interface ATSAnimatorProps {
    children: ReactNode;
}

export function ATSAnimator({ children }: ATSAnimatorProps) {
            ...
            if (featuresHeading) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 40 },
                    {
                        ...
                        duration: D.normal,
                        ease: E.smooth,
                        scrollTrigger: { trigger: $1(".ats-features"), start: "top 75%" },
                    },
                );
            }
            ...
            if (benefitBlocks.length) {
                gsap.fromTo(
                    ...
                    { opacity: 0, scale: 0.8 },
                    {
                        ...
                        ease: E.bounce,
                        stagger: S.normal,
                        scrollTrigger: { trigger: $1(".ats-benefits"), start: "top 85%" },
                    },
                );
            }
            ...
            if (useCasesHeading) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 40 },
                    {
                        ...
                        duration: D.normal,
                        ease: E.smooth,
                        scrollTrigger: { trigger: $1(".ats-use-cases"), start: "top 75%" },
                    },
                );
            }
            ...
            if (ctaContent) {
                gsap.fromTo(
                    ...
                    { opacity: 0, y: 50 },
                    {
                        ...
                        duration: D.hero,
                        ease: E.smooth,
                        scrollTrigger: { trigger: $1(".ats-cta"), start: "top 80%" },
                    },
                );
            }
