...
const CONTACT_TOPICS = [
    { value: "support", label: "Technical Support", icon: "fa-wrench" },
    { value: "sales", label: "Sales Inquiry", icon: "fa-handshake" },
    { value: "billing", label: "Billing Question", icon: "fa-credit-card" },
    { value: "partnership", label: "Partnership", icon: "fa-users" },
...
const CONTACT_METHODS = [
    ...
    },
    {
        ...
        icon: "fa-gauge-high",
        items: [
            { label: "Critical Issues", value: "< 2 hours" },
            { label: "General Support", value: "< 24 hours" },
                ...
                <div className="container mx-auto px-4 relative z-10 py-16">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="hero-subtext text-lg md:text-xl leading-relaxed mb-8 opacity-0 text-white/70">
                            Questions about split-fee recruiting? Need platform
                            support? Want to partner with us? Drop us a line and
                            we'll get back to you fast. Real humans, real
                            responses.
                        </p>

                        <div className="hero-stat inline-flex items-center gap-2 px-4 py-2 border-4 border-teal text-xs font-bold uppercase tracking-wider opacity-0 text-white/60">
                            <i className="fa-duotone fa-regular fa-gauge-high text-teal"></i>
                                    ...
                                    {formStatus === "success" ? (
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                className="w-full py-4 bg-dark text-white text-xs uppercase tracking-[0.25em] font-black hover:bg-coral transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
                                            >
                                                {formStatus === "submitting" ? (
                                                    <>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center max-w-3xl mx-auto opacity-0">
                        ...
                        <p className="text-lg mb-8 text-white/60">
                            Prefer live chat? Check our documentation? Browse
                            our help center? We've got options.
                        </p>
