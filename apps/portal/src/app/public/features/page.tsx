...
const keyStats = [
    { value: "6", label: "Core platform modules", bg: "bg-coral", text: "text-white" },
    { value: "3", label: "Subscription tiers", bg: "bg-teal", text: "text-white" },
    { value: "100%", label: "Fee transparency", bg: "bg-yellow", text: "text-dark" },
    { value: "24/7", label: "Real-time notifications", bg: "bg-purple", text: "text-white" },
];
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <h1 className="hero-headline text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight leading-[0.95] mb-8 text-cream opacity-0">
                            ...
                            <span className="relative inline-block">
                                <span className="text-coral">Split Placements</span>
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="article-section opacity-0">
                            <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight mb-6 text-dark">
                                A Complete{" "}
                                <span className="text-coral">Recruiting Ecosystem</span>
                            </h2>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="core-heading text-center mb-12 opacity-0">
                            ...
                            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight text-dark">
                                Six Modules.{" "}
                                <span className="text-purple">One Ecosystem.</span>
                            </h2>
                        </div>
                            ...
                            {coreFeatures.map((feature, index) => (
                                <div key={index}
                                    ...
                                    <div className={`w-14 h-14 flex items-center justify-center mb-4 border-4 ${feature.border}`}>
                                        <i className={`${feature.icon} text-2xl ${feature.text}`}></i>
                                    </div>
                                    ...
                                    <ul className="space-y-2">
                                        {feature.items.map((item, i) => (
                                            <li key={i} className="flex items-start gap-2 text-sm leading-relaxed text-dark/70">
                                                <i className={`fa-duotone fa-regular fa-check mt-0.5 flex-shrink-0 ${feature.text}`}></i>
                                                {item}
                                            </li>
                                        ))}
                                    </ul>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-5xl mx-auto">
                        <div className="recruiter-heading text-center mb-12 opacity-0">
                            ...
                            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight text-dark">
                                Maximize Your{" "}
                                <span className="text-coral">Placement Success</span>
                            </h2>
                        </div>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="company-heading text-center mb-12 opacity-0">
                            ...
                            <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight text-cream">
                                Streamline{" "}
                                <span className="text-teal">External Recruiting</span>
                            </h2>
                        </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto">
                        <div className="prose-section opacity-0">
                            <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight mb-6 text-dark">
                                Built on{" "}
                                <span className="text-purple">Modern Architecture</span>
                            </h2>
