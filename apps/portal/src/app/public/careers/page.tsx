    ...
    return (
        <ScrollAnimator>
            ...
            <section className="py-20 bg-base-200 overflow-hidden">
                <div className="container mx-auto px-4">
                    <div className="max-w-6xl mx-auto">
                        <h2 className="text-4xl font-bold mb-12 text-center opacity-0">Why Splits Network?</h2>
            ...
            <section className="py-20 bg-base-100 overflow-hidden">
                <div className="container mx-auto px-4">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-4xl font-bold mb-12 text-center opacity-0">Areas We'll Be Hiring</h2>
                        <div className="grid md:grid-cols-2 gap-6" data-animate-stagger>
                            {hiringAreas.map((area, index) => (
                                <div key={index} className="card bg-base-200 shadow hover:-translate-y-1 hover:shadow-lg transition-all">
            ...
            <section className="py-20 bg-neutral text-neutral-content overflow-hidden">
                <div className="container mx-auto px-4">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-4xl font-bold mb-12 text-center opacity-0">What We Value</h2>
                        <div className="space-y-6" data-animate-stagger>
                            {values.map((value, index) => (
                                <div key={index} className="card bg-base-100 text-base-content shadow">
                                    <div className="card-body">
