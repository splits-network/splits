    ...
    const overallState = useMemo(() => {
        if (isLoading) {
            return {
                ...
                message:
                    "Hang tight while we validate the API gateway, auth, ATS, network, billing, docs, AI, and automation stacks.",
        ...
        if (someUnhealthy) {
            return {
                ...
                message:
                    "We detected a hiccup. Follow the incident card below or ping us via the contact form.",
                ...
                <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p className="text-base-content/70 mt-2 max-w-3xl">
                            Live health telemetry across gateway, Identity, ATS,
                            Network, Billing, Notification, Automation,
                            Document, Document Processing, and AI Review
                            services.
                        </p>
                    </div>
                        ...
                        <div className="card bg-base-100 shadow">
                            <div className="card-body">
                                ...
                                <ul className="text-sm text-base-content/70 space-y-2">
                                    <li>
                                        - Release notes: splits.network/updates
                                    </li>
