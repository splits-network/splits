            ...
            <div className="border-t-4 border-dark pt-4 space-y-2.5">
                {metrics.map((metric) => {
                    ...
                    return (
                        ...
                        >
                            <div
                                className={`w-8 h-8 border-3 border-dark ${accent.bg}/20 flex items-center justify-center shrink-0`}
                            >
                                <i
                                    className={`fa-duotone fa-regular ${metric.icon} text-xs ${accent.text}`}
                                />
                            </div>
                            <div className="flex-1 min-w-0">
                                ...
                                {metric.sublabel && (
                                    <span className="text-[10px] text-dark/30 ml-1.5">
                                        ({metric.sublabel})
                                    </span>
                                )}
                            </div>
