...
function firmToForm(firm: Firm): FirmFormData {
    return {
        ...
        seeking_split_partners: firm.seeking_split_partners,
        accepts_candidate_submissions: firm.accepts_candidate_submissions,
...
function formToPayload(form: FirmFormData) {
    ...
    return {
        ...
        seeking_split_partners: form.seeking_split_partners,
        accepts_candidate_submissions: form.accepts_candidate_submissions,
