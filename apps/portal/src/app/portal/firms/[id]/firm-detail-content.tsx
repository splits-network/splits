...
export default function FirmDetailContent({ firmId }: FirmDetailContentProps) {
    ...
    const loadFirmData = useCallback(async () => {
        try {
            ...
            const firmRes = await client.get(`/firms/${firmId}`);
            setFirm(firmRes.data);

            const membersRes = await client.get(`/firms/${firmId}/members`);
    ...
    if (loading) {
        return <LoadingState message="Loading firm..." />;
    }
            ...
            <section className="relative bg-neutral text-neutral-content py-16 lg:py-20">
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="max-w-4xl">
                        ...
                        <div className="mb-4">
                            <span
                                className={`detail-badge text-sm uppercase tracking-[0.15em] font-bold px-2 py-1 opacity-0 ${statusColor(firm.status)}`}
                            >
