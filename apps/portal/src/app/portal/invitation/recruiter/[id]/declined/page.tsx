    ...
    return (
        <main className="min-h-[70vh] flex items-center justify-center p-6">
            <div className="max-w-md w-full text-center">
                ...
                <h1 className="text-2xl font-black mb-2">Invitation Declined</h1>
                <p className="text-sm text-base-content/60 mb-8 leading-relaxed">
                    You have declined this invitation. The company will be notified.
                    They can send a new invitation in the future if needed.
                </p>
