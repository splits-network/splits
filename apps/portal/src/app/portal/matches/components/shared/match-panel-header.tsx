...
export function MatchPanelHeader({
    ...
    const stats = [
        { label: "Overall", value: String(match.match_score), icon: "fa-duotone fa-regular fa-bullseye" },
        { label: "Rules", value: String(match.rule_score), icon: "fa-duotone fa-regular fa-list-check" },
        { label: "Skills", value: String(match.skills_score), icon: "fa-duotone fa-regular fa-code" },
        ...(isPartner && match.ai_score !== null
            ? [{ label: "AI", value: String(match.ai_score), icon: "fa-duotone fa-regular fa-brain" }]
            : []),
    ];
