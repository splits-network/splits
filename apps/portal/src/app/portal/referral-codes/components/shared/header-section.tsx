            ...
            <div className="container mx-auto px-6 lg:px-12">
                <div className="max-w-4xl">
                    ...
                    <p className="hero-subtitle text-lg text-base-content/60 leading-relaxed max-w-xl mb-10 scroll-reveal fade-up">
                        Share your referral code with candidates and companies.
                        When they sign up through your code, they&apos;re
                        attributed to you&mdash;building your sourcing record
                        and expanding your reach in the marketplace.
                    </p>
