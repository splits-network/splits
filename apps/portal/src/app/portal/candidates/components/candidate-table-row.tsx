                ...
                <div className="flex flex-wrap gap-1">
                    {candidate.verification_status &&
                        candidate.verification_status === "verified" && (
                            <div
                                className={`badge badge-sm ${getVerificationStatusBadge(candidate.verification_status)} gap-1`}
                            >
                                <i
                                    className={`fa-duotone fa-regular ${getVerificationStatusIcon(candidate.verification_status)}`}
                                ></i>
                                {candidate.verification_status
                                    .charAt(0)
                                    .toUpperCase() +
                                    candidate.verification_status.slice(1)}
                            </div>
                        )}
                    {isRecruiter && (
                        <>
                            {candidate.is_sourcer && (
                                <span
                                    ...
                                    title="You sourced this candidate"
                                >
                            ...
                            {candidate.has_active_relationship && (
                                <span
                                    className="badge badge-sm badge-success gap-1"
                    ...
                    <ExpandedDetailGrid>
                        <ExpandedDetailItem
                            ...
                            value={
                                candidate.verification_status && (
                                    <div
                                        className={`badge badge-sm ${getVerificationStatusBadge(candidate.verification_status)} gap-1 w-fit`}
                                    >
                                        <i
                                            className={`fa-duotone fa-regular ${getVerificationStatusIcon(candidate.verification_status)}`}
                                        ></i>
                                        {candidate.verification_status
                                            .charAt(0)
                                            .toUpperCase() +
                                            candidate.verification_status.slice(
                                                1,
                                            )}
                                    </div>
                                )
