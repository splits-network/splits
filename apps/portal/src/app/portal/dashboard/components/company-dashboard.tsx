                                ...
                                <table className="table table-sm">
                                    <thead>
                                        <tr className="border-b border-base-200">
                                            ...
                                            <th className="bg-transparent text-center">Applications</th>
                                            <th className="bg-transparent text-center">Interviews</th>
                                            <th className="bg-transparent text-center">Offers</th>
                                            <th className="bg-transparent text-center">Days Open</th>
                                        ...
                                        {roleBreakdown.map((role) => (
                                            <tr key={role.id} className="hover:bg-base-200/50 transition-colors">
                                                ...
                                                <td className="text-center">
                                                    <span className="badge badge-sm badge-ghost">{role.applications_count}</span>
                                                </td>
                                                <td className="text-center">
                                                    <span className="badge badge-sm badge-info badge-outline">{role.interview_count}</span>
                                                </td>
                                                <td className="text-center">
                                                    <span className="badge badge-sm badge-success badge-outline">{role.offer_count}</span>
                                                </td>
                                                <td className="text-center">
                                                    <span className={`text-sm ${role.days_open > 60 ? 'text-warning font-semibold' : 'text-base-content/70'}`}>
                                                        {role.days_open}
                                                    </span>
                                                </td>
                                                <td className="text-center">
                                                    <span className={`badge badge-sm ${getJobStatusBadge(role.status)}`}>
                                                        {role.status}
                                                    </span>
                                                </td>
                                                <td>
                                ...
                                {recentActivity.slice(0, 6).map((activity) => (
                                    ...
                                    >
                                        <div className={`
                                            ...
                                            ${activity.type === 'placement_completed' ? 'bg-success/10 text-success' :
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            {activity.role_title && (
                                                <p className="text-xs text-primary mt-0.5">{activity.role_title}</p>
                                            )}
