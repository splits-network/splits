...
const RANK_STYLES: Record<number, string> = {
    ...
    3: "bg-accent/10 text-accent border-yellow/20",
};
        ...
        >
            <div className="space-y-1 -mx-2">
                {performers.map((performer, i) => {
                    ...
                    const rankStyle =
                        RANK_STYLES[rank] ||
                        "bg-base-200 text-base-content/50 border-base-300/50";
                    ...
                    return (
                        ...
                        >
                            <div
                                className={`w-7 h-7 rounded-lg flex items-center justify-center shrink-0 text-xs font-bold border ${rankStyle} tabular-nums`}
                            >
                                {rank}
                            </div>
