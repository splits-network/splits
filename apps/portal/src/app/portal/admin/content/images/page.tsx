...
import { UploadImageModal } from "@/components/basel/admin/images/upload-image-modal";
import { ImageDetailModal } from "@/components/basel/admin/images/image-detail-modal";
    ...
    const {
        ...
        fetchFn: async (params) => {
            ...
            return await apiClient.get(
                `/content-images?${queryParams.toString()}`,
            );
        },
        defaultFilters,
