...
export default function OwnershipAuditClient() {
    ...
    const {
        ...
        fetchFn: async (params) => {
            ...
            if (params.filters?.protection_status) {
                queryParams.set(
                    "protection_status",
                    params.filters.protection_status,
                );
            }
    ...
    const stats = useMemo(() => {
        ...
        const active = sourcers.filter(
            (s) => !isExpired(s.protection_expires_at),
        ).length;
        const expired = sourcers.filter((s) =>
            isExpired(s.protection_expires_at),
        ).length;
        const tsnSourced = sourcers.filter(
            (s) => s.sourcer_type === "tsn",
        ).length;
        ...
        <div className="space-y-6">
                ...
                <select
                    ...
                    onChange={(e) =>
                        setFilters({
                            ...
                            protection_status:
                                (e.target
                                    .value as OwnershipFilters["protection_status"]) ||
                                undefined,
                        })
                    }
                >
                ...
                <select
                    ...
                    onChange={(e) =>
                        setFilters({
                            ...
                            sourcer_type:
                                (e.target
                                    .value as OwnershipFilters["sourcer_type"]) ||
                                undefined,
                        })
                    }
                >
            ...
            {loading ? (
                ...
                <EmptyState
                    ...
                    description={
                        search ||
                        filters.protection_status ||
                        filters.sourcer_type
                                    ...
                                    {sourcers.map((sourcer) => {
                                        ...
                                        return (
                                            <tr key={sourcer.id}>
                                                        ...
                                                        <div className="font-semibold">
                                                            {sourcer.candidate
                                                                ...
                                                                <span className="text-base-content/50 font-mono text-sm">
                                                                    {sourcer.candidate_id.substring(
                                                                        0,
                                                                        8,
                                                                    )}
                                                                    ...
                                                ...
                                                <td>
                                                    <span
                                                        className={`badge ${sourcer.sourcer_type === "tsn" ? "badge-primary" : "badge-primary"}`}
                                                    >
                                                        {sourcer.sourcer_type ===
                                                        "tsn"
                                                            ? "TSN"
                                                            : "Recruiter"}
                                                    </span>
