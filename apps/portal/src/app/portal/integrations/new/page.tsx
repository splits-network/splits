        ...
        fields: [
            {
                ...
                helpText:
                    "Found in Greenhouse Settings → Dev Center → API Credential Management",
            },
            {
        ...
        fields: [
            {
                ...
                helpText:
                    "Found in Workable Settings → Integrations → API Access",
            },
            {
                name: "subdomain",
                label: "Subdomain",
                ...
                helpText:
                    "Your Workable subdomain (e.g., company-name.workable.com)",
            },
        ],
    },
    ashby: {
...
export default function NewIntegrationPage() {
    ...
    const [selectedPlatform, setSelectedPlatform] =
        useState<ATSPlatform | null>(null);
            ...
            {step === "select" && (
                <div>
                    <h2 className="text-xl font-semibold mb-4">
                        Select Your ATS Platform
                    </h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {(Object.keys(PLATFORMS) as ATSPlatform[]).map(
                            (platform) => {
                                const config = PLATFORMS[platform];
                                return (
                                    <button
                                        key={platform}
                                        className="card bg-base-100 shadow hover:shadow transition-all text-left"
                                        onClick={() =>
                                    ...
                                    >
                                        <div className="card-body">
                                            <div className="flex items-start gap-4">
                                                ...
                                                >
                                                    <div
                                                        className={`bg-${config.color} text-${config.color}-content rounded-full w-12`}
                                                    >
                                                        <i
                                                            className={`fa-duotone fa-regular ${config.icon} text-xl`}
                                                        ></i>
                                                    </div>
                                                </div>
                    ...
                    <form onSubmit={handleSubmit} className="card-body">
                        ...
                        <div className="flex items-center gap-4 mb-6 pb-4 border-b border-base-300">
                            ...
                            <div className={`avatar avatar-placeholder`}>
                                <div
                                    className={`bg-${platformConfig.color} text-${platformConfig.color}-content rounded-full w-12`}
                                >
                                    <i
                                        className={`fa-duotone fa-regular ${platformConfig.icon} text-xl`}
                                    ></i>
                                </div>
                            </div>
                            <div>
