...
import type { Candidate } from '@splits-network/shared-types';
            ...
            <div className="modal-box max-w-4xl">
                ...
                <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="p-4 bg-base-200/50 rounded-lg">
                                {candidate.current_title && (
                                    <div className="font-semibold text-lg">{candidate.current_title}</div>
                                )}
                    ...
                    {candidate.location && (
                        <div>
                            <h4 className="font-semibold text-lg mb-2 flex items-center gap-2">
                                <i className="fa-duotone fa-regular fa-location-dot text-error"></i>
                                Location
                            </h4>
                            <div className="p-4 bg-base-200/50 rounded-lg">
                                {candidate.location}
