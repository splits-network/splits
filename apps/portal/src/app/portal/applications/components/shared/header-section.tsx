    ...
    return (
        <section className="bg-dark -mx-2 -mt-2">
                    ...
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <h1 className="header-title text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight leading-[0.95] mb-6 text-white opacity-0">
                            ...
                            <span className="relative inline-block">
                                <span className="text-coral">Applications</span>
                        ...
                        <p className="header-subtitle text-lg md:text-xl mb-10 max-w-2xl mx-auto leading-relaxed text-white/70 opacity-0">
                            Track candidates across each pipeline stage and keep feedback, notes, and actions in one place.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="retro-metrics grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 w-full">
                {[
                    { label: "Total", value: stats.total, color: "bg-coral", fg: "text-coral-content" },
                    { label: "Submitted", value: stats.submitted, color: "bg-teal", fg: "text-teal-content" },
                    { label: "Interview", value: stats.interview, color: "bg-yellow", fg: "text-yellow-content" },
                    { label: "Offer", value: stats.offer, color: "bg-purple", fg: "text-purple-content" },
                ].map((stat, i) => (
                    <div key={i} className={`metric-block metric-block-sm ${stat.color} ${stat.fg}`}>
