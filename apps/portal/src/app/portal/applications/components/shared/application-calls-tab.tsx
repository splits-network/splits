...
interface ApplicationCallsTabProps {
...
export function ApplicationCallsTab({ applicationId, applicationTitle }: ApplicationCallsTabProps) {
    ...
    const fetchMeta = useCallback(async () => {
        try {
            ...
            const [statsRes, tagsRes] = await Promise.all([
                client.get<{ data: CallStats }>(`/calls/stats?entity_type=application&entity_id=${applicationId}`),
        ...
        <div className="space-y-4">
            ...
            {loading && calls.length === 0 ? (
                ...
                <div className="py-12 text-center">
                    ...
                    <p className="text-base-content/50">No calls linked to this application yet.</p>
                </div>
            ) : (
            ...
            <CallCreationModal
                ...
                defaultEntityId={applicationId}
                defaultEntityLabel={applicationTitle}
                onSuccess={() => {
