...
const ENTITY_FILTERS: {
...
}[] = [
    {
        type: "candidate",
        label: "Candidates",
        icon: ENTITY_TYPE_CONFIG.candidate.icon,
    },
    { type: "job", label: "Jobs", icon: ENTITY_TYPE_CONFIG.job.icon },
    {
        type: "company",
        label: "Companies",
    ...
    },
    {
        type: "application",
        label: "Applications",
        icon: ENTITY_TYPE_CONFIG.application.icon,
    },
    {
        type: "placement",
        label: "Placements",
        icon: ENTITY_TYPE_CONFIG.placement.icon,
    },
];
                    ...
                    <div className="lg:col-span-4">
                        ...
                        {!showInitial && (
                            <div className="flex items-center justify-between mb-6">
                                ...
                                {/* Mobile sort (hidden on desktop since it's in sidebar) */}
                        ...
                        {isEmpty && (
                            <BaselEmptyState
                                ...
                                suggestions={[
                                    ...
                                    "Remove entity type filters to search all types",
                        ...
                        {showInitial && !isLoading && (
                            <BaselEmptyState
                                ...
                                description="Find candidates, jobs, companies, recruiters, applications, and placements across the entire platform. Use the sidebar filters to narrow results by entity type."
                                suggestions={[
                                    "Search by name, title, skill, or keyword",
                                    "Use checkboxes to filter by entity type",
                                    "Combine multiple entity types for cross-type search",
            ...
            fallback={
                <main className="min-h-screen bg-base-100">
                    <section className="bg-base-300 text-base-content py-14 lg:py-18">
                        <div className="container mx-auto px-6 lg:px-12">
                            <div className="h-6 w-32 bg-base-content/10 mb-4 animate-pulse" />
                            <div className="h-12 w-64 bg-base-content/10 mb-6 animate-pulse" />
                            <div className="h-14 max-w-2xl bg-base-content/10 animate-pulse" />
                        </div>
                    </section>
                </main>
            }
