        ...
        <section className="bg-dark -mx-2 -mt-2">
            <div className="relative overflow-hidden py-16 bg-dark -mx-2 -mt-4">
                ...
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    <div className="memphis-shape absolute top-[8%] left-[4%] w-20 h-20 rounded-full border-4 border-purple opacity-0" />
                    ...
                    <div className="memphis-shape absolute top-[20%] right-[18%] w-14 h-14 rotate-12 bg-coral opacity-0" />
                    <div className="memphis-shape absolute bottom-[25%] right-[30%] w-20 h-8 -rotate-6 border-4 border-purple opacity-0" />
                    <div className="memphis-shape absolute top-[40%] left-[22%] w-10 h-10 rotate-45 bg-teal opacity-0" />
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-5xl mx-auto text-center">
                        <div className="header-badge inline-block mb-6 opacity-0">
                            <span className="badge badge-purple badge-lg">
                        ...
                        <h1 className="header-title text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight leading-[0.95] mb-6 text-white opacity-0">
                            ...
                            <span className="relative inline-block">
                                <span className="text-purple">Subscriptions</span>
                        ...
                        <p className="header-subtitle text-lg md:text-xl mb-10 max-w-2xl mx-auto leading-relaxed text-white/70 opacity-0">
                            ...
                            history. Split-fee recruiting, made transparent.
                        </p>
                    </div>
                </div>
            </div>
