            ...
            <div className="alert alert-info">
                ...
                <div>
                    ...
                    <p className="text-sm opacity-80">
                        Ask questions to gather important information. Types:{" "}
                        <strong>Text</strong> (open-ended),
                        <strong>Yes/No</strong> (binary),{" "}
                        <strong>Select</strong> (single choice),
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-base-content/60">
                        Examples: eligibility, clearance status, relocation
                        willingness
                    </p>
                </div>
                <button
    ...
    return (
        <div className="card bg-base-200 p-4">
            <div className="space-y-3">
                ...
                {requiresOptions && (
                    <div className="space-y-2 pl-4 border-l-2 border-coral/30">
                        ...
                        {question.options && question.options.length > 0 && (
                            <div className="space-y-1">
                                {question.options.map((option, optIdx) => (
                                    ...
                                    >
                                        <span className="text-base-content/60 text-sm w-4">
                                            {optIdx + 1}.
                                        </span>
