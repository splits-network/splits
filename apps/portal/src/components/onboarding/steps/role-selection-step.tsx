        ...
        <div className="space-y-6 max-w-3xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <button
                    ...
                    className="card card-border hover:border-coral hover:shadow transition-all p-6 text-left"
                >
                    <div className="flex flex-col items-center text-center space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-base-content/70 mt-2">
                                Find candidates, collaborate with other
                                recruiters, and earn referral fees
                            </p>
                        </div>
                ...
                >
                    <div className="flex flex-col items-center text-center space-y-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-base-content/70 mt-2">
                                Post jobs, manage candidates, and work with
                                recruiters to fill positions
                            </p>
                        </div>
                    </div>
                </button>
