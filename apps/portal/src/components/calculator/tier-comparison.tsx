    ...
    return (
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
                {/* Free Tier */}
                <div
                    className={`card bg-base-200 shadow ${currentTier === "free" ? "ring-2 ring-primary" : ""}`}
                >
                ...
                <div
                    className={`card bg-primary text-primary-content shadow-lg ${currentTier === "paid" ? "ring-2 ring-accent ring-offset-2" : ""}`}
                >
                    <div className="card-body p-3 text-center">
                        {currentTier === "paid" && (
                ...
                >
                    <div className="card-body p-3 text-center">
                        ...
                        <div className="badge badge-accent badge-sm mb-1">
                ...
                <div className="alert bg-success/10 border-success/30">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-base-content/70">
                            On a {formatCurrency(effectiveFee)} placement,
                            upgrading to Partner earns you{" "}
                            <span className="font-bold text-success">
                                {formatCurrency(upgradeValue.premiumVsFree)}
                            </span>{" "}
                            more — that's{" "}
                            {((upgradeValue.premiumVsFree / 249) * 100).toFixed(
                                0,
                            )}
