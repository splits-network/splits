...
const GROUPS = [
    ...
    {
        title: "Account",
        categories: ["billing", "security", "invitations"],
    },
    {
        title: "Updates",
    ...
    return (
        <div className="flex items-center gap-4 px-4 py-3 hover:bg-base-200/50 transition-colors">
            ...
            <div className="w-14 flex justify-center">
                <div
                    className={
                        !emailEntitled && !pref.unsubscribable
                ...
                >
                    <input
                        ...
                        onChange={() =>
                            onToggle(pref.category, "email_enabled")
                        }
                    />
                </div>
            </div>
