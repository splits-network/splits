...
/**
 * Basel editorial header for email — diagonal clip-path accent,
 * large display heading, stat bar with DaisyUI semantic tokens.
 */
            ...
            <div className="relative container mx-auto px-6 lg:px-12">
                <div className="max-w-4xl">
                    ...
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-black leading-[0.92] tracking-tight mb-6">
                        ...
                        <span className="inline-block">Unified.</span>
                    </h1>
