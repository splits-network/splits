...
interface RecordingControlsProps {
    ...
    /** Company users have no subscription plans — show recording toggle only */
...
export function RecordingControls({
    ...
    return (
        <BaselFormField label="Recording">
            <div className="space-y-3">
                ...
                {/* Company users only get the recording toggle — no subscription tiers */}
                {isCompanyUser ? null : (
                    <>
