        ...
        <div className="relative overflow-hidden border border-base-300 p-4">
            ...
            <div className="blur-sm select-none pointer-events-none">
                ...
                <div className="text-sm text-base-content/60">
                    AI-powered analysis with semantic matching, career
                    trajectory scoring, and deeper candidate insights.
                </div>
            </div>
            ...
            <div className="">
                ...
                <p className="text-sm text-base-content/60 mb-3 text-center px-4">
                    Get AI-powered match analysis, deeper candidate insights,
                    and higher placement confidence with a Partner plan.
                </p>
