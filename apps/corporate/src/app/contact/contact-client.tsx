                ...
                <div className="container mx-auto px-4 relative z-10 py-16">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="hero-headline text-4xl md:text-6xl lg:text-7xl font-black uppercase tracking-tight leading-[0.95] mb-6 opacity-0 text-white">
                            LET'S BUILD THE{" "}
                            <span className="text-coral">FUTURE</span>
                        </h1>
                        ...
                        <p className="hero-subtext text-lg md:text-xl leading-relaxed mb-8 opacity-0 text-white/70">
                            ...
                            partnership? Need enterprise pricing? We're building
                            the next generation of split-fee recruiting. Let's
                            talk.
                        </p>
                        ...
                        <div className="hero-stat inline-flex items-center gap-2 px-4 py-2 border-4 border-teal text-xs font-bold uppercase tracking-wider opacity-0 text-white/60">
                            <i className="fa-duotone fa-regular fa-rocket text-teal"></i>
                            <span>
                                    ...
                                    {formStatus === "success" ? (
                                        ...
                                        >
                                            ...
                                            <p className="text-xs text-dark/40 text-center">
                                                For urgent sales inquiries, call
                                                us at{" "}
                                                <a
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center max-w-3xl mx-auto opacity-0">
                        ...
                        <p className="text-lg mb-8 text-white/60">
                            ...
                            into our documentation to learn how we're changing
                            recruiting.
                        </p>
