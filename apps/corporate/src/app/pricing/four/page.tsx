...
const TIERS: PricingTier[] = [
  {
    name: "Starter",
    description: "For individual recruiters getting started with split placements.",
    monthlyPrice: 49,
    yearlyPrice: 39,
  ...
  {
    name: "Enterprise",
    description: "For large agencies with advanced needs and compliance requirements.",
    monthlyPrice: 399,
    yearlyPrice: 319,
...
const COMPARISON: FeatureRow[] = [
  { name: "Active Roles", starter: "10", professional: "Unlimited", enterprise: "Unlimited" },
  { name: "Candidate Submissions", starter: "5 / mo", professional: "50 / mo", enterprise: "Unlimited" },
  { name: "Team Members", starter: "1", professional: "10", enterprise: "Unlimited" },
  { name: "AI Matching", starter: false, professional: true, enterprise: true },
  { name: "Automation Workflows", starter: false, professional: false, enterprise: true },
...
export default function PricingFourPage() {
  ...
  const savings = Math.round(
    ((TIERS[1].monthlyPrice - TIERS[1].yearlyPrice) / TIERS[1].monthlyPrice) *
      100
  );
      ...
      <header className="cin-pricing-hero bg-neutral text-neutral-content">
        <div className="max-w-6xl mx-auto px-6 pt-16 pb-20 text-center">
          ...
          <p className="text-neutral-content/60 max-w-xl mx-auto text-lg mb-8">
            Choose the plan that fits your recruiting business. All plans include
            a 14-day free trial.
          </p>
          ...
          <div className="flex items-center justify-center gap-3">
            <span
              className={`text-sm font-semibold ${
                !annual ? "text-neutral-content" : "text-neutral-content/40"
              }`}
            >
              Monthly
            </span>
            ...
            >
              ...
              <div className="mb-6">
                <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center mb-4">
                  <i className={`${tier.icon} text-primary text-lg`} />
                </div>
              ...
              <div className="mb-6">
                ...
                {annual && (
                  <p className="text-xs text-base-content/40 mt-1">
                    ${tier.yearlyPrice * 12}/year &middot; billed annually
                  </p>
                )}
              </div>
              ...
              <button
                className={`btn w-full ${
                  tier.highlighted ? "btn-primary" : "btn-outline border-base-300"
                }`}
              >
                {tier.cta}
              </button>
          ...
          <table className="table table-sm w-full">
            <thead>
              <tr className="bg-base-200/60">
                ...
                <th className="text-center bg-primary/5">Professional</th>
                <th className="text-center">Enterprise</th>
              </tr>
            </thead>
            <tbody>
              {COMPARISON.map((row) => (
                <tr key={row.name} className="hover:bg-base-200/30">
                    ...
                    (tier) => (
                      <td
                        ...
                        className={`text-center ${
                          tier === "professional" ? "bg-primary/5" : ""
                        }`}
                      >
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-base-content/60 mb-8 max-w-lg mx-auto">
            Join thousands of recruiters who use Splits Network to find better
            roles, close more placements, and earn more revenue.
          </p>
