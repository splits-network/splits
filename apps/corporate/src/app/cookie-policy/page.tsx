                ...
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="bl-section scroll-reveal fade-up">
                        ...
                        <p className="text-base leading-relaxed text-base-content/80 mb-6">
                            ...
                            when you visit our websites. They help us recognize
                            you, remember your preferences, and improve your
                            experience.
                        </p>
                        <div className="grid md:grid-cols-2 gap-4">
                            {[
                                {
                                    title: "Web Beacons",
                                    desc: "Small transparent images that track page views",
                                },
                                {
                                    title: "Local Storage",
                                    desc: "Browser storage for persistent data",
                                },
                                {
                                    title: "Session Storage",
                                    desc: "Temporary data during your session",
                                },
                                {
                                    title: "Fingerprinting",
                                    desc: "Device characteristics for analytics",
                                },
                            ].map((item) => (
                                <div
                                    key={item.title}
                    ...
                    <div className="bl-section scroll-reveal fade-up">
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            {[
                                ...
                                <div
                                    key={cat.title}
                                    className={`border-l-4 border-${cat.color} bg-base-100 p-6 shadow-sm`}
                                >
                                    ...
                                    <ul className="space-y-2 text-sm text-base-content/70">
                                        {cat.items.map((item, i) => (
                                            ...
                                            >
                                                <i
                                                    className={`fa-duotone fa-regular fa-check text-xs text-${cat.color} mt-1`}
                                                />
                                                {item}
                                            </li>
                                        ))}
                ...
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="bl-section scroll-reveal fade-up">
                        ...
                        {[
                            ...
                            <div
                                key={table.label}
                                className={`border-l-4 border-${table.color} bg-base-200 p-6 mb-6 shadow-sm`}
                            >
                                <span
                                    className={`badge badge-${table.color} mb-4`}
                                >
                                    {table.label}
                                </span>
                                <div className="overflow-x-auto">
                                    <table className="table table-sm">
                                        <thead>
                                            <tr>
                                                <th className="font-black uppercase text-xs tracking-wider">
                                                    Cookie
                                                </th>
                                                <th className="font-black uppercase text-xs tracking-wider">
                                                    Purpose
                            ...
                            {[
                                {
                                    ...
                                    desc: "Traffic analysis and behavior tracking",
                                },
                                {
                                    icon: "fa-duotone fa-regular fa-cursor",
                                    name: "Microsoft Clarity",
                                    desc: "Session recordings, heatmaps, and UX analytics",
                                },
                                {
                                    icon: "fa-duotone fa-regular fa-user",
                                    name: "Clerk Authentication",
                                    desc: "User identity and authentication",
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    name: "Resend",
                                    desc: "Transactional email delivery tracking",
                                },
                            ].map((svc) => (
                                <div
                                    key={svc.name}
                                    className="border-l-4 border-primary bg-base-100 p-5 flex items-center gap-4 shadow-sm"
                                >
                                    <div className="w-12 h-12 bg-primary/10 flex items-center justify-center flex-shrink-0">
                                        <i
                                            className={`${svc.icon} text-primary text-lg`}
                                        />
                                    </div>
                                    <div>
                                        <p className="font-bold text-sm">
                    ...
                    <div className="bl-section scroll-reveal fade-up">
                        ...
                        <div className="border-l-4 border-info bg-info/5 p-6">
                            ...
                            <p className="text-sm text-base-content/70">
                                When you first visit our site, we ask for your
                ...
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="bl-section scroll-reveal fade-up">
                        ...
                        <p className="text-base text-base-content/80">
                            Many browsers allow you to signal a &quot;Do Not
                            Track&quot; (DNT) preference. Currently, we do not
                            respond to DNT signals as there is no industry
                            standard. However, you can still control cookies
                    ...
                    <div className="bl-section scroll-reveal fade-up">
                        ...
                        <div className="space-y-3">
                            {[
                                {
                                    title: "We May Update",
                                    desc: "We review and update this policy regularly to reflect new technologies and regulations",
                                },
                                {
                                    title: "Check Back Often",
                                    desc: "Significant changes will be announced on our website",
                                },
                                {
                                    title: "Your Consent",
                                    desc: "Continued use means acceptance of any policy changes",
                                },
                            ].map((item, i) => (
                                <div
                                    key={i}
                                    className="border-l-4 border-primary bg-base-100 p-4 flex items-start gap-3 shadow-sm"
                                >
