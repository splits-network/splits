...
export default function PrivacyPolicyBaselPage() {
    ...
    const tocItems = [
        ...
        { n: "8", id: "google-api-services", label: "Google API Services" },
        { n: "9", id: "contact", label: "Contact Us" },
    ];
                ...
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="bl-section opacity-0">
                        ...
                        <p className="text-base leading-relaxed text-base-content/80 mb-6">
                            Employment Networks (&quot;we&quot;, &quot;us&quot;,
                            &quot;our&quot;) operates the Splits and Applicant
                            platforms. We&apos;re committed to protecting your
                            privacy and ensuring transparent handling of your
                            personal data.
                        </p>
                            ...
                            {[
                                {
                                    ...
                                    desc: "Provide and improve our platforms",
                                },
                                {
                                    title: "Analytics",
                                    desc: "Understand usage and optimize",
                                },
                                {
                                ...
                                <div
                                    key={item.title}
                                    className="border-l-4 border-primary bg-base-200 p-6"
                                >
                            ...
                            {[
                                {
                                    ...
                                    desc: "Tools and services to operate our platforms",
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    desc: "Integrated services for better functionality",
                                },
                            ].map((item) => (
                                <div
                                    key={item.label}
                    ...
                    <div className="bl-section opacity-0">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            {[
                                {
                                    title: "Encryption",
                                    desc: "TLS/SSL encryption in transit",
                                },
                                {
                                    title: "Access Control",
                                    desc: "Role-based permission system",
                                },
                                {
                    ...
                    <div className="bl-section opacity-0">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            {[
                                ...
                                <div
                                    key={item.title}
                                    className="border-l-4 border-accent bg-base-100 p-5"
                                >
                                    <p className="font-bold text-sm">
                                        {item.title}
                                    </p>
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                },
                                {
                                    ...
                                    name: "Supabase",
                                    desc: "Database and infrastructure",
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    desc: "Interview scheduling & calendar sync (recruiter integration)",
                                },
                                {
                                    icon: "fa-brands fa-google",
                                    name: "Gmail (Google)",
                                    desc: "Email tracking & communication management (recruiter integration)",
                                },
                            ].map((svc) => (
                                <div
                                    key={svc.name}
                                    className="border-l-4 border-primary bg-base-200 p-5 flex items-center gap-4"
                                >
                ...
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="bl-section opacity-0">
                            ...
                            {[
                                {
                                    ...
                                    use: "Google Calendar — schedule and display interview events",
                                },
                                {
                                    scope: "gmail.modify",
                        ...
                        <div className="border-l-4 border-success bg-success/5 p-5 space-y-2">
                            ...
                            <p className="text-sm text-base-content/70">
                                Google user data is used solely to provide the
                                feature for which access was granted. It is
                                never used for advertising, sold, or shared with
                                third parties beyond what is required to operate
                                the integration. Recruiters can revoke access at
                                any time from Account Settings or from their{" "}
                                <a
