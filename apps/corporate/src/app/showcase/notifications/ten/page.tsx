...
const initialNotifications: Notification[] = [
    {
        ...
        description:
            "Hey Katherine, I have 3 strong candidates for the VP Eng role at Cortex AI. Want to schedule a sync?",
        time: "12 min ago",
        read: false,
        icon: "fa-envelope",
        color: "primary",
    ...
    },
    {
        id: "n2",
        type: "application",
        title: "Candidate submitted for Senior SWE",
        description:
            "Rachel Chen has been submitted to Nexus Dynamics by TechFlow Partners via split-fee agreement.",
        time: "45 min ago",
        read: false,
        icon: "fa-user-plus",
        color: "primary",
    ...
    },
    {
        ...
        description:
            "Tom Nguyen has been placed as Backend Engineer at Pipeline Co. Commission: $19,500. Split: 50/50.",
        time: "2 hours ago",
        read: false,
    ...
    },
    {
        id: "n4",
        type: "payment",
        title: "Payment received - $24,000",
        description:
            "Split-fee payment for placement PLC-001 (Rachel Chen → Nexus Dynamics) has been processed.",
        time: "3 hours ago",
        read: false,
    ...
    },
    {
        ...
        description:
            "Your weekly recruiting performance report is ready to view. 3 placements, 12 submissions, $63,500 in fees.",
        time: "5 hours ago",
        read: true,
    ...
    },
    {
        ...
        description:
            "Summit Talent Group wants to connect with you on the Splits Network for executive search collaboration.",
    ...
    },
    {
        ...
        description:
            "J. Martinez from Nexus Dynamics submitted feedback on Priya Sharma. Rating: 4/5. Proceeding to final round.",
    ...
    },
    {
        id: "n8",
        type: "message",
        title: "Message from Sarah Kim",
        description:
            "The client wants to increase the salary range for the DevOps role. Updated to $175K-$200K. Can you update the listing?",
    ...
    },
    {
        ...
        description:
            "Two-factor authentication has been enabled on your account. All sessions are now secured.",
        time: "Mon, Feb 10",
        read: true,
    ...
    },
    {
        id: "n10",
        type: "placement",
        title: "Placement anniversary - 1 year",
        description:
            "Emma Brown has been at DataVault for 1 year. Retention milestone achieved. Great placement!",
        time: "Mon, Feb 10",
        read: true,
    ...
    },
    {
        id: "n11",
        type: "network",
        title: "Recruiter joined your network",
        description:
            "Alex Rivera from Horizon Staffing has joined your network. Specialization: Full-Stack Engineering.",
        time: "Sun, Feb 9",
        read: true,
        icon: "fa-link",
        color: "primary",
    ...
    },
    {
        id: "n12",
        type: "payment",
        title: "Invoice generated - PLC-006",
        description:
            "Invoice #INV-2847 for $19,500 has been generated for placement PLC-006. Payment due in 30 days.",
        time: "Sat, Feb 8",
        read: true,
                ...
                <div className="notif-header flex items-start justify-between">
                    <div>
                        <p className="font-mono text-xs tracking-[0.3em] uppercase text-primary mb-3 opacity-80">
                            sys.notifications &gt; activity_feed v2.0
                        </p>
                        <h1 className="text-3xl font-black tracking-tight">
                            Notifications
                            {unreadCount > 0 && (
                                <span className="ml-3 px-2 py-0.5 bg-primary/10 border border-coral/20 text-primary font-mono text-sm align-middle">
                                    {unreadCount}
                                </span>
                            )}
                        </h1>
                    ...
                    <div className="flex items-center gap-2">
                        {unreadCount > 0 && (
                            ...
                            >
                                <i className="fa-duotone fa-regular fa-check-double mr-1" />{" "}
                                Mark All Read
                            </button>
                        )}
                        <button className="btn btn-ghost btn-sm font-mono uppercase tracking-wider text-[10px]">
                            <i className="fa-duotone fa-regular fa-gear mr-1" />{" "}
                            Settings
                        </button>
                    </div>
                </div>
                    ...
                    <div className="flex gap-1 flex-wrap">
                        ...
                        {Object.entries(typeConfig).map(([key, cfg]) => (
                            <button
                                ...
                                className={`px-2 py-1 font-mono text-[10px] uppercase tracking-wider border transition-colors flex items-center gap-1 ${
                                    typeFilter === key
                                        ? "bg-primary/10 border-coral/20 text-primary"
                                        : "bg-base-200 border-base-content/10 text-base-content/30"
                                }`}
                            >
                                <i
                                    className={`fa-duotone fa-regular ${cfg.icon} text-[9px]`}
                                />{" "}
                                {cfg.label}
                            </button>
                        ))}
                ...
                {filtered.length === 0 ? (
                    <div className="text-center py-20">
                        ...
                        <button
                            ...
                            className="btn btn-outline btn-sm font-mono uppercase tracking-wider text-[10px]"
                        >
                            <i className="fa-duotone fa-regular fa-filter-circle-xmark mr-1" />{" "}
                            Clear Filters
                        </button>
                    </div>
                ) : (
                    <div className="space-y-6">
                        {["today", "yesterday", "this-week", "older"].map(
                            (group) => {
                                    ...
                                    <div key={group}>
                                        ...
                                        <div className="space-y-1">
                                            {items.map((notif) => (
                                                <div
                                                    key={notif.id}
                                                    className={`notif-item group flex items-start gap-4 p-4 border transition-colors cursor-pointer ${
                                                        notif.read
                                                            ? "bg-base-200 border-base-content/5 hover:border-base-content/10"
                                                            : "bg-base-200 border-l-2 border-l-primary border-t border-r border-b border-base-content/5 hover:border-base-content/10"
                                                    }`}
                                                >
                                                    {/* Icon */}
                                                    <div
                                                    ...
                                                    >
                                                        <i
                                                            className={`fa-duotone fa-regular ${notif.icon} text-xs`}
                                                        />
                                                    </div>
                                                        ...
                                                        <div className="flex items-start justify-between gap-2">
                                                            <div className="min-w-0">
                                                                <div className="flex items-center gap-2 mb-0.5">
                                                                    <p
                                                                        className={`text-sm truncate ${notif.read ? "text-base-content/50" : "font-bold"}`}
                                                                    >
                                                                        {
                                                                            notif.title
                                                                        }
                                                                ...
                                                                <p className="text-xs text-base-content/30 leading-relaxed line-clamp-2">
                                                                    {
                                                                        notif.description
                                                                    }
                                                                </p>
                                                            </div>
                                                            <span className="font-mono text-[10px] text-base-content/20 whitespace-nowrap flex-shrink-0">
                                                                {notif.time}
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
                                                        ...
                                                        >
                                                            <i
                                                                className={`fa-duotone fa-regular ${notif.read ? "fa-envelope" : "fa-envelope-open"} text-[10px] text-base-content/30`}
                                                            />
                                                        </button>
                                                        <button
                                                            onClick={(e) => {
