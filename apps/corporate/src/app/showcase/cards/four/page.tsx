...
const companies = [
    {
        ...
        industry: "Fintech",
        size: "5,000+",
        logo: "fa-duotone fa-regular fa-credit-card",
    },
    {
        name: "Notion",
        openRoles: 8,
        ...
        size: "1,000+",
        logo: "fa-duotone fa-regular fa-note-sticky",
    },
    {
        name: "Linear",
        openRoles: 5,
        industry: "Dev Tools",
        size: "100+",
        logo: "fa-duotone fa-regular fa-bolt",
    },
    {
        name: "Figma",
        openRoles: 9,
        ...
        size: "1,500+",
        logo: "fa-duotone fa-regular fa-pen-ruler",
    },
];
        ...
        () => {
            ...
            gsap.fromTo(
                ...
                { opacity: 0, y: 30 },
                {
                    ...
                    ease: "power3.out",
                    scrollTrigger: {
                        trigger: $1(".cin-featured-section"),
                        start: "top 80%",
                    },
                },
            );
            ...
            gsap.fromTo(
                ...
                { opacity: 0, y: 25 },
                {
                    ...
                    ease: "power2.out",
                    scrollTrigger: {
                        trigger: $1(".cin-recruiter-section"),
                        start: "top 85%",
                    },
                },
            );
            ...
            <div className="cin-cards-hero bg-neutral text-white opacity-0">
                <div className="max-w-6xl mx-auto px-6 py-12 lg:py-16">
                    ...
                    <p className="text-base text-white/50 max-w-xl leading-relaxed">
                        ...
                        companies. Featuring highlighted cards, hover states,
                ...
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        {featuredJobs.slice(0, 4).map((job) => (
                            <div
                                key={job.id}
                                className="cin-featured-card group relative border-2 border-coral/20 rounded-2xl p-6 bg-base-100 hover:border-coral/40 hover:shadow-xl transition-all cursor-pointer opacity-0"
                            >
                                ...
                                <p className="text-sm text-base-content/50 leading-relaxed mb-4 line-clamp-2">
                                    {job.description}
                                </p>
                ...
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <div className="cin-jobs-grid grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        {filteredJobs.map((job) => (
                            <div
                                key={job.id}
                                className="cin-job-card group bg-base-100 rounded-xl border border-base-content/5 p-5 hover:shadow-lg hover:border-coral/20 transition-all cursor-pointer opacity-0"
                            >
                                ...
                                <div className="flex flex-wrap gap-1 mb-4">
                                    ...
                                    {job.tags.length > 3 && (
                                        <span className="badge badge-sm bg-base-200 border-0 text-base-content/30">
                                            +{job.tags.length - 3}
                                        </span>
                                    )}
                                </div>
                ...
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        {recruiters.map((rec, i) => (
                            <div
                                key={i}
                                className="cin-recruiter-card group bg-base-100 border border-base-content/5 rounded-xl p-5 text-center hover:shadow-lg hover:border-coral/20 transition-all cursor-pointer opacity-0"
                            >
                                <img
                                    src={rec.avatar}
                                    alt={rec.name}
                                    className="w-16 h-16 rounded-full object-cover mx-auto mb-3 ring-2 ring-primary/20 group-hover:ring-primary/40 transition-all"
                                />
                                <h3 className="font-black text-base mb-0.5 group-hover:text-primary transition-colors">
                                    {rec.name}
                                </h3>
                        ...
                        {companies.map((co, i) => (
                            ...
                            >
                                <div className="w-12 h-12 rounded-xl bg-primary/20 flex items-center justify-center mb-4 group-hover:bg-primary/30 transition-colors">
                                    <i
                                        className={`${co.logo} text-primary text-xl`}
                                    />
                                </div>
                                ...
                                <p className="text-xs text-white/40 mb-4">
                                    {co.industry} &middot; {co.size} employees
                                </p>
