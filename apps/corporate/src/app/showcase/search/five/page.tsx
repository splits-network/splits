...
const sortOptions = [
    ...
    },
    {
        ...
        icon: "fa-duotone fa-regular fa-arrow-down-wide-short",
    },
    {
        value: "salary-asc",
        label: "Lowest Salary",
        icon: "fa-duotone fa-regular fa-arrow-up-wide-short",
    },
    {
        value: "applicants",
    ...
    const chipCls = (active: boolean) =>
        `px-2.5 py-1.5 rounded-lg border text-[10px] font-mono uppercase tracking-wider cursor-pointer transition-colors ${
            active
                ...
                : "border-[#27272a] text-[#e5e7eb]/25 hover:text-[#e5e7eb]/50 hover:border-[#e5e7eb]/10"
        }`;
                ...
                <div className="container mx-auto px-4 py-8">
                    <div className="search-header opacity-0">
                        ...
                        <p className="text-sm text-[#e5e7eb]/40 font-mono">
                            Scan the network with precision filters and signal
                            intelligence.
                        </p>
                    </div>
                </div>
            ...
            <div className="search-bar border-b border-[#27272a] bg-[#09090b] sticky top-0 z-30 opacity-0">
                <div className="container mx-auto px-4 py-3">
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 py-3 rounded-lg border text-xs font-mono uppercase tracking-wider transition-colors ${
                                filtersOpen
                                    ...
                                    : "border-[#27272a] text-[#e5e7eb]/30 hover:border-info/20"
                            }`}
                        >
                            <i className="fa-duotone fa-regular fa-sliders" />
                            Filters
                            {activeFilterCount > 0 && (
                                <span className="w-5 h-5 rounded-full bg-info text-[9px] font-bold flex items-center justify-center text-white">
                                    {activeFilterCount}
                                </span>
                            )}
                        </button>
                        ...
                        >
                            <i
                                className={`fa-duotone fa-regular ${savedSearch ? "fa-check" : "fa-bookmark"}`}
                            />
                    ...
                    {activeFilterCount > 0 && (
                        <div className="flex flex-wrap items-center gap-2 mt-3 pt-3 border-t border-[#27272a]/50">
                            <span className="font-mono text-[9px] text-[#e5e7eb]/20 uppercase tracking-wider mr-1">
                                Active:
                            </span>
                            {filters.departments.map((d) => (
                                <button
                                    key={d}
                                    onClick={() =>
                                        removeFilter("departments", d)
                                    }
                                    className="inline-flex items-center gap-1.5 px-2 py-1 rounded-lg border border-info/20 bg-info/5 text-[10px] font-mono text-info hover:bg-info/10 transition-colors"
                                >
                                    {d}{" "}
                            ...
                            {filters.types.map((t) => (
                                <button
                                    key={t}
                                    onClick={() => removeFilter("types", t)}
                                    className="inline-flex items-center gap-1.5 px-2 py-1 rounded-lg border border-warning/20 bg-warning/5 text-[10px] font-mono text-warning hover:bg-warning/10 transition-colors"
                                >
                                    {t}{" "}
                                    <i className="fa-duotone fa-regular fa-xmark text-[8px]" />
                                </button>
                            ...
                            {filters.statuses.map((s) => (
                                <button
                                    ...
                                    className="inline-flex items-center gap-1.5 px-2 py-1 rounded-lg border border-success/20 bg-success/5 text-[10px] font-mono text-success hover:bg-success/10 transition-colors"
                                >
                                    {s}{" "}
                                    <i className="fa-duotone fa-regular fa-xmark text-[8px]" />
                                </button>
                            ...
                            {filters.experienceLevels.map((l) => (
                                <button
                                    key={l}
                                    onClick={() =>
                                        removeFilter("experienceLevels", l)
                                    }
                                    className="inline-flex items-center gap-1.5 px-2 py-1 rounded-lg border border-yellow/20 bg-accent/5 text-[10px] font-mono text-accent hover:bg-accent/10 transition-colors"
                                >
                                    {l}{" "}
                                    <i className="fa-duotone fa-regular fa-xmark text-[8px]" />
                                </button>
                            ...
                            {(filters.salaryMin > 0 ||
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center gap-1.5 px-2 py-1 rounded-lg border border-[#27272a] bg-[#18181b] text-[10px] font-mono text-[#e5e7eb]/40 hover:text-[#e5e7eb] transition-colors"
                                >
                            ...
                            <button
                                onClick={clearAll}
                                className="font-mono text-[10px] text-error/50 hover:text-error transition-colors ml-2"
                            >
                                Clear all
                            </button>
                        </div>
                    ...
                    {filtersOpen && (
                        <aside className="filter-panel w-[260px] flex-shrink-0 space-y-6 opacity-0 hidden lg:block">
                            ...
                            <div className="border border-[#27272a] bg-[#18181b]/40 rounded-xl p-4">
                                <h3 className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#e5e7eb]/30 mb-3">
                                    Department
                                </h3>
                                ...
                                <div className="space-y-1.5">
                                    {allTypes.map((t) => (
                                        <button
                                            key={t}
                                            onClick={() =>
                                                toggleArrayFilter("types", t)
                                            }
                                            className={`w-full text-left flex items-center gap-2 px-3 py-2 rounded-lg border text-xs font-mono transition-colors ${
                                                filters.types.includes(t)
                                                    ? "border-info/30 bg-info/10 text-info"
                                                    : "border-transparent text-[#e5e7eb]/30 hover:bg-[#e5e7eb]/[0.03]"
                                            }`}
                                        >
                                            <span
                                                className={`w-3.5 h-3.5 rounded border flex items-center justify-center ${filters.types.includes(t) ? "border-info bg-info/20" : "border-[#27272a]"}`}
                                            >
                                                {filters.types.includes(t) && (
                                                    <i className="fa-duotone fa-regular fa-check text-[8px]" />
                                                )}
                                            </span>
                                            {t}
                                        </button>
                                    ...
                                    {allStatuses.map((s) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`w-full text-left flex items-center gap-2 px-3 py-2 rounded-lg border text-xs font-mono uppercase tracking-wider transition-colors ${
                            ...
                            <div className="border border-[#27272a] bg-[#18181b]/40 rounded-xl p-4">
                                ...
                                <div className="space-y-3">
                                    <div>
                                        <label className="font-mono text-[9px] text-[#e5e7eb]/20 mb-1 block">
                                            Min: $
                                            {formatSalary(filters.salaryMin)}
                                        </label>
                                        <input
                                            ...
                                            className="w-full accent-info h-1"
                                        />
                                    </div>
                                    <div>
                                        <label className="font-mono text-[9px] text-[#e5e7eb]/20 mb-1 block">
                            ...
                            <div className="border border-[#27272a] bg-[#18181b]/40 rounded-xl p-4">
                                <button
                                    ...
                                    className={`w-full text-left flex items-center gap-2 text-xs font-mono transition-colors ${filters.featured === true ? "text-warning" : "text-[#e5e7eb]/30"}`}
                                >
                                    <i
                                        className={`fa-duotone fa-regular fa-star ${filters.featured === true ? "text-warning" : ""}`}
                                    />
                                    Featured Only
                                </button>
                            </div>
                    ...
                    <div className="results-area flex-1 min-w-0 opacity-0">
                        ...
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <select
                                    ...
                                    className="bg-[#18181b] border border-[#27272a] rounded-lg px-2.5 py-1.5 text-[10px] text-[#e5e7eb]/40 font-mono focus:outline-none focus:border-info/30 appearance-none cursor-pointer"
                                >
                                    {sortOptions.map((o) => (
                        ...
                        <div className="space-y-3">
                            {results.map((job) => (
                                <div
                                    key={job.id}
                                    className="border border-[#27272a] bg-[#18181b]/40 rounded-xl p-5 hover:border-[#e5e7eb]/10 hover:bg-[#18181b]/60 transition-all cursor-pointer"
                                >
                                    <div className="flex items-start gap-4">
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-xs text-[#e5e7eb]/30 line-clamp-2 mb-3">
                                                {job.description}
                                            </p>
                                            <div className="flex flex-wrap gap-1.5">
                                                {job.tags
                                                    ...
                                                    .map((tag, i) => (
                                                        <span
                                                            key={i}
                                                            className="font-mono text-[9px] text-[#e5e7eb]/20 border border-[#27272a]/50 px-1.5 py-0.5 rounded"
                                                        >
                                                            {tag}
                                                        </span>
                                                    ))}
                                        ...
                                        <div className="text-right flex-shrink-0">
                                            <div className="font-mono text-sm font-bold text-info mb-1">
                                                {job.salary.currency}{" "}
                                                {formatSalary(job.salary.min)}-
                                                {formatSalary(job.salary.max)}
                                            </div>
                                            <div className="font-mono text-[9px] uppercase tracking-wider text-[#e5e7eb]/20 mb-2">
                                                {job.type}
                                            </div>
                                            <span
                                                className={`inline-flex items-center gap-1 font-mono text-[9px] uppercase tracking-wider ${job.status === "open" ? "text-success" : job.status === "filled" ? "text-info" : "text-warning"}`}
                                            >
                                                <span
                                                    className={`w-1.5 h-1.5 rounded-full ${job.status === "open" ? "bg-success animate-pulse" : job.status === "filled" ? "bg-info" : "bg-warning"}`}
                                                />
                                                {job.status}
                                            </span>
                                        </div>
                        ...
                        {results.length === 0 && (
                            <div className="border border-[#27272a] bg-[#18181b]/40 rounded-xl p-16 text-center">
                                ...
                                <div className="font-mono text-sm text-[#e5e7eb]/30 mb-1">
                                    No signals detected
                                </div>
                                <div className="font-mono text-[10px] text-[#e5e7eb]/15 uppercase tracking-wider mb-4">
                                    Adjust filters to widen your scan radius
                                </div>
                                <button
                                    onClick={clearAll}
                                    className="px-4 py-2 rounded-lg border border-info/20 bg-info/5 text-info text-xs font-mono uppercase tracking-wider hover:bg-info/10 transition-colors"
                                >
