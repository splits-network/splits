                ...
                <div className="p-6 space-y-5">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <Field label="Job Title">
                            <input
                                ...
                                className={`input input-sm w-full bg-base-300 border font-mono text-sm ${
                                    errors.title
                                        ? "border-error"
                                        : "border-base-content/10 focus:border-coral/40"
                                }`}
                        ...
                        <Field label="Job Type">
                            <select
                                className="select select-sm w-full bg-base-300 border border-base-content/10 focus:border-coral/40 font-mono text-sm"
                                value={form.type}
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        <Field label="Salary Min ($)">
                            <input
                                type="text"
                                className="input input-sm w-full bg-base-300 border border-base-content/10 focus:border-coral/40 font-mono text-sm"
                                placeholder="80,000"
                    ...
                    <Field label="Requirements">
                        <textarea
                            className="textarea textarea-sm w-full bg-base-300 border border-base-content/10 focus:border-coral/40 font-mono text-sm min-h-[80px]"
                            ...
                            >
                                ...
                                >
                                    {i < step ? (
                                        ...
                                        <i
                                            className={`fa-duotone fa-regular ${stepIcons[i]} text-xs`}
                                        />
                                    )}
                                </div>
                                <span
                    ...
                    {step === 1 && (
                        <div className="space-y-5">
                            ...
                            <Field label="Role Description">
                                <textarea
                                    className="textarea textarea-sm w-full bg-base-300 border border-base-content/10 focus:border-coral/40 font-mono text-sm min-h-[100px]"
                ...
                <div className="p-6">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-base-content/50 leading-relaxed">
                                    You are about to permanently delete the job
                                    listing{" "}
                    ...
                    <div className="space-y-2 text-sm text-base-content/40">
                        <div className="flex items-center gap-2">
                            ...
                            <span>
                                All candidate applications will be removed
                            </span>
                        </div>
                        <div className="flex items-center gap-2">
                            <i className="fa-duotone fa-regular fa-xmark text-error text-xs" />
            ...
            <section className="relative min-h-[60vh] flex items-center justify-center px-6 pt-24">
                <div className="relative z-10 max-w-5xl mx-auto text-center">
                    ...
                    <p className="page-subtitle max-w-2xl mx-auto text-lg text-base-content/50 font-light leading-relaxed">
                        Three distinct modal patterns for mission-critical
                        operations. Standard forms, guided wizards, and
            ...
            <section className="relative py-24 px-6">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {/* Card 1: Create Job */}
                        <div className="trigger-card group relative p-8 bg-base-200 border border-base-content/5 hover:border-coral/30 transition-colors duration-300">
                            ...
                            <p className="text-sm text-base-content/50 leading-relaxed mb-6">
                                A complete job creation form with field
                                validation, type selection, and salary range
                                configuration. Standard single-view modal
                                pattern.
                            </p>
                        ...
                        <div className="trigger-card group relative p-8 bg-base-200 border border-base-content/5 hover:border-coral/30 transition-colors duration-300">
                            ...
                            <p className="text-sm text-base-content/50 leading-relaxed mb-6">
                                A four-phase guided deployment sequence.
                                Collects job details, requirements, and
                                compensation with a final review before
                                submission.
                            </p>
                        ...
                        <div className="trigger-card group relative p-8 bg-base-200 border border-base-content/5 hover:border-error/30 transition-colors duration-300">
                            ...
                            <p className="text-sm text-base-content/50 leading-relaxed mb-6">
                                A destructive action confirmation dialog with
                                detailed impact warnings and explicit user
