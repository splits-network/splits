...
const deploymentPhases = [
    {
        ...
        title: "Initialize",
        description:
            "Create your organization and configure your recruiting profile. Set specializations, regions, and split preferences.",
        icon: "fa-power-off",
    },
    {
        phase: "02",
        title: "Connect",
        description:
            "The network scans for compatible partners. Accept or propose splits on active job orders that match your expertise.",
        icon: "fa-link",
    },
    {
        phase: "03",
        title: "Execute",
        description:
            "Work candidates through the pipeline. Every stage is tracked, every handoff is logged, every milestone triggers the next action.",
        icon: "fa-terminal",
    },
    {
        phase: "04",
        title: "Collect",
        description:
            "Placement confirmed. Fees calculated automatically, payouts distributed on schedule. No chasing invoices.",
        icon: "fa-vault",
    },
];
            ...
            <section className="relative min-h-[90vh] flex items-center justify-center px-6">
                ...
                <div className="relative z-10 max-w-5xl mx-auto text-center">
                    ...
                    <p className="hero-subtitle max-w-2xl mx-auto text-lg md:text-xl text-base-content/50 font-light leading-relaxed mb-10">
                        A unified command center for split-fee recruiting.
                        Monitor your network, execute placements, and collect
                        fees — all from one operational dashboard.
                    </p>
                ...
                {/* Corner decorations */}
                <div className="absolute top-8 left-8 w-12 h-12 border-l-2 border-t-2 border-coral/30" />
                <div className="absolute top-8 right-8 w-12 h-12 border-r-2 border-t-2 border-coral/30" />
                <div className="absolute bottom-8 left-8 w-12 h-12 border-l-2 border-b-2 border-coral/30" />
                <div className="absolute bottom-8 right-8 w-12 h-12 border-r-2 border-b-2 border-coral/30" />
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {operationPanels.map((panel, idx) => (
                            <div
                                key={panel.title}
                                className={`op-panel group relative p-8 bg-base-200 border border-base-content/5 hover:border-coral/30 transition-colors duration-300 ${
                                    idx === 0 ? "md:row-span-2" : ""
                                }`}
                            >
                                {/* Panel index */}
                                ...
                                <div className="flex items-start gap-4 mb-6">
                                    <div className="w-12 h-12 flex items-center justify-center bg-primary/10 text-primary border border-coral/20">
                                        <i
            ...
            <section className="relative py-24 px-6">
                <div className="max-w-6xl mx-auto">
                    <div className="img-reveal relative overflow-hidden aspect-[21/9]">
                        ...
                        {/* Corner brackets */}
                        <div className="absolute top-4 left-4 w-8 h-8 border-l border-t border-coral/50" />
                        <div className="absolute top-4 right-4 w-8 h-8 border-r border-t border-coral/50" />
                        <div className="absolute bottom-4 left-4 w-8 h-8 border-l border-b border-coral/50" />
                        <div className="absolute bottom-4 right-4 w-8 h-8 border-r border-b border-coral/50" />
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {systemModules.map((mod) => (
                            ...
                            >
                                <div className="w-10 h-10 flex items-center justify-center bg-primary/10 text-primary border border-coral/20 mb-6">
                                    <i
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {deploymentPhases.map((phase) => (
                            <div
                                key={phase.phase}
                                className="deploy-phase relative p-8 bg-base-200 border border-base-content/5 group hover:border-coral/20 transition-colors duration-300"
                            >
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div>
                        ...
                        <p className="text-base-content/50 leading-relaxed mb-8">
                            Your recruiting operation generates thousands of
                            data points daily. Mission Control aggregates
                            pipeline activity, partner performance, and
                            financial metrics into a single, real-time view. No
                            tab-switching. No spreadsheet wrangling. Just
                            signal.
                        </p>
            ...
            <section className="py-24 px-6 border-t border-base-content/10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <blockquote className="text-2xl md:text-3xl font-light leading-relaxed text-base-content/70 mb-8">
                        &ldquo;We went from managing splits across emails,
                        spreadsheets, and phone calls to having a single command
                        center. Our placement velocity doubled in the first
                        quarter.&rdquo;
                    </blockquote>
                    <div>
            ...
            <section className="cta-final py-32 px-6 bg-base-200 border-t border-base-content/10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg text-base-content/40 max-w-xl mx-auto mb-10">
                        Stop operating in the dark. Initialize your command
                        center and take control of every split, every placement,
                        every dollar.
                    </p>
