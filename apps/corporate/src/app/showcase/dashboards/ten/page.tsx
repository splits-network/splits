        ...
        <aside className="w-64 h-full bg-base-200 border-r border-base-content/5 flex flex-col">
                        ...
                        <li key={item.label}>
                            <a
                                ...
                                className={`sidebar-nav-item flex items-center gap-3 px-3 py-2.5 font-mono text-xs uppercase tracking-wider transition-colors duration-200 ${
                                    item.active
                                        ? "bg-primary/10 text-primary border-l-2 border-coral"
            ...
            <div className="p-4 border-t border-base-content/5">
                <div className="flex items-center gap-3 px-2">
                    <div className="w-8 h-8 flex items-center justify-center bg-primary/10 text-primary border border-coral/20 font-mono text-xs font-bold">
                        SC
                    </div>
        ...
        >
            ...
            <main className="flex-1 min-w-0">
                ...
                <section className="relative px-6 pt-8 pb-8">
                    ...
                    <div className="relative z-10 max-w-7xl mx-auto">
                        ...
                        <div className="flex items-center gap-4 mb-8">
                            <button
                                ...
                                className="lg:hidden w-10 h-10 flex items-center justify-center bg-base-200 border border-base-content/5 text-base-content/50 hover:text-primary hover:border-coral/20 transition-colors"
                            >
                    ...
                    {/* Corner decorations */}
                    <div className="absolute top-6 right-6 w-10 h-10 border-r-2 border-t-2 border-coral/20" />
                </section>
                ...
                <section className="kpi-row px-6 py-6">
                    <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        {kpis.map((kpi, idx) => (
                            <div
                                key={kpi.label}
                                className="kpi-card relative p-6 bg-base-200 border border-base-content/5 hover:border-coral/20 transition-colors duration-300 group"
                            >
                                {/* Index number */}
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="w-10 h-10 flex items-center justify-center bg-primary/10 text-primary border border-coral/20">
                                        <i
                                            className={`fa-duotone fa-regular ${kpi.icon} text-lg`}
                                        />
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="font-mono text-3xl font-black text-base-content tracking-tight">
                                            {kpi.formatted}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-2 mt-4 pt-3 border-t border-base-content/5">
                                    ...
                                    <span
                                        className={`font-mono text-xs font-bold ${kpi.trend > 0 ? "text-success" : "text-error"}`}
                                    >
                                        {kpi.trend > 0 ? "+" : ""}
                                        {kpi.trend}%
                                    </span>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="chart-panel p-6 bg-base-200 border border-base-content/5">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <span className="font-mono text-xs text-base-content/20">
                                        01
                                    </span>
                                </div>
                    ...
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 bg-base-200 border border-base-content/5">
                            ...
                            <div className="max-h-[480px] overflow-y-auto">
                                {activityFeed.map((item) => (
                                    ...
                                    >
                                        {/* Avatar */}
                                        <div className="w-9 h-9 flex items-center justify-center bg-primary/10 text-primary border border-coral/20 flex-shrink-0 font-mono text-xs font-bold">
                                            {item.initials}
                                        </div>
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-start gap-2">
                                                <i
                                                    className={`fa-duotone fa-regular ${item.icon} text-primary/60 text-sm mt-0.5`}
                                                />
                        ...
                        <div className="actions-grid space-y-4">
                            ...
                            {quickActions.map((action) => (
                                <button
                                    key={action.title}
                                    className="action-card w-full text-left p-5 bg-base-200 border border-base-content/5 hover:border-coral/30 transition-all duration-300 group"
                                >
                                    <div className="flex items-start gap-4">
                                        <div className="w-10 h-10 flex items-center justify-center bg-primary/10 text-primary border border-coral/20 group-hover:bg-primary/20 transition-colors">
                                            <i
                            ...
                            <div className="p-5 bg-base-200 border border-base-content/5 mt-6">
                                <p className="font-mono text-[10px] uppercase tracking-wider text-base-content/30 mb-3">
                                    System Status
                                </p>
                                <div className="space-y-2.5">
                                    {[
                ...
                <section className="px-6 py-6 border-t border-base-content/10 bg-base-200">
                    <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-6 text-base-content/20">
                            ...
                            <span className="font-mono text-[10px] uppercase tracking-wider">
                                Splits Network // Mission Control
                            </span>
                        </div>
