...
const steps = [
    ...
    },
    {
        num: "04",
        label: "Review",
        icon: "fa-duotone fa-regular fa-magnifying-glass-plus",
    },
];
    ...
    const validateStep = (step: number): boolean => {
        ...
        if (step === 1) {
            ...
            if (description.trim().length < 50)
                e.description = "Minimum 50 characters";
            if (!salaryMin || !salaryMax)
                e.salary = "Both salary bounds required";
            if (
                salaryMin &&
                salaryMax &&
                Number(salaryMin) >= Number(salaryMax)
            )
                e.salary = "Min must be less than max";
        }
        if (step === 2) {
            ...
            >
                <div className="text-center max-w-lg px-6">
                    ...
                    <p className="text-base-content/60 leading-relaxed mb-8">
                        ...
                        is now live on the Splits Network marketplace.
                    </p>
            ...
            <section className="relative bg-base-300 text-base-content py-16 lg:py-20">
                ...
                <div className="relative  container mx-auto px-6 lg:px-12">
                    <div className="max-w-3xl">
                        ...
                        <p className="form-subtitle text-base text-base-content/50 max-w-xl scroll-reveal fade-up">
            ...
            <section className="container mx-auto px-6 lg:px-12 py-10 lg:py-14">
                <div className="form-container scroll-reveal fade-up grid lg:grid-cols-5 gap-10 lg:gap-16">
                    <div className="lg:col-span-3">
                        ...
                        {currentStep === 0 && (
                            <div>
                                ...
                                <p className="text-sm text-base-content/50 mb-8">
                                    Start with the fundamental details about
                                    this role.
                                </p>
                                <div className="space-y-6">
                                    <fieldset>
                                        ...
                                        <input
                                            ...
                                            className={`input w-full bg-base-200 border-base-300 focus:border-coral focus:outline-none ${errors.title ? "border-error" : ""}`}
                                        />
                                    ...
                                    <fieldset>
                                        ...
                                        <select
                                            ...
                                            className={`select w-full bg-base-200 border-base-300 focus:border-coral focus:outline-none ${errors.department ? "border-error" : ""}`}
                                        >
                                            <option value="">
                                                Select department...
                                            </option>
                                    ...
                                    <fieldset>
                                        <label className="text-xs font-semibold uppercase tracking-widest text-base-content/50 mb-3 block">
                                            Employment Type
                                        </label>
                                                ...
                                                <button
                                                    ...
                                                    className={`px-4 py-2 text-sm font-semibold border transition-all ${
                                                        ...
                                                        et.value
                                                            ...
                                                            : "bg-base-200 text-base-content/60 border-base-300 hover:border-coral/50"
                                                    }`}
                                                >
                                                    {et.label}
                                                </button>
                                    ...
                                    <fieldset>
                                        ...
                                        <input
                                            ...
                                            className={`input w-full bg-base-200 border-base-300 focus:border-coral focus:outline-none ${errors.location ? "border-error" : ""}`}
                                        />
                                        ...
                                        <div className="space-y-2">
                                            {[
                                                ...
                                                >
                                                    ...
                                                    />
                                                    <i
                                                        className={`${opt.icon} text-sm ${remotePolicy === opt.value ? "text-primary" : "text-base-content/40"}`}
                                                    />
                                                    <span
                                                        className={`text-sm font-semibold ${remotePolicy === opt.value ? "text-base-content" : "text-base-content/60"}`}
                                                    >
                                                        {opt.label}
                                                    </span>
                                                </label>
                        ...
                        {currentStep === 1 && (
                            <div>
                                ...
                                <p className="text-sm text-base-content/50 mb-8">
                                    Describe the role and set compensation.
                                </p>
                                <div className="space-y-6">
                                    <fieldset>
                                        <label className="text-xs font-semibold uppercase tracking-widest text-base-content/50 mb-2 block">
                                        ...
                                        <textarea
                                            ...
                                            className={`textarea w-full bg-base-200 border-base-300 focus:border-coral focus:outline-none leading-relaxed ${errors.description ? "border-error" : ""}`}
                                        />
                                    ...
                                    <fieldset>
                                        ...
                                        <textarea
                                            ...
                                            className="textarea w-full bg-base-200 border-base-300 focus:border-coral focus:outline-none leading-relaxed"
                                        />
                                    </fieldset>
                                    <fieldset>
                                        <label className="text-xs font-semibold uppercase tracking-widest text-base-content/50 mb-2 block">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <div className="relative flex-1">
                                                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-base-content/30 text-sm">
                                                    $
                                                </span>
                                                <input
                                                    type="number"
                                                    ...
                                                    placeholder="120,000"
                                                    className={`input w-full pl-7 bg-base-200 border-base-300 focus:border-coral focus:outline-none ${errors.salary ? "border-error" : ""}`}
                                                />
                                            </div>
                                        ...
                                        <div
                                            className={`border-2 border-dashed p-6 text-center cursor-pointer transition-colors ${
                                                resumeFile
                                                    ...
                                                    : "border-base-300 hover:border-coral/50 bg-base-200"
                                            }`}
                                            onClick={() =>
                                                setResumeFile(
                                                    resumeFile
                        ...
                        {currentStep === 2 && (
                            <div>
                                ...
                                <p className="text-sm text-base-content/50 mb-8">
                                    Define skills, benefits, and marketplace
                                    terms.
                                </p>
                                <div className="space-y-6">
                                    <fieldset>
                                            ...
                                            {skillSuggestions
                                                ...
                                                .map((sk) => (
                                                    <button
                                                        ...
                                                        className="px-3 py-1 text-xs font-semibold bg-base-200 text-base-content/50 border border-base-300 hover:border-coral/50 hover:text-primary transition-colors"
                                                    >
                                    ...
                                    <fieldset>
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            {benefitOptions.map((b) => (
                                                <label
                                                    key={b}
                                                    className={`flex items-center gap-2 p-2.5 border cursor-pointer transition-all text-sm ${
                                                        benefits.includes(b)
                                                            ? "border-secondary bg-secondary/5 text-base-content"
                                                            : "border-base-300 bg-base-200 text-base-content/50 hover:border-base-content/20"
                                                    }`}
                                                >
                                                    <input
                                                        type="checkbox"
                                                ...
                                                (g) => (
                                                    <button
                                                        ...
                                                        className={`flex-1 py-2 text-sm font-bold border transition-all ${
                                                            guarantee === g
                                                                ? "bg-primary text-primary-content border-coral"
                                                                : "bg-base-200 text-base-content/50 border-base-300 hover:border-coral/50"
                                                        }`}
                                                    >
                                                        {g} days
                                                    </button>
                                    ...
                                    >
                                        ...
                                        <div>
                                            <p className="text-sm font-semibold">
                                                I agree to the Splits Network
                                                marketplace terms
                                            </p>
                                            <p className="text-xs text-base-content/50 mt-0.5">
                                                By posting, you commit to the
                                                split fee and guarantee period
                                                above.
                                            </p>
                                        </div>
                                    </label>
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-base-200 border-t-4 border-coral p-6 mb-6">
                            ...
                            <div className="space-y-3">
                                {steps.map((step, i) => (
                                    ...
                                    >
                                        ...
                                        <span
                                            className={`text-sm ${i <= currentStep ? "font-semibold text-base-content" : "text-base-content/40"}`}
                                        >
                                            {step.label}
                                        </span>
                                    </div>
                        ...
                        <div className="bg-base-200 p-6">
                            <h3 className="text-sm font-black uppercase tracking-wider mb-4 flex items-center gap-2">
                                <i className="fa-duotone fa-regular fa-lightbulb text-warning" />{" "}
                                Tips
                            </h3>
                            <div className="space-y-3">
                                {[
                                    currentStep === 0 &&
                                        "Be specific with the job title for better recruiter matching.",
                                    currentStep === 0 &&
                                        "Including remote policy helps recruiters source faster.",
                                    currentStep === 1 &&
                                        "Descriptions with 200+ words get 3x more recruiter engagement.",
                                    currentStep === 1 &&
                                        "Transparent salary ranges attract higher-quality candidates.",
                                    currentStep === 2 &&
                                        "5-8 required skills gets the best match quality.",
                                    currentStep === 2 &&
                                        "Standard 20% split fee attracts the most recruiter interest.",
                                    currentStep === 3 &&
                                        "Review carefully. Changes after posting notify active recruiters.",
                                    currentStep === 3 &&
                                        "Most roles receive first submissions within 24-48 hours.",
                                ]
                                    .filter(Boolean)
                                    .map((tip, i) => (
                                        <div
                                        ...
                                        >
                                            <i className="fa-duotone fa-regular fa-circle-info text-primary mt-0.5 flex-shrink-0" />
                                            <span>{tip}</span>
                                        </div>
                                    ))}
                            </div>
