...
interface Placement {
    ...
    recruiter: string;
    fee: string;
    status: "placed" | "in-progress" | "pending" | "rejected";
    date: string;
    split: string;
    salary: string;
}
...
const statusColors: Record<string, string> = {
    ...
    "in-progress": "bg-primary/10 border-coral/20 text-primary",
    ...
    return (
        ...
        >
            ...
            <section className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-8">
                ...
                <div className="table-header">
                    <p className="font-mono text-xs tracking-[0.3em] uppercase text-primary mb-3 opacity-80">
                        sys.data &gt; placement_records v2.0
                    </p>
            ...
            <section className="table-container relative z-10 max-w-7xl mx-auto px-6 pb-24">
                ...
                <div className="flex flex-wrap items-center gap-3 mb-4 p-4 bg-base-200 border border-base-content/5">
                    <div className="flex items-center gap-2 flex-1 min-w-[200px]">
                        ...
                        <input
                            ...
                            className="bg-transparent border-none outline-none font-mono text-xs flex-1 text-base-content placeholder:text-base-content/20"
                        />
                    </div>
                    <select
                        value={statusFilter}
                        ...
                        className="select select-xs bg-base-300 border border-base-content/10 font-mono text-[10px]"
                    >
                    ...
                    <div className="flex border border-base-content/10">
                        <button
                            ...
                            className={`w-7 h-7 flex items-center justify-center transition-colors ${!dense ? "bg-primary/10 text-primary" : "text-base-content/30"}`}
                            title="Comfortable"
                        >
                            <i className="fa-duotone fa-regular fa-expand text-[10px]" />
                        </button>
                        <button
                            ...
                            title="Dense"
                        >
                            <i className="fa-duotone fa-regular fa-compress text-[10px]" />
                        </button>
                    </div>
                    <div className="relative">
                        <button
                            onClick={() => setColMenuOpen(!colMenuOpen)}
                            className="btn btn-ghost btn-xs font-mono uppercase tracking-wider text-[9px]"
                        >
                            <i className="fa-duotone fa-regular fa-table-columns mr-1" />{" "}
                            Columns
                        </button>
                        {colMenuOpen && (
                            <div className="absolute right-0 top-full mt-1 w-40 bg-base-200 border border-base-content/10 shadow-xl z-50 p-2">
                                {columns.map((c) => (
                                    <label
                                        key={c.key}
                                        className="flex items-center gap-2 px-2 py-1.5 cursor-pointer hover:bg-base-content/5"
                                    >
                                        <input
                                            type="checkbox"
                    ...
                    <button className="btn btn-ghost btn-xs font-mono uppercase tracking-wider text-[9px]">
                        <i className="fa-duotone fa-regular fa-download mr-1" />{" "}
                        Export
                    </button>
                </div>
                ...
                {/* Bulk Actions */}
                {selectedRows.size > 0 && (
                    <div className="flex items-center gap-4 mb-3 p-3 bg-primary/5 border border-coral/20">
                        <span className="font-mono text-[10px] uppercase tracking-wider text-primary">
                            {selectedRows.size} selected
                        </span>
                        <button className="btn btn-primary btn-xs font-mono uppercase tracking-wider text-[9px]">
                            <i className="fa-duotone fa-regular fa-file-export mr-1" />{" "}
                            Export Selected
                        </button>
                        <button className="btn btn-ghost btn-xs font-mono uppercase tracking-wider text-[9px]">
                            <i className="fa-duotone fa-regular fa-tags mr-1" />{" "}
                            Update Status
                        </button>
                        <button className="btn btn-ghost btn-xs font-mono uppercase tracking-wider text-[9px] text-error/50">
                            <i className="fa-duotone fa-regular fa-trash mr-1" />{" "}
                            Delete
                        </button>
                        <button
                            onClick={() => setSelectedRows(new Set())}
                            className="ml-auto font-mono text-[10px] text-base-content/30 hover:text-base-content/50 uppercase tracking-wider"
                        >
                            Clear
                        </button>
                    </div>
                    ...
                    <table className="w-full">
                            ...
                            <tr>
                                ...
                                {columns
                                    ...
                                    .map((col) => (
                                        <th
                                            key={col.key}
                                            className={`px-3 ${dense ? "py-2" : "py-2.5"} text-left cursor-pointer hover:bg-base-content/5 transition-colors`}
                                        ...
                                        >
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                {sortField === col.key && (
                                                    <i
                                                        className={`fa-duotone fa-regular ${sortDir === "asc" ? "fa-arrow-up" : "fa-arrow-down"} text-[9px] text-primary`}
                                                    />
                                                )}
                                            </div>
                                        </th>
                        ...
                        <tbody>
                            {paged.map((row) => (
                                <tr
                                    key={row.id}
                                    className={`border-t border-base-content/5 hover:bg-base-content/[0.02] transition-colors ${selectedRows.has(row.id) ? "bg-primary/[0.03]" : ""}`}
                                >
                                    ...
                                    {visibleCols.has("id") && (
                                        <td
                                            className={`px-3 ${dense ? "py-1.5" : "py-3"} font-mono text-xs text-primary`}
                                        >
                                            {row.id}
                                        </td>
                                    )}
                                    {visibleCols.has("candidate") && (
                                        <td
                                            className={`px-3 ${dense ? "py-1.5" : "py-3"} text-sm font-bold`}
                                        >
                                            {row.candidate}
                                        </td>
                                    )}
                                    {visibleCols.has("role") && (
                                        <td
                                            className={`px-3 ${dense ? "py-1.5" : "py-3"} text-sm text-base-content/60`}
                                        >
                                            {row.role}
                                        </td>
                                    )}
                                    {visibleCols.has("company") && (
                                        <td
                                            className={`px-3 ${dense ? "py-1.5" : "py-3"} text-sm text-base-content/50`}
                                        >
                                            {row.company}
                                        </td>
                                    )}
                                    {visibleCols.has("fee") && (
                                        <td
                                            className={`px-3 ${dense ? "py-1.5" : "py-3"} font-mono text-xs font-bold text-primary`}
                                        >
                                            {row.fee}
                                        </td>
                                    )}
                                    {visibleCols.has("status") && (
                                        <td
                                            className={`px-3 ${dense ? "py-1.5" : "py-3"}`}
                                        >
                                            <span
                                                className={`px-2 py-0.5 border font-mono text-[9px] uppercase tracking-wider ${statusColors[row.status]}`}
                                            >
                                                {row.status}
                                            </span>
                                        </td>
                                    ...
                                    {visibleCols.has("date") && (
                                        <td
                                            className={`px-3 ${dense ? "py-1.5" : "py-3"} font-mono text-[11px] text-base-content/30`}
                                        >
                                            {row.date}
                                        </td>
                                    )}
                                    <td className="px-3 py-2">
                                        <div className="flex gap-1">
                                            <button
                                                ...
                                                title="View"
                                            >
                                                <i className="fa-duotone fa-regular fa-eye text-[10px] text-base-content/30" />
                                            </button>
                                            <button
                                                className="btn btn-ghost btn-xs btn-square"
                                                title="Edit"
                                            >
                                                <i className="fa-duotone fa-regular fa-pen text-[10px] text-base-content/30" />
                                            </button>
                                            <button
                                                className="btn btn-ghost btn-xs btn-square"
                                                title="Delete"
                                            >
                                                <i className="fa-duotone fa-regular fa-trash text-[10px] text-error/30" />
                                            </button>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div className="flex items-center justify-between mt-4 p-3 bg-base-200 border border-base-content/5">
                    ...
                    <div className="flex gap-1">
                        <button
                            ...
                            disabled={page === 1}
                            className="w-7 h-7 flex items-center justify-center bg-base-300 border border-base-content/10 text-base-content/30 font-mono text-xs disabled:opacity-30"
                        >
                            <i className="fa-duotone fa-regular fa-chevron-left text-[10px]" />
                        </button>
                        {Array.from({ length: totalPages }, (_, i) => (
                            <button
                                key={i}
                                onClick={() => setPage(i + 1)}
                                className={`w-7 h-7 flex items-center justify-center border font-mono text-xs ${page === i + 1 ? "bg-primary/10 border-coral/20 text-primary" : "bg-base-300 border-base-content/10 text-base-content/30"}`}
                            >
                                {i + 1}
                            </button>
                        ))}
