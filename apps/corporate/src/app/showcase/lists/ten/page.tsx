        ...
        >
            ...
            <div className="p-6 border-b border-base-content/5">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                    {[job.type, job.experienceLevel, job.department].map(
                        (tag) => (
                            <span
                                key={tag}
            ...
            <div className="p-6 border-b border-base-content/5">
                ...
                <div className="flex flex-wrap gap-2">
                    {job.tags.map((tag) => (
                        <span
                            key={tag}
                            className="font-mono text-[10px] px-2.5 py-1 bg-primary/5 border border-coral/10 text-primary/70"
                        >
                            {tag}
                        </span>
                    ))}
                ...
                <div className="px-5 pt-6 pb-4 border-b border-base-content/5">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2.5">
                            <div className="w-7 h-7 flex items-center justify-center bg-primary/10 border border-coral/20">
                    ...
                    <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-start md:items-center gap-4">
                        ...
                        <div className="relative flex-1 max-w-md">
                            ...
                            <input
                                ...
                                className="input input-sm w-full pl-9 bg-base-300 border-base-content/5 font-mono text-xs focus:border-coral/30 focus:outline-none"
                            />
                        </div>
                            ...
                            <div className="flex items-center justify-center py-24">
                                <div className="text-center">
                                    ...
                                    <p className="font-mono text-xs text-base-content/15">
                                        Adjust search parameters or clear
                                        filters
                                    </p>
                                </div>
                            </div>
