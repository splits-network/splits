        ...
        >
            ...
            <main className="flex-1 min-w-0 flex flex-col h-screen">
                ...
                <section className="relative px-6 pt-6 pb-4 flex-shrink-0">
                        ...
                        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-3">
                            <div>
                                ...
                                <p className="msg-subtitle text-base-content/40 font-mono text-sm mt-1">
                                    Secure messaging across the recruiting
                                    network
                                </p>
                            </div>
                    ...
                    <div className="absolute top-4 right-6 w-8 h-8 border-r-2 border-t-2 border-coral/20" />
                </section>
                        ...
                        <div className="p-3 border-b border-base-content/5">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-base-300 border border-base-content/5 pl-9 pr-16 py-2.5 font-mono text-xs text-base-content placeholder:text-base-content/20 focus:outline-none focus:border-coral/30 transition-colors"
                                />
                                <button
                                    onClick={() =>
                            ...
                            <div className="flex-1 flex items-center justify-center">
                                <div className="text-center p-8">
                                    ...
                                    <p className="font-mono text-xs text-base-content/15 max-w-xs">
                                        Select a conversation from the inbox to
                                        begin transmitting. All communications
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <div
                                                                className={`px-4 py-3 ${
                                                                    isSelf
                                                                        ? "bg-primary/10 border border-coral/15"
                                                            ...
                                                            >
                                                                ...
                                                                {msg.attachment && (
                                                                    <div className="mt-2 pt-2 border-t border-base-content/5">
                                                                        <div className="flex items-center gap-2 bg-base-content/[0.03] px-3 py-2 border border-base-content/5 cursor-pointer hover:border-coral/20 transition-colors">
                                                                            <i
                                                        ...
                                                        {isSelf && (
                                                            <div className="w-8 h-8 flex-shrink-0 flex items-center justify-center bg-primary/10 text-primary border border-coral/20 font-mono text-[10px] font-bold self-end">
                                                                {
                                    ...
                                    <div className="flex items-end gap-2">
                                        <div className="flex-1 relative">
                                            <textarea
                                                ...
                                                rows={1}
                                                className="w-full bg-base-300 border border-base-content/5 px-4 py-3 font-mono text-xs text-base-content placeholder:text-base-content/20 focus:outline-none focus:border-coral/30 transition-colors resize-none min-h-[44px] max-h-32"
                                                style={
                                                    {
                                                        fieldSizing: "content",
