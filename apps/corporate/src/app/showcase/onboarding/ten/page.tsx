...
export default function OnboardingShowcaseTen() {
    ...
    const goNext = () => {
        if (step < 4) animateStep("next", () => setStep((s) => s + 1));
    };
    const goBack = () => {
        if (step > 0) animateStep("back", () => setStep((s) => s - 1));
    };
    ...
    return (
        <main
            ref={mainRef}
            className="min-h-screen bg-base-300 text-base-content flex flex-col"
        >
            <div
                ...
                <div className="max-w-4xl mx-auto px-6 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                        <div className="w-8 h-8 flex items-center justify-center bg-primary/10 text-primary border border-coral/20">
                            <i className="fa-duotone fa-regular fa-split text-sm" />
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-mono text-[9px] uppercase tracking-wider text-base-content/25">
                            Onboarding Active
                        </span>
                    </div>
                </div>
            ...
            <div className="relative z-10 max-w-4xl mx-auto w-full px-6 pt-8 pb-4">
                <div className="flex items-center justify-between mb-3">
                    {steps.map((s, i) => (
                        ...
                        >
                            <div
                                className={`w-9 h-9 flex items-center justify-center border font-mono text-xs transition-colors duration-300 ${
                                    i < step
                                        ? "bg-primary text-primary-content border-coral"
                                        : i === step
                                          ? "bg-primary/10 text-primary border-coral/40"
                                          : "bg-base-200 text-base-content/20 border-base-content/10"
                                }`}
                            >
                                {i < step ? (
                                    ...
                                    <i
                                        className={`fa-duotone fa-regular ${s.icon} text-xs`}
                                    />
                                )}
                            </div>
                            <span
                                className={`font-mono text-[10px] uppercase tracking-wider hidden md:inline ${i === step ? "text-primary" : i < step ? "text-base-content/40" : "text-base-content/15"}`}
                            >
                                {s.label}
                            </span>
                            {i < 4 && (
                                <div
                                    className={`flex-1 h-[1px] mx-2 transition-colors ${i < step ? "bg-primary/40" : "bg-base-content/10"}`}
                                />
                            )}
                        </div>
                    ))}
                ...
                <div ref={stepRef} className="onboard-content w-full max-w-2xl">
                    ...
                    {step === 0 && (
                        <div className="text-center">
                            ...
                            <div className="w-20 h-20 flex items-center justify-center bg-primary/10 text-primary border-2 border-coral/20 mx-auto mb-6">
                                <i className="fa-duotone fa-regular fa-terminal text-3xl" />
                            </div>
                            ...
                            <p className="text-base-content/50 max-w-lg mx-auto leading-relaxed mb-8">
                                You are about to initialize your command center
                                on the Splits Network. We will configure your
                                identity, calibrate your specializations, and
                                set your operational preferences.
                            </p>
                            <div className="flex gap-4 justify-center mb-8">
                                {[
                                    ...
                                    <div
                                        key={i.label}
                                        className="flex items-center gap-2 text-base-content/30"
                                    >
                                        <i
                                            className={`fa-duotone fa-regular ${i.icon} text-xs`}
                                        />
                            ...
                            <button
                                onClick={goNext}
                                className="btn btn-primary btn-lg font-mono uppercase tracking-wider text-sm"
                            >
                    ...
                    {step === 1 && (
                        <div className="bg-base-200 border border-base-content/10 p-6">
                            <div className="flex items-center gap-2 mb-6">
                                <i className="fa-duotone fa-regular fa-user text-primary text-lg" />
                                <div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-6 mb-4">
                                    <div className="w-20 h-20 flex items-center justify-center bg-base-300 border-2 border-dashed border-base-content/10 text-base-content/20 cursor-pointer hover:border-coral/30 transition-colors">
                                        <i className="fa-duotone fa-regular fa-camera text-xl" />
                                    </div>
                                    <div>
                                ...
                                <fieldset className="space-y-1.5">
                                    ...
                                    <textarea
                                        placeholder="Brief description of your recruiting background..."
                                        value={formData.bio}
                                        onChange={(e) =>
                                            setFormData((p) => ({
                                                ...p,
                    ...
                    {step === 2 && (
                        <div className="bg-base-200 border border-base-content/10 p-6">
                            <div className="flex items-center gap-2 mb-6">
                                <i className="fa-duotone fa-regular fa-radar text-primary text-lg" />
                                <div>
                                    <h2 className="text-xl font-bold tracking-tight">
                                        Skill Calibration
                                    </h2>
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <p className="text-xs text-base-content/30 mb-3">
                                        Select all areas you recruit for
                                    </p>
                    ...
                    {step === 3 && (
                        <div className="bg-base-200 border border-base-content/10 p-6">
                            <div className="flex items-center gap-2 mb-6">
                                <i className="fa-duotone fa-regular fa-sliders text-primary text-lg" />
                                <div>
                                    <h2 className="text-xl font-bold tracking-tight">
                            ...
                            <div className="space-y-5">
                                <fieldset className="space-y-1.5">
                                    <label className="font-mono text-[11px] uppercase tracking-wider text-base-content/40">
                                        Default Split-Fee Preference
                                    </label>
                                    <div className="grid grid-cols-2 gap-2">
                                        {splitPrefs.map((sp) => (
                                            <label
                                                key={sp}
                                                className={`flex items-center gap-2 px-3 py-2.5 cursor-pointer border transition-colors font-mono text-xs ${
                                                    formData.splitPref === sp
                    ...
                    {step === 4 && (
                        <div className="text-center">
                            <div className="w-24 h-24 flex items-center justify-center bg-success/10 text-success border-2 border-success/20 mx-auto mb-6">
                                <i className="fa-duotone fa-regular fa-check text-4xl" />
                            </div>
                            <p className="font-mono text-xs tracking-[0.3em] uppercase text-success mb-4">
                                // deployment.complete
                            </p>
                            ...
                            <p className="text-base-content/50 max-w-lg mx-auto leading-relaxed mb-8">
                                Your command center is fully operational. The
                                network is scanning for matching job orders and
                                potential split-fee partners based on your
                                configured specializations.
                            </p>
                            <div className="grid grid-cols-3 gap-4 max-w-md mx-auto mb-8">
                                <div className="p-4 bg-base-200 border border-base-content/5 text-center">
                            ...
                            <div className="flex gap-3 justify-center">
                                <button className="btn btn-primary font-mono uppercase tracking-wider text-xs">
                                    <i className="fa-duotone fa-regular fa-grid-2 mr-2" />{" "}
                                    Go to Dashboard
                                </button>
                                <button className="btn btn-outline font-mono uppercase tracking-wider text-xs">
                ...
                <div className="relative z-10 border-t border-base-content/10 bg-base-200">
                    <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button className="btn btn-ghost btn-sm font-mono uppercase tracking-wider text-xs text-base-content/25">
                                Skip
                            </button>
                            <button
                                onClick={goNext}
