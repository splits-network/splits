...
export default function AuthFourPage() {
  ...
  const SocialButtons = () => (
    <div className="space-y-2">
      <button className="btn btn-outline border-base-300 w-full gap-3 hover:border-primary/40">
        ...
        <fieldset className="fieldset">
          ...
          <div className="relative">
            <input
              ...
              className={`input input-bordered w-full pr-10 bg-base-200/50 border-base-300 focus:border-primary ${
        ...
        <div>
          ...
          <div className="max-w-md">
            ...
            <p className="text-neutral-content/50 leading-relaxed">
              Join thousands of recruiters who collaborate to fill positions
              faster and earn split-fee commissions on placements across the
              network.
            </p>
          </div>
        </div>
        ...
        <div className="mt-auto pt-10">
          <div className="border-t border-white/10 pt-8">
            ...
            <blockquote className="text-sm text-neutral-content/70 leading-relaxed italic mb-4">
              &ldquo;Splits Network transformed how our agency works. We&apos;ve
              closed 3x more placements since joining the marketplace and built
              an incredible network of recruiting partners.&rdquo;
            </blockquote>
