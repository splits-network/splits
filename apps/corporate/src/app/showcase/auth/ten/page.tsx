...
export default function AuthShowcaseTen() {
    ...
    const inputClass = (err?: string) =>
        `input input-sm w-full bg-base-300 border font-mono text-sm ${err ? "border-error" : "border-base-content/10 focus:border-coral/40"}`;

    return (
        <main
            ref={mainRef}
            className="min-h-screen bg-base-300 text-base-content flex items-center justify-center px-6"
        >
            <div
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <div className="w-12 h-12 flex items-center justify-center bg-primary/10 text-primary border border-coral/20 mx-auto mb-4">
                        <i className="fa-duotone fa-regular fa-split text-xl" />
                    </div>
                    <p className="font-mono text-[10px] tracking-[0.3em] uppercase text-primary mb-1">
                        Splits Network
                    </p>
                    <p className="font-mono text-[9px] uppercase tracking-wider text-base-content/20">
                    ...
                    <div className="flex border-b border-base-content/10">
                        {(["login", "signup", "forgot"] as const).map((tab) => (
                            <button
                                ...
                                className={`flex-1 py-3 font-mono text-[10px] uppercase tracking-wider transition-colors border-b-2 -mb-[1px] ${
                                    activeTab === tab
                                        ? "text-primary border-coral bg-primary/5"
                                        : "text-base-content/25 border-transparent hover:text-base-content/40"
                                }`}
                            >
                                {tab === "login"
                                    ? "Sign In"
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className="font-mono text-[10px] text-primary/60 hover:text-primary uppercase tracking-wider"
                                    >
                                        Forgot password?
                                    </button>
                                </div>
                                ...
                                <button
                                    onClick={handleLogin}
                                    disabled={submitting}
                                    className="btn btn-primary btn-sm w-full font-mono uppercase tracking-wider text-[10px]"
                                >
                                    {submitting ? (
                                        <>
                                        ...
                                        <>
                                            <i className="fa-duotone fa-regular fa-right-to-bracket mr-1" />{" "}
                                            Sign In
                                        </>
                                    )}
                                </button>
                                ...
                                <div className="relative my-4">
                                    ...
                                    <div className="relative flex justify-center">
                                        <span className="bg-base-200 px-3 font-mono text-[9px] text-base-content/20 uppercase">
                                            or continue with
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <button className="btn btn-outline btn-sm font-mono text-[10px]">
                                        <i className="fa-brands fa-google mr-2 text-sm" />{" "}
                                        Google
                                    </button>
                                    <button className="btn btn-outline btn-sm font-mono text-[10px]">
                                        <i className="fa-brands fa-linkedin mr-2 text-sm" />{" "}
                                        LinkedIn
                                    </button>
                                </div>
                            </div>
                                        ...
                                        <div className="flex items-center gap-2 mt-1">
                                            <div className="flex-1 h-1 bg-base-300 flex gap-0.5">
                                                {[1, 2, 3, 4].map((l) => (
                                                    <div
                                                        key={l}
                                                        className={`flex-1 h-full ${l <= pw.level ? pw.color : "bg-base-content/5"}`}
                                                    />
                                                ))}
                                            </div>
                                            <span
                                                className={`font-mono text-[9px] uppercase tracking-wider ${pw.level <= 1 ? "text-error" : pw.level <= 2 ? "text-warning" : pw.level <= 3 ? "text-primary" : "text-success"}`}
                                            >
                                                {pw.label}
                                            </span>
                                        </div>
                            ...
                            <div className="space-y-4">
                                ...
                                {forgotSent ? (
                                    <div className="text-center py-6">
                                        <div className="w-16 h-16 flex items-center justify-center bg-success/10 text-success border border-success/20 mx-auto mb-4">
                                            <i className="fa-duotone fa-regular fa-envelope-circle-check text-2xl" />
                                        </div>
                    ...
                    <div className="flex items-center justify-center p-4 border-t border-base-content/5">
                        <div className="flex items-center gap-4 text-base-content/15">
                            <div className="flex items-center gap-1">
                                <i className="fa-duotone fa-regular fa-lock text-[10px]" />
                            ...
                            <span>|</span>
                            <div className="flex items-center gap-1">
                                <i className="fa-duotone fa-regular fa-shield-check text-[10px]" />
                                <span className="font-mono text-[9px] uppercase tracking-wider">
                                    SOC 2
                                </span>
                            </div>
