...
const stats = [
    ...
    },
    {
        ...
        value: "23d",
        icon: "fa-clock",
        trend: "-4d vs industry",
    },
    {
        label: "Rating",
        value: "4.9",
        icon: "fa-star",
        trend: "from 186 reviews",
    },
    {
        label: "Active Splits",
        value: "18",
        icon: "fa-split",
        trend: "across 6 clients",
    },
    {
        label: "Network Score",
        value: "97",
        icon: "fa-chart-network",
        trend: "Top 3% nationally",
    },
];
...
const experience = [
    {
        ...
        company: "Apex Recruiting Group",
        description:
            "Leading a team of 8 recruiters focused on senior technical placements. Manage enterprise client relationships and split-fee partnerships.",
        icon: "fa-briefcase",
        color: "primary",
    },
    {
        ...
        description:
            "Full-cycle technical recruiting for Series B-D startups. Averaged 45 placements per year with 92% retention rate.",
        icon: "fa-users",
        color: "primary",
    },
    {
        ...
        description:
            "Full-stack development on enterprise SaaS products. Transitioned to recruiting after discovering passion for connecting talent with opportunity.",
        icon: "fa-code",
        color: "primary",
    },
];
...
const recentActivity = [
    {
        action: "Placed Senior Backend Engineer",
    ...
    {
        action: "Submitted 3 candidates for VP Eng",
        client: "Cortex AI",
        time: "4 days ago",
        icon: "fa-paper-plane",
        color: "primary",
    ...
    {
        action: "Accepted split-fee proposal",
        client: "TechFlow Partners",
        time: "1 week ago",
        icon: "fa-handshake",
        color: "primary",
    },
            ...
            <section className="relative z-10 max-w-6xl mx-auto px-6 pt-24 pb-8">
                ...
                <div className="profile-header flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex items-start gap-6 flex-1">
                        <div className="w-24 h-24 flex items-center justify-center bg-primary/10 text-primary border-2 border-coral/20 font-mono text-3xl font-black flex-shrink-0">
                            KR
                        </div>
                        <div>
                            ...
                            <div className="flex items-center gap-4 text-xs text-base-content/30 mb-4">
                                ...
                                <span className="flex items-center gap-1">
                                    <i className="fa-duotone fa-regular fa-calendar text-[10px]" />{" "}
                    ...
                    <div className="flex items-start gap-2 flex-shrink-0">
                        <button
                            ...
                            className={`btn btn-sm font-mono uppercase tracking-wider text-[10px] ${connected ? "btn-primary" : "btn-outline"}`}
                        >
                            <i
                                className={`fa-duotone fa-regular ${connected ? "fa-check" : "fa-link"} mr-1`}
                            />{" "}
            ...
            <section className="relative z-10 max-w-6xl mx-auto px-6 pb-8">
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
                    {stats.map((s) => (
                        <div
                            key={s.label}
                            className="stat-card p-4 bg-base-200 border border-base-content/5 text-center"
                        >
                            <i
                                className={`fa-duotone fa-regular ${s.icon} text-primary text-sm mb-2 block`}
                            />
                            <p className="font-mono text-2xl font-black text-primary">
                                {s.value}
                            </p>
                            <p className="font-mono text-[9px] uppercase tracking-wider text-base-content/30 mb-1">
                                {s.label}
                            </p>
                            <p className="font-mono text-[9px] text-base-content/20">
                                {s.trend}
                            </p>
                        </div>
                    ))}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 profile-content space-y-6">
                        ...
                        <div className="flex gap-1 border-b border-base-content/10">
                            {(["about", "activity", "reviews"] as const).map(
                                (tab) => (
                                    <button
                                        key={tab}
                                        onClick={() => setActiveTab(tab)}
                                        className={`px-4 py-2.5 font-mono text-xs uppercase tracking-wider border-b-2 -mb-[1px] transition-colors ${
                                            activeTab === tab
                                ...
                                <div className="timeline-section p-6 bg-base-200 border border-base-content/5">
                                    ...
                                    <div className="space-y-0">
                                        {experience.map((exp, i) => (
                                            <div
                                                key={i}
                                                className="timeline-entry flex gap-4 relative"
                                            >
                                                ...
                                                <div className="w-8 h-8 flex items-center justify-center bg-primary/10 text-primary border border-coral/20 flex-shrink-0">
                                                    <i
                                                        className={`fa-duotone fa-regular ${exp.icon} text-xs`}
                                                    />
                                                </div>
                                                <div className="flex-1 pb-6">
                                                    <p className="font-mono text-[10px] text-base-content/25 uppercase tracking-wider mb-1">
                                                        {exp.period}
                                                    </p>
                                ...
                                <div className="p-6 bg-base-200 border border-base-content/5">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {profile.regions.map((r) => (
                                            <span
                                                key={r}
                                                className="px-3 py-1 bg-base-300 border border-base-content/10 font-mono text-xs text-base-content/50"
                                            >
                                                {r}
                                            </span>
                                        ))}
                                ...
                                {[
                                    {
                                        ...
                                        rating: 5,
                                        text: "Katherine understood our technical requirements perfectly. She delivered a shortlist of 5 candidates, all of whom made it to final rounds. Exceptional quality.",
                                        time: "2 weeks ago",
                                    },
                                    {
                                        author: "R. Singh",
                                        company: "CloudBase",
                                        rating: 5,
                                        text: "Fast, professional, and incredibly thorough. Her engineering background means she can actually evaluate technical candidates, not just keyword match.",
                                        time: "1 month ago",
                                    },
                                    {
                                        author: "L. Torres",
                                        company: "DataVault",
                                        rating: 4,
                                        text: "Great partnership on a difficult VP Engineering search. Took a bit longer than expected but the final placement was outstanding.",
                                        time: "2 months ago",
                                    },
                                ].map((review, i) => (
                                    <div
                                        key={i}
                                        className="p-5 bg-base-200 border border-base-content/5"
                                    >
                                        <div className="flex items-center justify-between mb-3">
                                            <div className="flex items-center gap-3">
                                                <div className="w-9 h-9 flex items-center justify-center bg-base-300 border border-base-content/10 font-mono text-xs font-bold">
                                            ...
                                            <div className="flex items-center gap-1">
                                                {Array.from({
                                                    ...
                                                    <i
                                                        key={j}
                                                        className="fa-solid fa-star text-warning text-[10px]"
                                                    />
                                                ))}
                                                <span className="font-mono text-[10px] text-base-content/20 ml-2">
                                                    {review.time}
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <div className="related-section">
                            ...
                            <div className="space-y-3">
                                {relatedProfiles.map((p) => (
                                    <div
                                        key={p.name}
                                        className="related-card p-4 bg-base-200 border border-base-content/5 hover:border-coral/20 transition-colors cursor-pointer"
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <p className="font-mono text-[8px] text-base-content/20">
                                                    placements
                                                </p>
                                            </div>
                                        </div>
