...
const emptyStates = [
    {
        ...
        description:
            "Try adjusting your filters, broadening your search terms, or checking for typos. Sometimes less specific queries return more results.",
        ...
        actions: [
            {
                label: "Clear Filters",
                style: "btn-primary",
                icon: "fa-duotone fa-regular fa-filter-slash",
            },
            {
        ...
        suggestions: [
            "Try removing location filters",
            "Use broader skill keywords",
    ...
    },
    {
        ...
        description:
            "Start by browsing open roles or importing your existing candidates. The marketplace connects you with companies that match your recruiting niche.",
    ...
    },
    {
        ...
        description:
            "Our team has been notified and is looking into it. You can try refreshing the page or come back in a few minutes.",
        ...
        actions: [
            {
                label: "Try Again",
                style: "btn-error",
                icon: "fa-duotone fa-regular fa-rotate-right",
            },
            {
    ...
    },
    {
        ...
        description:
            "This section requires additional access. Contact your organization admin to request the appropriate role or subscription upgrade.",
        ...
        actions: [
            ...
            },
            {
                label: "Go Back",
                style: "btn-ghost",
                icon: "fa-duotone fa-regular fa-arrow-left",
            },
        ],
                    ...
                    <div key={state.id} className="empty-card opacity-0">
                        ...
                        <div className="bg-base-200 border border-base-300 p-10 lg:p-16">
                            <div className="max-w-lg mx-auto text-center">
                                {/* Icon */}
                                <div
                                    className={`w-20 h-20 ${state.iconBg} flex items-center justify-center mx-auto mb-6`}
                                >
                                    <i
                                        className={`${state.icon} ${state.iconColor} text-4xl`}
                                    />
                                </div>
