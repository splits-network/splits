...
const emptyStates = [
    {
        ...
        description:
            'Your search for "Senior Quantum Engineer" in "Antarctica" returned zero results. The network is vast, but not that vast.',
        suggestions: [
    ...
    },
    {
        ...
        iconBorder: "border-coral/20",
        iconColor: "text-primary",
        heading: "Ready for Launch",
        description:
            "Your command center is initialized and all systems are standing by. Deploy your first job order to activate the recruiting network and start receiving candidates.",
        suggestions: [
    ...
    },
    {
        ...
        description:
            "The data pipeline encountered an unexpected fault while loading your dashboard. Our monitoring systems have already flagged the incident for the engineering team.",
        suggestions: [
    ...
    },
    {
        ...
        description:
            "You do not have the required permissions to access the Billing Core module. This area is restricted to Organization Admins and Finance operators.",
        suggestions: [
    ...
    if (type === "launch") {
        return (
            <div className="relative w-32 h-32 mx-auto mb-6">
                ...
                {/* Corner brackets */}
                <div className="absolute top-0 left-0 w-6 h-6 border-l border-t border-coral/20" />
                <div className="absolute top-0 right-0 w-6 h-6 border-r border-t border-coral/20" />
                <div className="absolute bottom-0 left-0 w-6 h-6 border-l border-b border-coral/20" />
                <div className="absolute bottom-0 right-0 w-6 h-6 border-r border-b border-coral/20" />
            </div>
        );
    }
            ...
            <section className="relative flex items-center justify-center px-6 pt-28 pb-12">
                <div className="relative z-10 max-w-5xl mx-auto text-center">
                    ...
                    <p className="page-subtitle max-w-xl mx-auto text-base-content/50 font-light leading-relaxed">
                        Graceful handling for zero-data scenarios. Every void in
                        the interface becomes an opportunity to guide the
                        operator toward their next action.
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {emptyStates.map((state, idx) => (
                            <div
                                key={state.id}
                                className="empty-card bg-base-200 border border-base-content/5 overflow-hidden"
                            >
                                {/* Scenario Header */}
                                ...
                                <div className="p-8 text-center">
                                    ...
                                    {/* Icon */}
                                    <div
                                        className={`w-16 h-16 flex items-center justify-center ${state.iconBg} ${state.iconColor} border ${state.iconBorder} mx-auto mb-5`}
                                    >
                                        <i
                                            className={`fa-duotone fa-regular ${state.icon} text-2xl`}
                                        />
                                    </div>
                                    ...
                                    <div className="flex gap-3 justify-center">
                                        <button
                                            className={`btn btn-sm font-mono uppercase tracking-wider text-[10px] ${
                                                state.id === "error"
                                                    ? "btn-error"
                                                    : state.id ===
                                                        "access-denied"
                                        ...
                                        >
                                            <i
                                                className={`fa-duotone fa-regular ${state.primaryAction.icon} mr-1`}
                                            />
                                            {state.primaryAction.label}
                                        </button>
                                        <button className="btn btn-ghost btn-sm font-mono uppercase tracking-wider text-[10px]">
                                            <i
                                                className={`fa-duotone fa-regular ${state.secondaryAction.icon} mr-1`}
                                            />
            ...
            <section className="px-6 pb-24 pt-8 border-t border-base-content/10">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        {[
                            {
                                title: "Decorative Visual",
                                detail: "Custom SVG/CSS illustration matching the scenario context",
                                icon: "fa-palette",
                            },
                            {
                                title: "Icon + Heading",
                                detail: "Color-coded icon and bold descriptive heading",
                                icon: "fa-heading",
                            },
                            {
                                title: "Description",
                                detail: "Concise explanation of what happened and why",
                                icon: "fa-align-left",
                            },
                            {
                                title: "Action Buttons",
                                detail: "Primary CTA + secondary alternative, context-appropriate",
                            ...
                            >
                                <div className="w-9 h-9 flex items-center justify-center bg-primary/10 text-primary border border-coral/20 mb-4">
                                    <i
                                        className={`fa-duotone fa-regular ${spec.icon} text-sm`}
                                    />
                                </div>
                ...
                <div className="max-w-6xl mx-auto flex items-center justify-center gap-8 text-base-content/20">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-mono text-[10px] uppercase tracking-wider">
                            Empty State System Operational
                        </span>
                    </div>
