...
// Memphis retro animation constants (matching landing page six)
...
interface ArticleSixAnimatorProps {
    children: ReactNode;
}

export function ArticleSixAnimator({ children }: ArticleSixAnimatorProps) {
        ...
        () => {
            ...
            gsap.fromTo(
                ...
                { opacity: 0, scale: 0.8 },
                {
                    ...
                    ease: E.bounce,
                    stagger: S.normal,
                    scrollTrigger: { trigger: $1(".article-stats"), start: "top 90%" },
                },
            );
            ...
            // ════════════════════════════════════════
            const articleSections = [".article-intro", ".article-why", ".article-future"];
            articleSections.forEach((sel) => {
                const section = $1(sel);
                if (!section) return;
                const inner = section.querySelector(".article-section, .why-section, .future-section");
                if (inner) {
                    gsap.fromTo(
                        inner,
                        { opacity: 0, y: 40 },
            ...
            gsap.fromTo(
                ...
                { opacity: 0, y: 30 },
                {
                    opacity: 1, y: 0,
                    duration: D.normal, ease: E.smooth,
                    scrollTrigger: { trigger: $1(".article-benefits"), start: "top 75%" },
                },
            );
