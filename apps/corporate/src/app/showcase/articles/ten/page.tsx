...
const articleMeta = {
    ...
    subtitle:
        "An operational analysis of the network-driven recruiting model reshaping talent acquisition",
...
export default function ArticleTen() {
    ...
    useGSAP(
        () => {
            ...
            /* ── section reveals ── */
            gsap.utils
                .toArray<HTMLElement>(".article-section")
                .forEach((section) => {
                    gsap.fromTo(
                        section,
                        { opacity: 0, y: 40 },
                    ...
                    {sections.map((section, idx) => (
                        <div key={section.id}>
                            ...
                            {getPullQuoteAfter(idx) && (
                                <aside className="pull-quote my-16 pl-8 border-l-2 border-coral relative">
                                    ...
                                    <p className="text-xl md:text-2xl font-light text-base-content/70 leading-relaxed italic">
                                        &ldquo;{getPullQuoteAfter(idx)!.text}
                                        &rdquo;
                                    </p>
                            ...
                            {idx === 1 && (
                                <div className="img-reveal my-16 relative overflow-hidden aspect-[16/7]">
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-base-300/30" />
                                    <div className="absolute top-3 left-3 w-6 h-6 border-l border-t border-coral/40" />
                                    <div className="absolute bottom-3 right-3 w-6 h-6 border-r border-b border-coral/40" />
                                </div>
                            )}
            ...
            <section className="px-6 py-16 border-b border-base-content/10">
                <div className="max-w-3xl mx-auto">
                    <div className="flex items-start gap-6 p-8 bg-base-200 border border-base-content/5">
                        <div className="w-14 h-14 flex items-center justify-center bg-primary/10 text-primary border border-coral/20 flex-shrink-0">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-base-content/40 leading-relaxed">
                                The intelligence unit at Splits Network monitors
                                industry trends, analyzes network performance
                                data, and publishes operational insights for the
                                recruiting community. All analysis is derived
                                from anonymized, aggregated platform data.
                            </p>
            ...
            <section className="cta-block py-32 px-6 bg-base-200">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="text-base-content/40 max-w-xl mx-auto mb-10 leading-relaxed">
                        The split-fee model is not a trend. It is the operating
                        system for the next generation of recruiting. Initialize
                        your command center and start building the partnerships
                        that will define your firm.
                    </p>
