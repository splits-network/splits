                    ...
                    <div className="flex items-start justify-between">
                        <div>
                            ...
                            <p className="text-lg text-primary-content/80 max-w-2xl">
                                Editorial Magazine — Basel-compliant card with DaisyUI semantic tokens,
            ...
            <div className="max-w-7xl mx-auto px-6 pb-16">
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    {SAMPLE_RECRUITERS.map((r) => (
                        <div key={r.name} className={r.name === recruiter.name ? "ring-2 ring-primary ring-offset-4 ring-offset-base-200" : ""}>
                            <Card01 recruiter={r} />
                        </div>
                    ))}
                </div>
