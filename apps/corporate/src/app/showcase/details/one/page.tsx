...
const activity = [
    ...
    },
    {
        ...
        initials: "PP",
        role: "company",
        action: "added a note: 'Prefer fintech experience'",
        time: "Yesterday",
    },
    {
        type: "submission",
    ...
    },
    {
        ...
        initials: "RT",
        role: "company",
        action: "created this job posting",
        time: "4 days ago",
    },
];
                        ...
                        <div className="flex flex-wrap gap-3 mb-8">
                            {[
                                ...
                                },
                                {
                                    ...
                                    text: `$${(job.salaryMin / 1000).toFixed(0)}k - $${(job.salaryMax / 1000).toFixed(0)}k`,
                                },
                                {
                                    icon: "fa-duotone fa-regular fa-gauge-high",
                                    text: `${job.urgency.charAt(0).toUpperCase() + job.urgency.slice(1)} Priority`,
                                },
                            ].map((tag) => (
                                <span
                                    key={tag.text}
            ...
            <section className="bg-base-200 border-b border-base-300 py-4">
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="flex flex-wrap items-center gap-6">
                        ...
                        <div className="flex items-center gap-2 text-sm text-base-content/50">
                            <i className="fa-duotone fa-regular fa-hourglass text-xs" />{" "}
                                ...
                                <div className="detail-section opacity-0">
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {job.benefits.map((b) => (
                                            <div
                                                key={b}
                                                className="flex items-center gap-2 p-3 bg-base-200"
                                            >
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 pt-1">
                                                    <div className="flex items-center gap-2 mb-0.5">
                                                        ...
                                                        <i
                                                            className={`${activityIcons[item.type]} text-xs ${rc.text}`}
                                                        />
                                                    </div>
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-primary text-primary-content p-6 mb-6">
                            ...
                            <p className="text-sm opacity-80 mb-4">
                                Earn {job.splitFee}% placement fee on this $
                                {(job.salaryMin / 1000).toFixed(0)}k-$
                                {(job.salaryMax / 1000).toFixed(0)}k role.
                            </p>
                            <div className="text-xs opacity-60 mb-4">
                                <div className="flex justify-between py-1.5 border-b border-white/10">
                                    <span>Potential Fee (min)</span>
                                    <span className="font-bold">
                                        $
                                        {(
                                            (job.salaryMin * job.splitFee) /
                                            100
                                        ).toLocaleString()}
                                    </span>
                                </div>
                                <div className="flex justify-between py-1.5">
                                    <span>Potential Fee (max)</span>
                                    <span className="font-bold">
                                        $
                                        {(
                                            (job.salaryMax * job.splitFee) /
                                            100
                                        ).toLocaleString()}
                                    </span>
                                </div>
                            </div>
                            <button className="btn bg-white text-primary hover:bg-white/90 border-0 w-full btn-sm">
                                <i className="fa-duotone fa-regular fa-paper-plane" />{" "}
                                Submit Now
                            </button>
                        </div>
                            ...
                            <div className="space-y-3">
                                {similarJobs.map((sj) => (
                                    <a
                                        key={sj.title}
                                        href="#"
                                        className="block p-3 bg-base-100 border border-base-300 hover:border-coral/50 transition-colors"
                                    >
