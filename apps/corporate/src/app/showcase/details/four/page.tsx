...
const activityTimeline = [
    {
        type: "posted",
        text: "Job listing published to marketplace",
        time: "3 days ago",
    ...
    {
        type: "featured",
        text: "Listing promoted to featured status",
        time: "3 days ago",
    ...
    {
        type: "applicant",
        text: "First application received from external candidate",
        time: "2 days ago",
    ...
    {
        type: "milestone",
        text: "50 applications milestone reached",
        time: "1 day ago",
    ...
    {
        type: "recruiter",
        text: "Sarah Chen assigned as lead recruiter",
        time: "1 day ago",
    ...
    {
        type: "views",
        text: "Listing surpassed 1,000 views",
        time: "12 hours ago",
    ...
    {
        type: "update",
        text: "Job description updated with additional requirements",
        time: "6 hours ago",
...
const relatedJobs = mockJobs
    .filter((j) => j.id !== job.id && j.department === "Design")
    .slice(0, 3);
const alsoRecommended = mockJobs
    .filter((j) => j.id !== job.id && j.featured)
    .slice(0, 3);
                ...
                <div className="max-w-6xl mx-auto px-6 py-12 lg:py-16">
                    ...
                    <div className="cin-detail-title opacity-0">
                        <div className="flex items-center gap-3 mb-3">
                            <span className="badge badge-success font-semibold uppercase tracking-wider">
                                {job.status}
                            </span>
                            {job.featured && (
                            ...
                            <span className="badge bg-white/10 border-0 text-white/50 font-medium capitalize">
                                {job.type}
                            </span>
                        </div>
                ...
                <div className="max-w-6xl mx-auto px-6 py-5">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {[
                            ...
                            <div
                                key={i}
                                className="cin-quick-stat flex items-center gap-3 opacity-0"
                            >
                                ...
                                <div>
                                    ...
                                    <div className="text-xs text-base-content/40 font-medium mt-0.5">
                                        {stat.label}
                                    </div>
                                </div>
                            </div>
            ...
            <div className="max-w-6xl mx-auto px-6 py-12 lg:py-16">
                <div className="grid lg:grid-cols-3 gap-10">
                        ...
                        <section className="cin-section opacity-0">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {job.tags.map((tag, i) => (
                                    <span
                                        key={i}
                                        className="badge badge-lg bg-base-200 border-base-content/10 font-medium"
                                    >
                                        {tag}
                                    </span>
                                ))}
                        ...
                        <section className="cin-section cin-timeline opacity-0">
                            ...
                            <div className="space-y-0">
                                {activityTimeline.map((item, i) => (
                                    <div
                                        key={i}
                                        className="cin-timeline-item flex gap-4 pb-6 last:pb-0 relative opacity-0"
                                    >
                                        ...
                                        <div className="w-8 h-8 rounded-full bg-base-200 flex items-center justify-center shrink-0 z-10">
                                            <i
                                                className={`${item.icon} ${item.color} text-xs`}
                                            />
                                        </div>
                                        <div className="flex-1 pt-0.5">
                                            ...
                                            <span className="text-xs text-base-content/30 mt-0.5 block">
                                                {item.time}
                                            </span>
                                        </div>
                                    </div>
                    ...
                    <aside className="space-y-6">
                        ...
                        {/* Apply CTA */}
                        <div className="cin-section border border-coral/20 bg-primary/5 rounded-xl p-5 text-center opacity-0">
            ...
            <section className="cin-related bg-base-200 py-16 lg:py-20">
                <div className="max-w-6xl mx-auto px-6">
                    <div className="flex items-end justify-between mb-10">
                        ...
                        <a
                            href="#"
                            className="hidden sm:flex text-sm text-primary font-semibold hover:underline items-center gap-1"
                        >
                            View All{" "}
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {(relatedJobs.length > 0
                            ...
                            <div
                                key={rj.id}
                                className="cin-related-card bg-base-100 rounded-xl border border-base-content/5 p-5 hover:shadow-lg hover:border-coral/20 transition-all cursor-pointer group opacity-0"
                            >
                                <div className="flex items-center gap-2 mb-3">
                                    <span
                                        className={`badge badge-sm badge-success font-semibold uppercase tracking-wider`}
                                    >
                                        {rj.status}
                                    </span>
                                    {rj.featured && (
                                ...
                                <h3 className="font-black text-base mb-1 group-hover:text-primary transition-colors">
                                    {rj.title}
                                </h3>
                                ...
                                <div className="space-y-1 text-sm text-base-content/40 mb-4">
                                    <div className="flex items-center gap-2">
                                        <i className="fa-duotone fa-regular fa-location-dot text-primary text-xs w-4" />
                                        {rj.location}
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <i className="fa-duotone fa-regular fa-money-bill-wave text-primary text-xs w-4" />
                                ...
                                <div className="flex flex-wrap gap-1">
                                    {rj.tags.slice(0, 3).map((t, i) => (
                                        <span
                                            key={i}
                                            className="badge badge-sm bg-base-200 border-0 text-base-content/50"
                                        >
                                            {t}
                                        </span>
                                    ))}
