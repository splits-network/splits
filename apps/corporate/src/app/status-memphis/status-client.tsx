                ...
                <div className="container mx-auto px-4 relative z-10 py-16">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="hero-subtext text-lg md:text-xl leading-relaxed mb-8 opacity-0"
                            ...
                            Live health telemetry for the Employment Networks platform.
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm mt-1" style={{ color: "rgba(26,26,46,0.7)" }}>
                                                    {service.error || "Our reliability team is mitigating the issue. Updates will follow."}
                                                </p>
                        ...
                        {unhealthyServices.length === 0 && (
                            <div className="no-incidents-card relative p-8 border-4 text-center mb-8 opacity-0"
                                ...
                                <p className="text-sm mt-1" style={{ color: "rgba(26,26,46,0.6)" }}>
                                    ...
                                    email help@employment-networks.com.
                                </p>
                            </div>
                        )}
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="cta-content text-center max-w-3xl mx-auto opacity-0">
                        ...
                        <p className="text-lg mb-8" style={{ color: "rgba(255,255,255,0.6)" }}>
                            ...
                            our reliability team is ready to assist.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <a href="mailto:help@employment-networks.com"
