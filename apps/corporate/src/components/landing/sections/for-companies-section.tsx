                    ...
                    <div>
                        ...
                        <div className="space-y-4 mb-8 stagger-children">
                            {benefits.map((benefit, index) => (
                                <div
                                    key={index}
                                    className="scroll-reveal slide-from-left benefit-item flex items-start gap-4"
                                >
                        ...
                        >
                            {features.map((feature, index) => (
                                <span
                                    key={index}
                                    className="scroll-reveal pop-in feature-badge badge badge-lg bg-accent/10 border-yellow/20 text-accent gap-2"
                                >
                                    <i
