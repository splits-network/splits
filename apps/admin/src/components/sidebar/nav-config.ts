...
export const NAV_SECTIONS: NavSection[] = [
    {
        ...
        items: [
            { href: '/secure/dashboard', label: 'Dashboard', icon: 'fa-gauge-high' },
        ],
    },
    {
        id: 'operations',
    ...
    },
    {
        ...
        items: [
            ...
            { href: '/secure/automation-rules', label: 'Automation Rules', icon: 'fa-robot', keywords: ['automation', 'rule', 'workflow'] },
            {
                href: '/secure/fraud-detection',
            ...
            { href: '/secure/chat-moderation', label: 'Chat Moderation', icon: 'fa-comments', keywords: ['chat', 'moderation', 'message'] },
            { href: '/secure/ownership-audit', label: 'Ownership Audit', icon: 'fa-magnifying-glass-chart', keywords: ['ownership', 'audit'] },
    ...
    },
    {
        ...
        items: [
            ...
            { href: '/secure/billing', label: 'Billing Profiles', icon: 'fa-credit-card', keywords: ['billing', 'invoice', 'payment'] },
        ],
    },
    {
        id: 'content',
        ...
        icon: 'fa-gear',
        items: [
            { href: '/secure/pages', label: 'Pages', icon: 'fa-file-lines', keywords: ['page', 'content', 'cms'] },
            { href: '/secure/navigation', label: 'Navigation', icon: 'fa-sitemap', keywords: ['nav', 'menu', 'link'] },
            { href: '/secure/images', label: 'Images', icon: 'fa-images', keywords: ['image', 'media', 'upload'] },
            { href: '/secure/metrics', label: 'Metrics', icon: 'fa-chart-mixed', keywords: ['metric', 'analytics', 'stats'] },
            { href: '/secure/activity-log', label: 'Activity Log', icon: 'fa-clock-rotate-left', keywords: ['activity', 'log', 'history'] },
