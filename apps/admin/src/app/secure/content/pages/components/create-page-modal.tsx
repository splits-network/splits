...
export function CreatePageModal({ isOpen, onClose, onCreated }: CreatePageModalProps) {
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            const result = await apiClient.post('/content/admin/pages', {
        ...
        <BaselModal isOpen={isOpen} onClose={handleClose} maxWidth="max-w-lg">
            ...
            <BaselModalBody>
                <div className="space-y-4">
                    ...
                    <BaselFormField label="Slug" required hint="URL path segment — auto-generated from title">
                        <input
                            type="text"
            ...
            <BaselModalFooter align="end">
                ...
                <button className="btn btn-primary" onClick={handleSubmit} disabled={submitting}>
                    <ButtonLoading loading={submitting} text="Create Page" loadingText="Creating..." />
                </button>
            </BaselModalFooter>
        </BaselModal>
    );
