...
import { HeaderNavEditor } from "./components/header-nav-editor";
import { FooterNavEditor } from "./components/footer-nav-editor";
import { ImportJsonModal } from "../pages/components/import-json-modal";
...
export default function NavigationAdminPage() {
        ...
        async (app: ContentApp, location: NavLocation) => {
            ...
            try {
                ...
                const result = await apiClient.get(
                    `/content/admin/navigation?app=${app}&location=${location}`,
                );
    ...
    async function handleSave() {
        ...
        try {
            ...
            await apiClient.post("/content/admin/navigation", {
                app: activeApp,
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Editor */}
            {loading ? (
                <StandardListLoadingState message="Loading navigation config..." />
            ) : (
