    ...
    return (
        <LandingAnimations>
            <main className="min-h-screen bg-base-100 flex flex-col">
                    ...
                    <div className="container mx-auto px-6 lg:px-12">
                        <div className="max-w-3xl">
                            ...
                            <p className="hero-body scroll-reveal text-lg md:text-xl text-base-content/70 leading-relaxed max-w-xl mb-10">
                                This is the internal administration portal for
                                Employment Networks. Looking for our platforms?
                                Visit Splits Network for recruiters and
                ...
                {/* ── Footer ──────────────────────────────────────────── */}
                <footer className="py-16 bg-base-300 text-base-content">
                    <div className="container mx-auto px-6 lg:px-12">
                        <div className="footer-content scroll-reveal fade-up max-w-3xl mx-auto text-center">
                            ...
                            <p className="opacity-70 leading-relaxed mb-8 max-w-lg mx-auto">
                                This portal is restricted to Employment Networks
