    ...
    experience: [
        {
            ...
            period: "2023 - Present",
            description:
                "Top-performing recruiter on the marketplace. 47 placements across engineering and product roles.",
        },
        {
            ...
            period: "2020 - 2023",
            description:
                "Built engineering pipelines for Series A-C startups. Specialized in hard-to-fill senior roles.",
        },
        {
            ...
            period: "2018 - 2020",
            description:
                "Coordinated hiring for 200+ engineering roles annually. Developed interview process improvements.",
        },
    ],
    recentActivity: [
        {
            action: "Placed a Senior Engineer at TechCorp",
            time: "2 days ago",
            icon: "fa-duotone fa-regular fa-trophy",
            color: "text-success",
        },
        {
            action: "Submitted 3 candidates to DataFlow VP role",
            time: "4 days ago",
            icon: "fa-duotone fa-regular fa-paper-plane",
            color: "text-primary",
        },
        {
            action: "Earned Pro Recruiter badge",
            time: "1 week ago",
            icon: "fa-duotone fa-regular fa-award",
            color: "text-warning",
        },
        {
            action: "Completed 5-star review from InnovateCo",
            time: "2 weeks ago",
            icon: "fa-duotone fa-regular fa-star",
            color: "text-accent",
        },
                        ...
                        {(["about", "experience", "reviews"] as const).map(
                            (tab) => (
                                <button
                                    ...
                                    className={`px-6 py-3 text-sm font-semibold border-b-2 transition-all capitalize ${activeTab === tab ? "border-coral text-primary" : "border-transparent text-base-content/40 hover:text-base-content/60"}`}
                                >
                                    {tab}
                                </button>
                            ),
                            ...
                            <div className="profile-section opacity-0">
                                ...
                                <div className="space-y-4">
                                    {profile.testimonials.map((t, i) => (
                                        <div
                                            key={i}
                                            className="border-l-4 border-coral bg-base-200 p-6"
                                        >
                                            <i className="fa-duotone fa-regular fa-quote-left text-2xl text-primary/20 mb-3 block" />
                                            <p className="text-base-content/70 leading-relaxed mb-4 italic">
                                                &ldquo;{t.text}&rdquo;
                                            </p>
