    ...
    return (
        ...
        >
            ...
            <div className="hidden lg:flex lg:w-2/5 flex-col justify-between p-12 relative">
                <div
                    className="absolute top-0 right-0 w-full h-full bg-primary/5"
                    style={{
                ...
                <div className="onboard-panel opacity-0 w-full max-w-lg">
                    ...
                    <div className="lg:hidden flex items-center gap-2 mb-8">
                        {steps.map((step) => (
                            <div
                                key={step.id}
                                className={`h-1 flex-1 ${currentStep >= step.id ? "bg-primary" : "bg-base-300"}`}
                            />
                        ))}
                    </div>
                    ...
                    {currentStep === 1 && (
                        <div>
                            ...
                            <p className="text-base-content/50 mb-8">
                                First, tell us how you will be using the
                                platform.
                            </p>
                                ...
                                {[
                                    {
                                        ...
                                        desc: "I source and place candidates for split-fee commissions",
                                    ...
                                    },
                                    {
                                        ...
                                        desc: "I want to post roles and find recruiters to fill them",
                                    ...
                                    >
                                        <div
                                            className={`w-12 h-12 bg-${option.color}/10 flex items-center justify-center flex-shrink-0`}
                                        >
                                            <i
                                                className={`${option.icon} text-${option.color} text-xl`}
                                            />
                                        </div>
                                        <div>
                                        ...
                                        {role === option.id && (
                                            <i
                                                className={`fa-solid fa-circle-check text-${option.color} ml-auto mt-1`}
                                            />
                                        )}
                                    </button>
                                ))}
                    ...
                    {currentStep === 2 && (
                        <div>
                            ...
                            <p className="text-base-content/50 mb-8">
                                This information helps companies find and trust
                                you.
                            </p>
                            ...
                            <div className="space-y-5">
                                ...
                                <fieldset>
                                    ...
                                    <textarea
                                        placeholder="Tell companies about your recruiting experience..."
                    ...
                    {currentStep === 3 && (
                        <div>
                            ...
                            <p className="text-base-content/50 mb-8">
                                Select the areas where you recruit. Pick at
                                least one.
                            </p>
                            ...
                            {selectedSpecs.length > 0 && (
                                <div className="mt-6 p-4 bg-primary/5 border border-coral/20">
                    ...
                    {currentStep === 4 && (
                        <div>
                            ...
                            <p className="text-base-content/50 mb-8">
                                Fine-tune how you want to work on the
                                marketplace.
                            </p>
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <div className="bg-base-200 p-5 border border-base-300">
                                        ...
                                        <p className="text-xs text-base-content/40 mt-2">
                                            Your preferred commission split
                                            percentage
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-3 gap-3">
                                        {[
                                            ...
                                            <button
                                                key={a}
                                                className={`p-4 border-2 text-center text-sm font-semibold transition-all ${i === 0 ? "border-coral bg-primary/5" : "border-base-300 hover:border-base-content/20"}`}
                                            >
                                                {a}
                                            </button>
                                        ))}
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        {[
                                            {
                                                label: "New roles matching my specializations",
                                                defaultChecked: true,
                                            },
                                            {
                                                label: "Messages from companies",
                                                defaultChecked: true,
                                            },
                                            {
                                                label: "Placement status updates",
                                                defaultChecked: true,
                                            },
                                            {
                                            ...
                                            <label
                                                key={pref.label}
                                                className="flex items-center justify-between p-3 bg-base-200 border border-base-300 cursor-pointer"
                                            >
                    ...
                    {currentStep === 5 && (
                        <div className="text-center py-8">
                            ...
                            <p className="text-base-content/50 mb-8 max-w-sm mx-auto">
                                Your profile is ready. Start browsing open roles
