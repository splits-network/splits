...
const mockNotifications: Notification[] = [
    {
        ...
        description:
            "Alex Rivera has been officially placed as Senior Engineer at TechCorp. Commission: $18,500.",
        time: "2 hours ago",
        read: false,
    ...
    },
    {
        ...
        description:
            "Hey Sarah, I wanted to follow up on the VP Engineering candidates you submitted last week...",
        time: "3 hours ago",
        read: false,
    ...
    },
    {
        ...
        description:
            "Jordan Lee has advanced to the interview stage for VP Engineering at DataFlow.",
        time: "5 hours ago",
        read: false,
    ...
    },
    {
        id: 4,
        type: "achievement",
        title: "Badge earned: Pro Recruiter",
        description:
            "Congratulations! You have completed 25+ placements and earned the Pro Recruiter badge.",
        time: "1 day ago",
        read: true,
    ...
    },
    {
        id: 5,
        type: "system",
        title: "New roles matching your specializations",
        description:
            "12 new engineering roles were posted today that match your profile. 3 are marked as urgent.",
        time: "1 day ago",
        read: true,
    ...
    },
    {
        id: 6,
        type: "billing",
        title: "Invoice paid: February 2026",
        description:
            "Your Pro plan payment of $49.00 has been successfully processed.",
        time: "2 days ago",
        read: true,
    ...
    },
    {
        ...
        description:
            "TechCorp left a 5-star review for your placement of Casey Nguyen. View the review on your profile.",
        time: "3 days ago",
        read: true,
    ...
    },
    {
        id: 8,
        type: "message",
        title: "Message from Robert Tanaka",
        description:
            "Great news about the DataFlow search. Can we schedule a call to discuss the final candidates?",
        time: "3 days ago",
        read: true,
        icon: "fa-duotone fa-regular fa-comment",
        iconColor: "text-primary",
    ...
    },
    {
        ...
        description:
            "Splits Network will undergo scheduled maintenance on Feb 20 from 2-4 AM PT. No action needed.",
        time: "5 days ago",
        read: true,
    ...
    },
    {
        ...
        description:
            "Sam Patel has withdrawn their application for Backend Engineer at ScaleAI.",
        time: "1 week ago",
        read: true,
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                        ...
                        {unreadCount > 0 && (
                            <div className="flex items-center gap-3">
                                <div className="px-3 py-1.5 bg-primary/20 text-primary text-sm font-bold">
                                    {unreadCount} unread
                                </div>
                                <button
                                    onClick={markAllRead}
                        ...
                        {filterOptions.map((f) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`px-5 py-3 text-sm font-semibold border-b-2 transition-all whitespace-nowrap flex items-center gap-2 ${filter === f.value ? "border-coral text-primary" : "border-transparent text-base-content/40 hover:text-base-content/60"}`}
                                >
                                    {f.label}
                                    <span
                        ...
                        <div className="space-y-0">
                            {filtered.map((n) => (
                                ...
                                >
                                    {/* Icon */}
                                    <div
                                        className={`w-10 h-10 ${n.iconBg} flex items-center justify-center flex-shrink-0`}
                                    >
                                        <i
                                            className={`${n.icon} ${n.iconColor}`}
                                        />
                                    </div>
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start justify-between gap-3 mb-1">
                                            <h3
                                                className={`text-sm ${!n.read ? "font-bold" : "font-semibold"}`}
                                            >
                                                {n.title}
                                            </h3>
                                        ...
                                        <p className="text-sm text-base-content/50 leading-relaxed mb-2 line-clamp-2">
                                            {n.description}
                                        </p>
