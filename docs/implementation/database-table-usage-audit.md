...
- ❌ No V2 endpoints (`/api/v2/invitations`)
...
- ❌ No V2 endpoints (`/api/v2/subscriptions`)
...
- ❌ No V2 endpoints (`/api/v2/candidate-sourcers`)
...
- ❌ No V2 endpoints (`/api/v2/matches`)
...
- ❌ No V2 endpoints (`/api/v2/payout-schedules`)
...
- ❌ No V2 endpoints (`/api/v2/payout-splits`)
...
- ❌ No V2 endpoints (`/api/v2/escrow-holds`)
...
- ❌ No V2 endpoints (`/api/v2/integrations`)
