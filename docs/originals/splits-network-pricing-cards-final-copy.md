# Splits Network – Pricing Cards (Final Copy)

This file contains **production-ready copy** for the three recruiter pricing cards.
It is written to be clear, ethical, and conversion-focused without misrepresenting earnings or guarantees.
...
**Footnote (small text):**  
Payout percentages are finalized at hire time and depend on role participation.
...
**Label:** PARTNER  
**Price:** $249 / month  
**Alt:** $2,499 / year (2 months free)

**Headline:**  
Built for firms, power users, and sourcing partners
