...
const bgMap: Record<string, { bg: string; text: string; border: string }> = {
    ...
    secondary: {
        ...
        border: "border-secondary-content/20",
    },
    "base-100": {
        bg: "bg-base-100",
            ...
            <div className="container mx-auto px-6 lg:px-12">
                <div
                    className={`max-w-4xl mx-auto ${
                        isCentered
                            ? "text-center"
                            : `border-l-4 ${theme.border} pl-8 lg:pl-12`
                    }`}
                >
                    {!isCentered && (
                        <i
                            className={`fa-duotone fa-regular fa-quote-left text-4xl ${theme.text}/30 mb-6 block`}
                        />
                    )}
                    {isCentered && (
                        <i
                            className={`fa-duotone fa-regular fa-quote-left text-4xl ${theme.text}/20 mb-6 block`}
                        />
                    )}
                    ...
                    {block.citation && (
                        <cite
                            className={`text-sm uppercase tracking-[0.2em] ${theme.text}/50 not-italic`}
                        >
                            -- {block.citation}
                        </cite>
                    )}
