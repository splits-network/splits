        ...
        <div className={className}>
            <div className="flex items-center justify-between mb-4">
                <div className="text-center accent-coral">
                    ...
                    <p className="text-sm font-bold uppercase text-dark/50">
                        {leftLabel}
                    </p>
                </div>
                <div className="w-8 h-8 flex items-center justify-center border-xs">
            ...
            <div className="flex h-3 border-2 overflow-hidden border-dark">
                <div
