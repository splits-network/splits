                ...
                <div key={item.label}>
                    {item.hasDropdown ? (
                        ...
                        >
                            <div className="flex items-center gap-2.5">
                                ...
                                <span
                                    ...
                                    style={{ color: expandedItem === item.label ? item.color : '#FFFFFF' }}
                                >
                                    {item.label}
                                </span>
                            </div>
                            {item.subItems?.length && (
                                <i
                                    className={`fa-solid fa-chevron-${expandedItem === item.label ? 'up' : 'down'} text-[8px]`}
                        ...
                        <a
                            ...
                            className="w-full flex items-center gap-2.5 px-3 py-2.5 border-[2px] transition-all"
