...
- On small screens, show a compact search icon button that expands; on lg+, show the full input. (Use responsive classes: hidden on mobile, visible on lg+, with a btn-circle toggle for mobile.)
