...
tech-stack:
    added: []
    patterns:
        [gsap-counter-animation, prefers-reduced-motion-respect, barrel-exports]
...
key-decisions:
    ...
    - "Premium tier distinguished with border-2 border-yellow"
...
- Premium tier has border-2 border-yellow to distinguish from free tier
