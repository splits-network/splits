...
2. Pricing page imports calculator: `grep "RTICalculator" apps/portal/src/app/public/pricing/pricing-content.tsx`
3. Calculator section exists: `grep "Calculate Your Earnings" apps/portal/src/app/public/pricing/pricing-content.tsx`
4. Build check: `pnpm --filter @splits-network/portal build` passes
  </verify>
  <done>
...
2. Visit http://localhost:3100/public/pricing
