...
- `apps/portal/src/app/pricing/pricing-content.tsx` - Client component with GSAP animations

**Modified:**

- `apps/portal/src/app/pricing/page.tsx` - Server wrapper for metadata export
