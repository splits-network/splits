...
must_haves:
  ...
  artifacts:
    - path: "apps/portal/src/app/public/pricing/page.tsx"
      provides: "Animated pricing page with GSAP integration"
      contains: "'use client'"
  key_links:
    - from: "apps/portal/src/app/public/pricing/page.tsx"
...
<task type="auto">
  ...
  <files>apps/portal/src/app/public/pricing/page.tsx</files>
  <action>
...
4. Move metadata export to a separate file since client components cannot export metadata. Create `apps/portal/src/app/public/pricing/metadata.ts` with the metadata export, then import and re-export from a layout or use generateMetadata in a server component wrapper.
