...
-- =============================================================================
-- Add Profile Fields to ats.candidates
-- =============================================================================
...
-- Add comments
COMMENT ON COLUMN ats.candidates.bio IS 'Candidate professional bio/summary';
COMMENT ON COLUMN ats.candidates.github_url IS 'GitHub profile URL';
COMMENT ON COLUMN ats.candidates.portfolio_url IS 'Portfolio or personal website URL';
COMMENT ON COLUMN ats.candidates.skills IS 'Comma-separated list of skills';
