...
COMMENT ON COLUMN applications.recruiter_notes IS 'Recruiter insights/pitch added during review before submitting to company';
...
-- Next Steps:
-- 1. Verify tables with: \d job_pre_screen_answers
...
-- 3. Verify indexes: \di idx_applications_*
