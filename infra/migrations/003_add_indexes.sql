...
CREATE INDEX IF NOT EXISTS idx_memberships_organization_id ON identity.memberships(organization_id);
CREATE INDEX IF NOT EXISTS idx_memberships_user_org ON identity.memberships(user_id, organization_id);
...
CREATE INDEX IF NOT EXISTS idx_jobs_company_status ON ats.jobs(company_id, status);

-- Index for candidate lookups by email
CREATE INDEX IF NOT EXISTS idx_candidates_email ON ats.candidates(email);
CREATE INDEX IF NOT EXISTS idx_candidates_created_by ON ats.candidates(created_by_user_id);
...
CREATE INDEX IF NOT EXISTS idx_applications_job_stage ON ats.applications(job_id, stage);
CREATE INDEX IF NOT EXISTS idx_applications_recruiter_stage ON ats.applications(recruiter_id, stage);

-- Index for placements filtering by recruiter, company, and date
CREATE INDEX IF NOT EXISTS idx_placements_recruiter_id ON ats.placements(recruiter_id);
CREATE INDEX IF NOT EXISTS idx_placements_company_id ON ats.placements(company_id);
CREATE INDEX IF NOT EXISTS idx_placements_job_id ON ats.placements(job_id);
CREATE INDEX IF NOT EXISTS idx_placements_hired_at ON ats.placements(hired_at DESC);
CREATE INDEX IF NOT EXISTS idx_placements_recruiter_hired_at ON ats.placements(recruiter_id, hired_at DESC);
CREATE INDEX IF NOT EXISTS idx_placements_company_hired_at ON ats.placements(company_id, hired_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_recruiters_status ON network.recruiters(status);

-- Index for role assignments - critical for recruiter-specific job filtering
CREATE INDEX IF NOT EXISTS idx_role_assignments_job_id ON network.role_assignments(job_id);
CREATE INDEX IF NOT EXISTS idx_role_assignments_recruiter_id ON network.role_assignments(recruiter_id);
CREATE INDEX IF NOT EXISTS idx_role_assignments_recruiter_job ON network.role_assignments(recruiter_id, job_id);

-- ===== Billing Schema =====

-- Index for subscription lookups
CREATE INDEX IF NOT EXISTS idx_subscriptions_recruiter_id ON billing.subscriptions(recruiter_id);
...
CREATE INDEX IF NOT EXISTS idx_subscriptions_recruiter_status ON billing.subscriptions(recruiter_id, status);
